...
namespace YSWL.ShoppingCart.Core
{
        ...
        where TCartItemInfo : CartItemInfo, new()
    {
        ...
        protected const string BASE_COOKIE_INDEXKEY = "yswl_v1.2.1_shoppingcart_index_{0}";
        protected const string BASE_COOKIE_DATAKEY = "yswl_v1.2.1_shoppingcart_data_{0}";
        protected readonly string CartDataCookieIndexKey;
        protected readonly string CartDataCookieDataKey;
        protected int CookieItemsMaxNum = 20;
        protected int CookieKeyMaxNum = 15;
        protected double CookieExpiresDayNum = 1.0;
        ...
        public virtual void RemoveItemList(string itemIds)
        {
            TCartInfo shoppingCart = GetShoppingCart();
            if (shoppingCart.Items == null || shoppingCart.Items.Count < 1) return;
            ...
            {
                shoppingCart.Items.RemoveAll(xx => xx.ItemId == int.Parse(s));
            }
            this.SaveShoppingCart(shoppingCart);
        }
        #endregion
