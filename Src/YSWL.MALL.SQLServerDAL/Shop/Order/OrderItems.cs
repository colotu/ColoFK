...
namespace YSWL.MALL.SQLServerDAL.Shop.Order
{
	...
	public partial class OrderItems:IOrderItems
	{
        ...
        public long Add(YSWL.MALL.Model.Shop.Order.OrderItems model)
        {
            ...
            strSql.Append("OrderId,OrderCode,ProductId,ProductCode,SKU,Name,ThumbnailsUrl,Description,Quantity,ShipmentQuantity,CostPrice,SellPrice,AdjustedPrice,Attribute,Remark,Weight,Deduct,Points,ProductLineId,SupplierId,SupplierName,BrandId,BrandName,ProductType,ReferId,ReferType)");
        ...
        public bool Update(YSWL.MALL.Model.Shop.Order.OrderItems model)
        {
            ...
            parameters[24].Value = model.ReferId;
            parameters[25].Value = model.ReferType;
            parameters[26].Value = model.ItemId;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ItemId,OrderId,OrderCode,ProductId,ProductCode,SKU,Name,ThumbnailsUrl,Description,Quantity,ShipmentQuantity,CostPrice,SellPrice,AdjustedPrice,Attribute,Remark,Weight,Deduct,Points,ProductLineId,SupplierId,SupplierName,BrandId,BrandName,ProductType,ReferId,ReferType ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ItemId,OrderId,OrderCode,ProductId,ProductCode,SKU,Name,ThumbnailsUrl,Description,Quantity,ShipmentQuantity,CostPrice,SellPrice,AdjustedPrice,Attribute,Remark,Weight,Deduct,Points,ProductLineId,SupplierId,SupplierName,BrandId,BrandName,ProductType,ReferId,ReferType ");
            strSql.Append(" FROM OMS_OrderItems ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
