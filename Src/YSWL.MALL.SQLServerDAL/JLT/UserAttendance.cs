...
namespace YSWL.MALL.SQLServerDAL.JLT
{
	/// <summary>
	...
	public partial class UserAttendance:IUserAttendance
	{
		...
		public int GetMaxId()
		{
		return DBHelper.DefaultDBHelper.GetMaxID("ID", "JLT_UserAttendance"); 
		}
        ...
        {
            return DBHelper.DefaultDBHelper.RunProcedure("sp_UserAttendance_Statistics",
              new IDataParameter[]
                  {
                      DBHelper.DefaultDBHelper.CreateInParam("@SqlWhere", SqlDbType.NVarChar, 3000, strWhere)
                  }, "StatisticsTable");
        }
