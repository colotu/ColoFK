...
namespace YSWL.MALL.SQLServerDAL.SNS
{
	...
	public partial class Categories:ICategories
	{
        ...
        public int GetMaxId()
        {
            return DBHelper.DefaultDBHelper.GetMaxID("CategoryId", "SNS_Categories");
        }
        ...
        public bool AddCategories(Model.SNS.Categories model)
        {
            ...
            return DBHelper.DefaultDBHelper.RunProcedure("sp_SNS_Category_Create", parameters, out resultRows) > 0;
        ...
        public bool SwapCategorySequence(int CategoryId, Model.SNS.EnumHelper.SwapSequenceIndex zIndex)
        {
            ...
            DBHelper.DefaultDBHelper.RunProcedure("sp_SNS_Category_SwapSequence", parameter, out AffectedRows);
