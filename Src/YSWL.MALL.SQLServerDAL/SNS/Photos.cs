...
namespace YSWL.MALL.SQLServerDAL.SNS
{
    ...
    public partial class Photos : IPhotos
    {
        ...
        public int GetMaxId()
        {
            return DBHelper.DefaultDBHelper.GetMaxID("PhotoID", "SNS_Photos");
        }
        ...
        public DataSet DeleteListEx(string Ids, out int Result)
        {
            ...
            DataSet ds = DBHelper.DefaultDBHelper.RunProcedure("sp_SNS_ImageDeleteAction", parameters, "tb", out Result);
            if (Result == 1)
            {
                return ds;
            }
