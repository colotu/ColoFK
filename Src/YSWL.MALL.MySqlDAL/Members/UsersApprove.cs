...
namespace YSWL.MALL.MySqlDAL.Members
{
    ...
    public partial class UsersApprove : IUsersApprove
    {
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("ApproveID", "Accounts_UsersApprove");
        }
        ...
        public bool Exists(int ApproveID)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("?ApproveID",  MySqlDbType.Int32,4)
			};
        ...
        public int Add(YSWL.MALL.Model.Members.UsersApprove model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?TrueName", MySqlDbType.VarString,50),
					new MySqlParameter("?IDCardNum", MySqlDbType.VarString,20),
					new MySqlParameter("?FrontView", MySqlDbType.VarString,500),
					new MySqlParameter("?RearView", MySqlDbType.VarString,500),
					new MySqlParameter("?DueDate", MySqlDbType.DateTime),
					new MySqlParameter("?Status",  MySqlDbType.Int32,4),
					new MySqlParameter("?ApproveUserID",  MySqlDbType.Int32,4),
					new MySqlParameter("?UserType",  MySqlDbType.Int32,4),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT    ApproveID,UserID,TrueName,IDCardNum,FrontView,RearView,DueDate,Status,ApproveUserID,UserType,CreatedDate,ApproveDate FROM Accounts_UsersApprove ");
            strSql.Append(" WHERE ApproveID=?ApproveID LIMIT 1 ");
            MySqlParameter[] parameters = {
					new MySqlParameter("?ApproveID",  MySqlDbType.Int32,4)
			};
            parameters[0].Value = ApproveID;
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append("SELECT T.*  FROM Accounts_UsersApprove T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
        ...
        public bool BatchUpdate(string ids, string status)
        {
            ...
            strSql.AppendFormat("SET Status={0} ,ApproveDate=now() ", status);
