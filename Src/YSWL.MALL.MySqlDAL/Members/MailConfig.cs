    ...
    public class MailConfig : YSWL.MALL.IDAL.IMailConfig
    {
        ...
        public bool Exists(int UserID, string Mailaddress)
        {
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("?Mailaddress", MySqlDbType.VarString,100)};
        ...
        public int Add(YSWL.MALL.Model.MailConfig model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?Password", MySqlDbType.VarString,50),
					new MySqlParameter("?SMTPServer", MySqlDbType.VarString,50),
					new MySqlParameter("?SMTPPort",  MySqlDbType.Int32,4),
					new MySqlParameter("?SMTPSSL", MySqlDbType.Int16,2),
					new MySqlParameter("?POPServer", MySqlDbType.VarString,50),
