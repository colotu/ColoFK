...
namespace YSWL.MALL.MySqlDAL.SNS
{
	...
	public partial class GroupTags:IGroupTags
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("TagID", "SNS_GroupTags"); 
		}
		...
		public YSWL.MALL.Model.SNS.GroupTags GetModel(int TagID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("SELECT TagID,TagName,IsRecommand,Status FROM SNS_GroupTags ");
			...
			YSWL.MALL.Model.SNS.GroupTags model=new YSWL.MALL.Model.SNS.GroupTags();
