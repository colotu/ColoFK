...
namespace YSWL.MALL.MySqlDAL.SNS
{
    ...
    public partial class UserBlog : IUserBlog
    {
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("BlogID", "SNS_UserBlog");
        }
        ...
        public bool Exists(int BlogID)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("?BlogID", MySqlDbType.Int32,4)
			};
        ...
        public int Add(YSWL.MALL.Model.SNS.UserBlog model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?StaticUrl", MySqlDbType.VarChar,500),
        ...
        public YSWL.MALL.Model.SNS.UserBlog GetModel(int BlogID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  BlogID,Title,Summary,Description,UserID,UserName,LinkUrl,Status,Keywords,Recomend,Attachment,Remark,PvCount,TotalComment,TotalFav,TotalShare,Meta_Title,Meta_Description,Meta_Keywords,SeoUrl,StaticUrl,CreatedDate from SNS_UserBlog ");
            strSql.Append(" where BlogID=?BlogID LIMIT 1 ");
            MySqlParameter[] parameters = {
					new MySqlParameter("?BlogID", MySqlDbType.Int32,4)
			};
            parameters[0].Value = BlogID;

            YSWL.MALL.Model.SNS.UserBlog model = new YSWL.MALL.Model.SNS.UserBlog();
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.UserBlog DataRowToModel(DataRow row)
        {
            YSWL.MALL.Model.SNS.UserBlog model = new YSWL.MALL.Model.SNS.UserBlog();
            if (row != null)
            {
