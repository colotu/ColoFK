	...
	public partial class GroupTopics:IGroupTopics
	{
        ...
        public bool Exists(int TopicID)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("?TopicID", MySqlDbType.Int32,50)
			};
		...
		public int Add(YSWL.MALL.Model.SNS.GroupTopics model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("?DingCount", MySqlDbType.Int32,4),
					new MySqlParameter("?Status", MySqlDbType.Int32,4),
					new MySqlParameter("?IsTop", MySqlDbType.Int32,4),
					new MySqlParameter("?IsActive", MySqlDbType.Bit,1),
					new MySqlParameter("?IsAdminRecommend", MySqlDbType.Bit,1),
					...
					new MySqlParameter("?LastReplyUserId", MySqlDbType.Int32,4),
					new MySqlParameter("?LastReplyNickName", MySqlDbType.VarChar,50),
		...
		public YSWL.MALL.Model.SNS.GroupTopics GetModel(int TopicID)
		{
            ...
            strSql.Append(" where TopicID=?TopicID LIMIT 1 ");
			MySqlParameter[] parameters = {
					new MySqlParameter("?TopicID", MySqlDbType.Int32,4)
			};
			parameters[0].Value = TopicID;
            ...
            using (MySqlConnection connection = DbHelperMySQL.GetConnection)
            {
                ...
                using (MySqlTransaction transaction = connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        TopicId = DbHelperMySQL.GetSingle4Trans(GenerateTopicInfo(Tmodel), transaction);
                        DbHelperMySQL.GetSingle4Trans(GenerateUpdateUserEx(Tmodel.CreatedUserID, Tmodel.Type), transaction);
                        DbHelperMySQL.GetSingle4Trans(GenerateUpdateGroupCount(Tmodel), transaction);
                        transaction.Commit();
