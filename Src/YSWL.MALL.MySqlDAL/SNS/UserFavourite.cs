	...
	public partial class UserFavourite:IUserFavourite
	{
		...
		public int Add(YSWL.MALL.Model.SNS.UserFavourite model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("?OwnerUserID", MySqlDbType.Int32,4),
					new MySqlParameter("?OwnerNickName", MySqlDbType.VarChar,100),
		...
		public bool Update(YSWL.MALL.Model.SNS.UserFavourite model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("?Tags", MySqlDbType.VarChar,100),
					new MySqlParameter("?CreatedDate", MySqlDbType.DateTime),
					new MySqlParameter("?FavouriteID", MySqlDbType.Int32,4)};
			parameters[0].Value = model.TargetID;
			parameters[1].Value = model.Type;
			parameters[2].Value = model.CreatedUserID;
			parameters[3].Value = model.CreatedNickName;
		...
		public YSWL.MALL.Model.SNS.UserFavourite GetModel(int FavouriteID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select FavouriteID,TargetID,Type,CreatedUserID,CreatedNickName,OwnerUserID,OwnerNickName,Description,Tags,CreatedDate from SNS_UserFavourite ");
            strSql.Append(" where FavouriteID=?FavouriteID LIMIT 1 ");
			MySqlParameter[] parameters = {
					new MySqlParameter("?FavouriteID", MySqlDbType.Int32,4)
			};
			parameters[0].Value = FavouriteID;

			YSWL.MALL.Model.SNS.UserFavourite model=new YSWL.MALL.Model.SNS.UserFavourite();
		...
		/// 得到一个对象实体
		/// </summary>
		public YSWL.MALL.Model.SNS.UserFavourite DataRowToModel(DataRow row)
		{
			YSWL.MALL.Model.SNS.UserFavourite model=new YSWL.MALL.Model.SNS.UserFavourite();
			if (row != null)
			{
        ...
        /// 增加一条数据
        /// </summary>
        public bool AddEx(YSWL.MALL.Model.SNS.UserFavourite model,int TopicId, int ReplyId)
        {
            ...
            if (model.Type == (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Photo)
            {
        ...
        public bool DeleteEx(int UserId,int TargetId,int Type)
        {
            ...
            #region  喜欢数量-1
            StringBuilder strSql = new StringBuilder();
            if (Type == (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Product)
            {
