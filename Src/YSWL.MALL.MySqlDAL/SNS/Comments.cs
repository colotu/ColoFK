    ...
    public partial class Comments : IComments
    {
        ...
        public int Add(YSWL.MALL.Model.SNS.Comments model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?HasReferUser", MySqlDbType.Bit,1),
        ...
        public YSWL.MALL.Model.SNS.Comments GetModel(int CommentID)
        {
            ...
            YSWL.MALL.Model.SNS.Comments model = new YSWL.MALL.Model.SNS.Comments();
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Comments DataRowToModel(DataRow row)
        {
            YSWL.MALL.Model.SNS.Comments model = new YSWL.MALL.Model.SNS.Comments();
            if (row != null)
            {
        ...
        /// <returns></returns>
        public int AddEx(YSWL.MALL.Model.SNS.Comments model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into SNS_Comments(");
            ...
            if (model.Type == (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo || model.Type == (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Product)
            {
                #region 图片或商品的评论加1

                StringBuilder strSql2 = new StringBuilder();
                if (model.Type == (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo)
                {
        ...
        public DataSet AblumComment(int ablumId,string strWhere)
        {
            ...
            {
                strSql.AppendFormat("WHERE A.CreatedNickName LIKE '%{0}%'",Common.InjectionFilter.SqlFilter(strWhere));
            }
            MySqlParameter[] parameters = {
        ...
        { 
         ...
         MySqlParameter[] parameters = {
             ...
             DbHelperMySQL.RunProcedure("sp_SNS_CommentDeleteAction", parameters, out result);
             if (result > 0)
             {
                 return true;
             }
