...
namespace YSWL.MALL.MySqlDAL.SNS
{
	...
	public partial class Categories:ICategories
	{
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("CategoryId", "SNS_Categories");
        }
        ...
        public int Add(YSWL.MALL.Model.SNS.Categories model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?FontColor", MySqlDbType.VarChar,100),
        ...
        public YSWL.MALL.Model.SNS.Categories GetModel(int CategoryId)
        {
            ...
            YSWL.MALL.Model.SNS.Categories model = new YSWL.MALL.Model.SNS.Categories();
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Categories DataRowToModel(DataRow row)
        {
            YSWL.MALL.Model.SNS.Categories model = new YSWL.MALL.Model.SNS.Categories();
            if (row != null)
            {
        ...
        public bool AddCategories(Model.SNS.Categories model)
        {
            int resultRows = 0;
            MySqlParameter[] parameters = {
					new MySqlParameter("_Name", MySqlDbType.VarChar,200),
					new MySqlParameter("_Description", MySqlDbType.VarChar),
					new MySqlParameter("_HasChildren", MySqlDbType.Bit),
					new MySqlParameter("_ParentCategoryId", MySqlDbType.Int32,4),
					new MySqlParameter("_MenuSequence", MySqlDbType.Int32,4),
					new MySqlParameter("_MenuIsShow", MySqlDbType.Bit),
					new MySqlParameter("_CreatedUserID", MySqlDbType.Int32,4),
					new MySqlParameter("_IsMenu", MySqlDbType.Bit),
					new MySqlParameter("_Type", MySqlDbType.Int32,4),
					new MySqlParameter("_Status", MySqlDbType.Int32,4),
					new MySqlParameter("_FontColor", MySqlDbType.VarChar),
                   	new MySqlParameter("_SeoUrl", MySqlDbType.VarChar,300),
					new MySqlParameter("_Meta_Title", MySqlDbType.VarChar,100),
            ...
            return DbHelperMySQL.RunProcedure("sp_SNS_Category_Create", parameters, out resultRows) > 0;
        ...
        public bool SwapCategorySequence(int CategoryId, Model.SNS.EnumHelper.SwapSequenceIndex zIndex)
        {
            ...
            DbHelperMySQL.RunProcedure("sp_SNS_Category_SwapSequence", parameter, out AffectedRows);
