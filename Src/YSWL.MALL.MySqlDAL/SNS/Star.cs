    ...
    public partial class Star : IStar
    {
        ...
        public int Add(YSWL.MALL.Model.SNS.Star model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?ExpiredDate", MySqlDbType.DateTime),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,UserID,TypeID,NickName,UserGravatar,ApplyReason,CreatedDate,ExpiredDate,Status from SNS_Star ");
            ...
            YSWL.MALL.Model.SNS.Star model = new YSWL.MALL.Model.SNS.Star();
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Star DataRowToModel(DataRow row)
        {
            YSWL.MALL.Model.SNS.Star model = new YSWL.MALL.Model.SNS.Star();
            if (row != null)
            {
