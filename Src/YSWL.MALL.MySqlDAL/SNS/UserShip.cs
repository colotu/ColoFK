    ...
    public partial class UserShip : IUserShip
    {
        ...
        public bool Exists(int ActiveUserID, int PassiveUserID)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("?ActiveUserID", MySqlDbType.Int32,4),
					new MySqlParameter("?PassiveUserID", MySqlDbType.Int32,4)			};
        ...
        public YSWL.MALL.Model.SNS.UserShip GetModel(int ActiveUserID, int PassiveUserID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ActiveUserID,PassiveUserID,State,Type,CategoryID,CreatedDate,IsRead from SNS_UserShip ");
            strSql.Append(" where ActiveUserID=?ActiveUserID and PassiveUserID=?PassiveUserID LIMIT 1 ");
            MySqlParameter[] parameters = {
					new MySqlParameter("?ActiveUserID", MySqlDbType.Int32,4),
					new MySqlParameter("?PassiveUserID", MySqlDbType.Int32,4)			};
            parameters[0].Value = ActiveUserID;
            ...
            YSWL.MALL.Model.SNS.UserShip model = new YSWL.MALL.Model.SNS.UserShip();
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.UserShip DataRowToModel(DataRow row)
        {
            YSWL.MALL.Model.SNS.UserShip model = new YSWL.MALL.Model.SNS.UserShip();
            if (row != null)
            {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserShip> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.UserShip> modelList = new List<YSWL.MALL.Model.SNS.UserShip>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.UserShip model;
        ...
        /// <returns></returns>
        public bool FellowUser(YSWL.MALL.Model.SNS.UserShip model)
        {
            #region 被关注者的粉丝增加1
            ...
            {
                model.Type = (int)YSWL.MALL.Model.SNS.EnumHelper.FansType.EachOher;
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into SNS_UserShip(");
                strSql.Append("ActiveUserID,PassiveUserID,State,Type,CategoryID,CreatedDate,IsRead)");
                strSql.Append(" values (");
        ...
        public bool UnFellowUser(int UserID, int UnfellowUserID)
        {
            ...
            if (Exists(UnfellowUserID, UserID))
            {
                ...
                MySqlParameter[] parameters1 = {
					...
					new MySqlParameter("?ActiveUserID", MySqlDbType.Int32,4),
					new MySqlParameter("?PassiveUserID", MySqlDbType.Int32,4)};
                parameters1[0].Value = (int)YSWL.MALL.Model.SNS.EnumHelper.FansType.None;
        ...
        public List<YSWL.MALL.Model.SNS.UserShip> DataTableToListEx(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.UserShip> modelList = new List<YSWL.MALL.Model.SNS.UserShip>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.UserShip DataRowToModelEx(DataRow row)
        {
            YSWL.MALL.Model.SNS.UserShip model = new YSWL.MALL.Model.SNS.UserShip();
            if (row != null)
            {
        ...
        public bool AddAttention(int ActiveUserID, int PassiveUserID)
        {
            ...
            {
                List<CommandInfo> sqllist = new List<CommandInfo>();
                int Type = (int)YSWL.MALL.Model.SNS.EnumHelper.FansType.Normal;

                //判断被关注用户是否是用户的粉丝，即被关注者关注了用户。
                if (Exists(PassiveUserID, ActiveUserID))
                {
                    Type = (int)YSWL.MALL.Model.SNS.EnumHelper.FansType.EachOher;
