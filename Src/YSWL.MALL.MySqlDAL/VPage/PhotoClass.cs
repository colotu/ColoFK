...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2013/12/2 18:10:00   N/A    初版
*
...
namespace YSWL.MALL.MySqlDAL.VPage
{
	...
	/// 数据访问类:PhotoClass
	/// </summary>
	public partial class PhotoClass:IPhotoClass
	{
		public PhotoClass()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("ClassId", "VPage_PhotoClass"); 
		}
		...
		public bool Exists(int ClassId)
		{
			...
			strSql.Append("select count(1) from VPage_PhotoClass");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(YSWL.MALL.Model.VPage.PhotoClass model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VPage_PhotoClass(");
			strSql.Append("TargetId,TargetType,ParentId,ClassName,Sequence,Path,Depth)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(YSWL.MALL.Model.VPage.PhotoClass model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VPage_PhotoClass set ");
		...
		public bool Delete(int ClassId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VPage_PhotoClass ");
			strSql.Append(" where ClassId=?ClassId");
			MySqlParameter[] parameters = {
					new MySqlParameter("?ClassId", MySqlDbType.Int32,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public YSWL.MALL.Model.VPage.PhotoClass GetModel(int ClassId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ClassId,TargetId,TargetType,ParentId,ClassName,Sequence,Path,Depth from VPage_PhotoClass ");
			...
			YSWL.MALL.Model.VPage.PhotoClass model=new YSWL.MALL.Model.VPage.PhotoClass();
		...
		/// 得到一个对象实体
		/// </summary>
		public YSWL.MALL.Model.VPage.PhotoClass DataRowToModel(DataRow row)
		{
			YSWL.MALL.Model.VPage.PhotoClass model=new YSWL.MALL.Model.VPage.PhotoClass();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ClassId,TargetId,TargetType,ParentId,ClassName,Sequence,Path,Depth ");
			strSql.Append(" FROM VPage_PhotoClass ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ClassId,TargetId,TargetType,ParentId,ClassName,Sequence,Path,Depth ");
			strSql.Append(" FROM VPage_PhotoClass ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VPage_PhotoClass T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VPage_PhotoClass";
