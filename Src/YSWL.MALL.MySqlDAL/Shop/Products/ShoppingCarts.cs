...
namespace YSWL.MALL.MySqlDAL.Shop.Products
{
	...
	public partial class ShoppingCarts:IShoppingCarts
	{
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("ItemId", "Shop_ShoppingCarts");
        }
        ...
        public bool Add(YSWL.MALL.Model.Shop.Products.ShoppingCartItem model)
        {
            ...
            strSql.Append("ItemId,UserId,Target,Quantity,ItemType,Name,ThumbnailsUrl,Description,CostPrice,SellPrice,AdjustedPrice,Attributes,Weight,Deduct,Points,ProductLineId,SupplierId,SupplierName)");
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?Attributes", MySqlDbType.Text),
        ...
        public bool Update(YSWL.MALL.Model.Shop.Products.ShoppingCartItem model)
        {
            ...
            parameters[16].Value = model.ItemId;
        ...
        public YSWL.MALL.Model.Shop.Products.ShoppingCartItem GetModel(int ItemId, int UserId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  ItemId,UserId,Target,Quantity,ItemType,Name,ThumbnailsUrl,Description,CostPrice,SellPrice,AdjustedPrice,Attributes,Weight,Deduct,Points,ProductLineId,SupplierId,SupplierName from Shop_ShoppingCarts ");
            strSql.Append(" where ItemId=?ItemId and UserId=?UserId ");
            MySqlParameter[] parameters = {
					new MySqlParameter("?ItemId", MySqlDbType.Int32,4),
					new MySqlParameter("?UserId", MySqlDbType.Int32,4)			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ItemId,UserId,Target,Quantity,ItemType,Name,ThumbnailsUrl,Description,CostPrice,SellPrice,AdjustedPrice,Attributes,Weight,Deduct,Points,ProductLineId,SupplierId,SupplierName ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.* from Shop_ShoppingCarts T ");
