...
namespace YSWL.MALL.MySqlDAL.Shop.Sales
{
	...
	public partial class SalesRuleProduct:ISalesRuleProduct
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("RuleId", "Shop_SalesRuleProduct"); 
		}
		...
		public YSWL.MALL.Model.Shop.Sales.SalesRuleProduct GetModel(int RuleId,long ProductId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RuleId,ProductId,ProductName from Shop_SalesRuleProduct ");
			strSql.Append(" where RuleId=?RuleId and ProductId=?ProductId ");
			MySqlParameter[] parameters = {
					new MySqlParameter("?RuleId", MySqlDbType.Int32,4),
					new MySqlParameter("?ProductId", MySqlDbType.Int64,8)			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.* from Shop_SalesRuleProduct T ");
