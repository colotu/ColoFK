...
namespace YSWL.MALL.MySqlDAL.Shop.Distribution
{
	...
	public partial class SuppDistRegion:ISuppDistRegion
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("SupplierId", "Shop_SuppDistRegion"); 
		}
		...
		public YSWL.MALL.Model.Shop.Distribution.SuppDistRegion GetModel(int SupplierId,int RegionId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  SupplierId,RegionId from Shop_SuppDistRegion ");
			strSql.Append(" where SupplierId=?SupplierId and RegionId=?RegionId ");
			MySqlParameter[] parameters = {
					new MySqlParameter("?SupplierId", MySqlDbType.Int32,4),
					new MySqlParameter("?RegionId", MySqlDbType.Int32,4)			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.* from Shop_SuppDistRegion T ");
