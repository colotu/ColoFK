...
namespace YSWL.MALL.MySqlDAL.Shop.Order
{
	...
	public partial class OrderOptions:IOrderOptions
	{
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("LookupListId", "Shop_OrderOptions");
        }
        ...
        public bool Add(YSWL.MALL.Model.Shop.Order.OrderOptions model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?CustomerTitle", MySqlDbType.VarChar,500),
        ...
        public YSWL.MALL.Model.Shop.Order.OrderOptions GetModel(int LookupListId, int LookupItemId, long OrderId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  LookupListId,LookupItemId,OrderId,OrderCode,ListDescription,ItemDescription,AdjustedPrice,CustomerTitle,CustomerDescription from Shop_OrderOptions ");
            strSql.Append(" where LookupListId=?LookupListId and LookupItemId=?LookupItemId and OrderId=?OrderId ");
            MySqlParameter[] parameters = {
					new MySqlParameter("?LookupListId", MySqlDbType.Int32,4),
					new MySqlParameter("?LookupItemId", MySqlDbType.Int32,4),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.* from Shop_OrderOptions T ");
