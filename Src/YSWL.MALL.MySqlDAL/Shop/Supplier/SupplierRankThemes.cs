...
namespace YSWL.MALL.MySqlDAL.Shop.Supplier
{
	...
	public partial class SupplierRankThemes:ISupplierRankThemes
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("RankId", "Shop_SupplierRankThemes"); 
		}
		...
		public YSWL.MALL.Model.Shop.Supplier.SupplierRankThemes GetModel(int RankId,int ThemeId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RankId,ThemeId from Shop_SupplierRankThemes ");
			strSql.Append(" where RankId=?RankId and ThemeId=?ThemeId ");
			MySqlParameter[] parameters = {
					new MySqlParameter("?RankId", MySqlDbType.Int32,4),
					new MySqlParameter("?ThemeId", MySqlDbType.Int32,4)			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.* from Shop_SupplierRankThemes T ");
