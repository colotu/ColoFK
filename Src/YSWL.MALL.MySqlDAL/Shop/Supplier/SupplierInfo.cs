...
namespace YSWL.MALL.MySqlDAL.Shop.Supplier
{
    ...
    public partial class SupplierInfo : ISupplierInfo
    {
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("SupplierId", "Shop_Suppliers");
        }
        ...
        public int Add(YSWL.MALL.Model.Shop.Supplier.SupplierInfo model)
        {
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("?IsSuppApprove", MySqlDbType.Bit,1),
					new MySqlParameter("?ScoreDesc", MySqlDbType.Decimal,8),
					new MySqlParameter("?ScoreService", MySqlDbType.Decimal,8),
					new MySqlParameter("?ScoreSpeed", MySqlDbType.Decimal,8),
					...
					new MySqlParameter("?IndexProdTop", MySqlDbType.Int32,4),
					new MySqlParameter("?IndexContent", MySqlDbType.VarChar,-1),
        ...
        public YSWL.MALL.Model.Shop.Supplier.SupplierInfo DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (!string.IsNullOrWhiteSpace(row["Latitude"].ToString()))
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.* from Shop_Suppliers T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  SupplierId,Name,ShopName,CategoryId,Rank,UserId,UserName,TelPhone,CellPhone,ContactMail,Introduction,RegisteredCapital,RegionId,Address,Contact,EstablishedDate,EstablishedCity,LOGO,Fax,PostCode,HomePage,ArtiPerson,CompanyType,BusinessLicense,TaxNumber,AccountBank,AccountInfo,ServicePhone,QQ,MSN,Status,CreatedDate,CreatedUserId,UpdatedDate,UpdatedUserId,ExpirationDate,Balance,IsUserApprove,IsSuppApprove,ScoreDesc,ScoreService,ScoreSpeed,Recomend,Sequence,ProductCount,PhotoCount,ThemeId,Remark,AgentId,StoreStatus,Latitude,Longitude from Shop_Suppliers ");
       ...
       /// <returns></returns>
        public bool DeleteEx(int SupplierId)
        {
           ...
           List<CommandInfo> sqllist = new List<CommandInfo>();
            ...
            //strSql2.Append("delete from   Shop_SuppProductCategories WHERE  EXISTS(SELECT ProductId FROM   Shop_Products p WHERE  SupplierId=?SupplierId and  Shop_SuppProductCategories.ProductId=p.ProductId) ");
            ...
            //strSql3.Append(" delete from   Shop_Products WHERE SupplierId=?SupplierId ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.AppendFormat("SHOW TABLES LIKE '{0}'", table);
            object obj = DbHelperMySQL.GetSingle(strSql.ToString());
            if (obj == null)
            {
                return false;
        ...
        public bool Update(Model.Shop.Supplier.SupplierInfo model, int SupplierId, List<int> idList)
        {
            ...
            MySqlParameter[] parameter = { new MySqlParameter("?SupplierId", MySqlDbType.Int32) };
            ...
            {
                listCommand.Add(new CommandInfo(insertSb.ToString(), new MySqlParameter[0], EffentNextType.ExcuteEffectRows)); 
            }
            #endregion
        ...
        public bool Add(int supplierId, List<int> idList)
        {
            ...
            return DbHelperMySQL.ExecuteSql(insertSb.ToString())>0;
        }
