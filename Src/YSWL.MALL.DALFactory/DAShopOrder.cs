...
namespace YSWL.MALL.DALFactory
{
    public sealed class DAShopOrder : DataAccessBase
    {
        ...
        /// 创建OrdersHistory数据层接口。
        /// </summary>
        public static YSWL.MALL.IDAL.Shop.Order.IStock CreateStock()
        {
            string ClassNamespace = AssemblyPath + ".Shop.Order.Stock";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (YSWL.MALL.IDAL.Shop.Order.IStock)objType;
        }
