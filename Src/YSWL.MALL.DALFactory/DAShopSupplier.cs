...
namespace YSWL.MALL.DALFactory
{
    public sealed class DAShopSupplier : DataAccessBase
    {
		...
		/// 创建SuppAreas数据层接口。
		/// </summary>
		public static YSWL.MALL.IDAL.Shop.Supplier.ISuppAreas CreateSuppAreas()
        {
            string ClassNamespace = AssemblyPath + ".Shop.Supplier.SuppAreas";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (YSWL.MALL.IDAL.Shop.Supplier.ISuppAreas)objType;
        }
        /// <summary>
		/// 创建SuppAreaRelation数据层接口。
		/// </summary>
		public static YSWL.MALL.IDAL.Shop.Supplier.ISuppAreaRelation CreateSuppAreaRelation()
        {

            string ClassNamespace = AssemblyPath + ".Shop.Supplier.SuppAreaRelation";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (YSWL.MALL.IDAL.Shop.Supplier.ISuppAreaRelation)objType;
        }
    }
}
