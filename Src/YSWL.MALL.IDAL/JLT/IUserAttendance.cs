...
namespace YSWL.MALL.IDAL.JLT
{
    ...
    public interface IUserAttendance
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.JLT.UserAttendance model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.JLT.UserAttendance model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.JLT.UserAttendance GetModel(int AttendanceID);
        YSWL.MALL.Model.JLT.UserAttendance DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
