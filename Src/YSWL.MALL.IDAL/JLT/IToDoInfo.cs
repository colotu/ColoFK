...
namespace YSWL.MALL.IDAL.JLT
{
    ...
    public interface IToDoInfo
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.JLT.ToDoInfo model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.JLT.ToDoInfo model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.JLT.ToDoInfo GetModel(int ID);
        YSWL.MALL.Model.JLT.ToDoInfo DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
