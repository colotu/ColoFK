...
namespace YSWL.MALL.IDAL.Pay
{
	...
	public interface IBalanceDetails
	{
		...
		/// 增加一条数据
		/// </summary>
		long Add(YSWL.MALL.Model.Pay.BalanceDetails model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.Pay.BalanceDetails model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.Pay.BalanceDetails GetModel(long JournalNumber);
		YSWL.MALL.Model.Pay.BalanceDetails DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
