...
namespace YSWL.MALL.IDAL.SNS
{
	...
	public interface IGroupTopics
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.SNS.GroupTopics model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.SNS.GroupTopics model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.SNS.GroupTopics GetModel(int TopicID);
		YSWL.MALL.Model.SNS.GroupTopics DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
        ...
        /// 增加一个帖子
        /// </summary>
        int AddEx(YSWL.MALL.Model.SNS.GroupTopics Tmodel, YSWL.MALL.Model.SNS.Products PModel);
	    ...
	    bool DeleteGroupTopic(int topicId);
