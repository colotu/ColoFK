...
namespace YSWL.MALL.IDAL.SNS
{
	...
	public interface IGroupUsers
	{
		...
		/// 增加一条数据
		/// </summary>
		bool Add(YSWL.MALL.Model.SNS.GroupUsers model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.SNS.GroupUsers model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.SNS.GroupUsers GetModel(int GroupID,int UserID);
		YSWL.MALL.Model.SNS.GroupUsers DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
        ...
        /// 用户加入小组
        /// </summary>
        bool AddEx(YSWL.MALL.Model.SNS.GroupUsers model);
        /// <summary>
        /// 更新推荐状态
        /// </summary>
