...
namespace YSWL.MALL.IDAL.SNS
{
	...
	public interface ITagType
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.SNS.TagType model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.SNS.TagType model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		bool Delete(int ID);
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.SNS.TagType GetModel(int ID);
		YSWL.MALL.Model.SNS.TagType DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
