...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface IPhotos
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.SNS.Photos model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.Photos model);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.Photos GetModel(int PhotoID);

        YSWL.MALL.Model.SNS.Photos DataRowToModel(DataRow row);
