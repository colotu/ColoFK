...
namespace YSWL.MALL.IDAL.SNS
{
	...
	public interface IPhotoTags
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.SNS.PhotoTags model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.SNS.PhotoTags model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.SNS.PhotoTags GetModel(int TagID);
		YSWL.MALL.Model.SNS.PhotoTags DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
