...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface IUserAlbums
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.SNS.UserAlbums model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.UserAlbums model);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.UserAlbums GetModel(int AlbumID);

        YSWL.MALL.Model.SNS.UserAlbums DataRowToModel(DataRow row);
        ...
        YSWL.MALL.Model.SNS.UserAlbums GetUserAlbum(int type, int pid, int UserId);

        /// <summary>
        /// 更新部分数据
        /// </summary>
        bool UpdateEx(YSWL.MALL.Model.SNS.UserAlbums model);
        ...
        /// 增加专辑
        /// </summary>
        int AddEx(YSWL.MALL.Model.SNS.UserAlbums model, int TypeId);
