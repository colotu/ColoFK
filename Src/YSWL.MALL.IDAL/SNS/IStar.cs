...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface IStar
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.SNS.Star model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.Star model);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.Star GetModel(int ID);

        YSWL.MALL.Model.SNS.Star DataRowToModel(DataRow row);
