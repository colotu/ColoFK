...
namespace YSWL.MALL.IDAL.SNS
{
	...
	public interface IUserShip
	{
		...
		/// 增加一条数据
		/// </summary>
		bool Add(YSWL.MALL.Model.SNS.UserShip model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.SNS.UserShip model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.SNS.UserShip GetModel(int ActiveUserID,int PassiveUserID);
		YSWL.MALL.Model.SNS.UserShip DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
		...
		/// 获得数据列表
		/// </summary>
        List<YSWL.MALL.Model.SNS.UserShip> DataTableToList(DataTable dt);
		#endregion  成员方法
        ...
        bool FellowUser( YSWL.MALL.Model.SNS.UserShip model);
         bool UnFellowUser(int Userid, int FellowUserId);

         /// <summary>
		/// 获得数据列表
		/// </summary>
         List<YSWL.MALL.Model.SNS.UserShip> DataTableToListEx(DataTable dt);
