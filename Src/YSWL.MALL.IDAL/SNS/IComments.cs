...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface IComments
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.SNS.Comments model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.Comments model);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.Comments GetModel(int CommentID);

        YSWL.MALL.Model.SNS.Comments DataRowToModel(DataRow row);
        ...
        int AddEx(YSWL.MALL.Model.SNS.Comments ComModel);
