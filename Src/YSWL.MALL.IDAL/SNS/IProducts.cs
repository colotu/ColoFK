...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface IProducts
    {
        ...
        /// 增加一条数据
        /// </summary>
        long Add(YSWL.MALL.Model.SNS.Products model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.Products model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.Products GetModel(long ProductID);
        YSWL.MALL.Model.SNS.Products DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
