...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface ICategories
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.SNS.Categories model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.Categories model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.Categories GetModel(int CategoryId);
        YSWL.MALL.Model.SNS.Categories DataRowToModel(DataRow row);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        ...
        /// <returns></returns>
        bool AddCategory(YSWL.MALL.Model.SNS.Categories model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        bool UpdateCategory(YSWL.MALL.Model.SNS.Categories model);
