...
namespace YSWL.MALL.IDAL.SNS
{
    ...
    public interface IReport
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.SNS.Report model);

        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(YSWL.MALL.Model.SNS.Report model);
        ...
        /// 得到一个对象实体
        /// </summary>
        YSWL.MALL.Model.SNS.Report GetModel(int ID);

        YSWL.MALL.Model.SNS.Report DataRowToModel(DataRow row);
