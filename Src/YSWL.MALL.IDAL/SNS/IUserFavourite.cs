...
namespace YSWL.MALL.IDAL.SNS
{
	...
	public interface IUserFavourite
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(YSWL.MALL.Model.SNS.UserFavourite model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(YSWL.MALL.Model.SNS.UserFavourite model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		YSWL.MALL.Model.SNS.UserFavourite GetModel(int FavouriteID);
		YSWL.MALL.Model.SNS.UserFavourite DataRowToModel(DataRow row);
		/// <summary>
		/// 获得数据列表
		/// </summary>
		...
		#endregion  成员方法
		#region  MethodEx
        bool AddEx(YSWL.MALL.Model.SNS.UserFavourite FavModell,int TopicId, int ReplyId);
