...
namespace YSWL.MALL.IDAL.Shop.Supplier
{
	...
	public interface ISupplierInfo
	{
        ...
        bool Update(Model.Shop.Supplier.SupplierInfo supplierInfo,int SupplierId,List<int> idList, YSWL.MALL.Model.Shop.Supplier.SuppAreas suppAreaModel);
        ...
        /// <returns></returns>
        int GetSuppNum(DateTime? date);
        int GetRecordCount(string key, int areaid = 0);
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        DataSet GetListByPage(string key, int areaid, string orderby, int startIndex, int endIndex);
        /// <summary>
        /// 增加一条数据
        /// </summary>
        int Add(YSWL.MALL.Model.Shop.Supplier.SupplierInfo model, YSWL.MALL.Model.Shop.Supplier.SuppAreas suppAreaModel);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        bool DeleteSupp(int SupplierId);
    } 
}
