...
var submitAddPhoto = function (v, h, f) {
    $.ajax({
        ...
        data: { Type: "Photo", ImageUrl: ImageUrl, ShareDes: f.PhotoAddAlbumscontent, AblumId: f.myAlbums, PhotoCateId: f.PhotoCate },
...
$(function() {
    ...
    if (CheckUserLogin() == true) {
        ...
        $("#UploadPhotoBtn").click(function() { CheckUserState(); });
    }
});
                ...
                callbacks: {
                    onComplete: function (id, fileName, responseJSON) {
                        ...
                        if (responseJSON.success) {
                            $(".qq-upload-list").hide();
                            $.ajax({
                                url: $YSWL.BasePath + "profile/AjaxGetUploadPhotoResult",
