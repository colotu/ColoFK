...
$(function () {
    $(".AddTopicToFav").click(function () {
        ...
        if (CheckUserState()) {
            $.ajax({
                url: $YSWL.BasePath+"profile/AjaxAddTopicToFav",
                type: 'post',
                dataType: 'text',
                timeout: 10000,
    ...
    $(".btnReply").die("click").live("click", function () {
        ...
        if (CheckUserState()) {
            $.ajax({
                url: $YSWL.BasePath+"profile/AJaxCreateReply",
                type: 'post',
                dataType: 'text',
                timeout: 10000,
                data: { Des: Des, ReplyId: ReplyId },
                success: function (resultData) {
                    $("#YSWLTopicReply").prepend(resultData);
    ...
    $("#PostReply").click(function () {
        ...
        if (CheckUserState()) {
            ...
            $.ajax({
                url: $YSWL.BasePath+"profile/AJaxCreateTopicReply",
                type: 'post',
                dataType: 'text',
                timeout: 10000,
