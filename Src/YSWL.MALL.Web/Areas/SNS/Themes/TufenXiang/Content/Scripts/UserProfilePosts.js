...
var submit = function (v, h, f) {
    ...
    $.ajax({
        url: $YSWL.BasePath+"profile/AjaxPostForward",
    ...
    $(".postComment").die("click").live("click", function(e) {
        if (CheckUserState()) {
            ...
            if ($("#Inputcomment" + postid + "").children('div').length == 0) {
                ...
                $.ajax({
                    url: $YSWL.BasePath+"profile/AjaxGetCommentByPostId",
                    type: 'post',
                    dataType: 'text',
                    timeout: 10000,
                    data: { PostId: postid },
...
function commentRelyBtnFun() {
    $(".replyBtnPost").die("click").live("click", function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: $YSWL.BasePath+"profile/AjaxAddComment",
            type: 'post', dataType: 'text', timeout: 10000,
...
function DelPostFun() {
    $(".DelPost").die("click").live("click", function (e) {
        ...
        var postid = $(this).attr("postid");
        $.ajax({
            url: $YSWL.BasePath+"profile/AjaxDelPost",
            type: 'post', dataType: 'text', timeout: 10000,
            data: { PostId: postid },
            success: function (resultData) {
                if (resultData == "No") {
...
$(function() {
    $(".CreateReport").die("click").live("click", function() {
        ...
        $.ajax({
            ...
            dataType: "text",
            async: false,
            url: $YSWL.BasePath+"Profile/AjaxCreateReport",
...
var submitReport = function (v, h, f) {
    ...
    $.ajax({
        url: $YSWL.BasePath+"profile/AjaxAddReport",
        type: 'post', dataType: 'text', timeout: 10000,
...
$(function () {
    ...
    function InitData(pageIndex) {
        $("#PostAllContent").html("<div style='margin:0 auto;text-align: center;'><img src='/Areas/SNS/Themes/TufenXiang/Content/images/loads.gif' ></div>");
        $.ajax({
            type: "POST",
            dataType: "text",
            url: $YSWL.BasePath+"User/AjaxGetPostByIndex",
    ...
    function ReBindData(PostType) {
        ...
        $.ajax({
            ...
            dataType: "text",
            async: false,
            url: $YSWL.BasePath+"User/GetDataCountByPageType",
