...
$(function () {
    ...
    $("#btnBlogFav").click(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "text",
            url: $YSWL.BasePath+"Blog/AjaxFavCount",
            async: false,
    ...
    $("#AddCommentBtn").click(function (e) {
        ...
        if (CheckUserState()) {
            ...
            $.ajax({
                type: "POST",
                dataType: "text",
                url: $YSWL.BasePath+"Partial/AjaxAddComment",
                async: false,
...
$(function () {
    ...
    $.ajax({
        type: "POST",
        dataType: "text",
        url: $YSWL.BasePath+"Blog/AjaxGetPvCount",
        data: { id: TargetId },
        success: function (data) {
    ...
    $.ajax({
        ...
        dataType: "text",
        async: false,
        url: $YSWL.BasePath+"Blog/AjaxCount",
        data: { BlogId: TargetId },
        success: function (data) {
    ...
    function pageselectCallback(page_id, jq) {
        $("#CommentArea").html("<div style='margin:0 auto;text-align: center;'><img src='/Areas/SNS/Themes/TufenXiang/Content/images/ui.loading.gif' ></div>");
        $.ajax({
            type: "POST",
            dataType: "text",
            url: $YSWL.BasePath+"Partial/AjaxGetCommentsByType",
