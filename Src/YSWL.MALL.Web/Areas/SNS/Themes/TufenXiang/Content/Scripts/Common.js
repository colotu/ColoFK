    ...
    $.ajax({
        ...
        success: function (resultData) {
            if (resultData != "Yes") {
                ...
                html += "<div class='login2'><ul><li><a href='#' id='ajaxlogin'> <img src='/Areas/SNS/Themes/TufenXiang/Content/images/login.jpg'></a></li></ul>";
                html += "<ul><li><a href=$YSWL.BasePath + 'Account/Register'><img src='/Areas/SNS/Themes/TufenXiang/Content/images/reg.jpg'></a></li></ul>";
                html += "<ul><li><a href='/social/sina'><img src='/Areas/SNS/Themes/TufenXiang/Content/images/sin.jpg'></a></li><li><a href='/social/sina'>新浪微博</a></li></ul>";
                html += "<ul style='display:none'><li><a href='http://open.denglu.cc/transfer/tencent?appid=" + resultData + "'><img src='/Areas/SNS/Themes/TufenXiang/Content/images/tengxun.jpg'></a></li><li><a href='http://open.denglu.cc/transfer/tencent?appid=" + resultData + "'>腾讯微博</a></li></ul>";
                html += "<ul><li><a href='/social/qq'> <img src='/Areas/SNS/Themes/TufenXiang/Content/images/qq.jpg'></a></li> <li><a href='/social/qq'>QQ登录</a></li></ul></div>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (parseInt(data.split("|")[0]) > 0) {
                $("#headers").load($YSWL.BasePath+"Partial/Header");
...
var AjaxLoginGetUserInfo = function (pointer, rankscore) {
    $.ajax({
        type: "get",
        dataType: "text",
        url: $YSWL.BasePath+"Partial/Header",
