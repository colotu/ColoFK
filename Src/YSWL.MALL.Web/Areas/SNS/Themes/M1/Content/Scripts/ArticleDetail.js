...
$(function () {
    ...
    $("#btnArticleFav").click(function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "text",
            url: $YSWL.BasePath+"Article/AjaxFavCount",
            async: false,
    ...
    $("#AddCommentBtn").click(function (e) {
        ...
        if (CheckUserState()) {
            ...
            $.ajax({
                type: "POST",
                dataType: "text",
                url: $YSWL.BasePath + "Article/AjaxAddComment",
                async: false,
...
$(function () {
    ...
    $.ajax({
        type: "POST",
        dataType: "text",
        url: $YSWL.BasePath + "Article/AjaxGetPvCount",
        data: { id: TargetId },
        success: function (data) {
    ...
    $.ajax({
        ...
        dataType: "text",
        async: false,
        url: $YSWL.BasePath + "Article/AjaxCount",
        data: { ContentId: TargetId },
        success: function (data) {
    ...
    function pageselectCallback(page_id, jq) {
        ...
        $.ajax({
            type: "POST",
            dataType: "text",
            url: $YSWL.BasePath + "Article/AjaxGetComments",
