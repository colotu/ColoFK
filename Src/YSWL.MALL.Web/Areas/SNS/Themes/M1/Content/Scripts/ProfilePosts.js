        ...
        callbacks: {
            onComplete: function (id, fileName, responseJSON) {
                ...
                if (type == "Photo") {
                    ...
                    if (responseJSON.success) {
                        $("#ProductResultTemplate2").load($YSWL.BasePath + "profile/AjaxProductResult?image=" + responseJSON.data.format("T116x170_") + "&data=" + responseJSON.data, { limit: 25 },
                     function () {
...
function addProductPost(imageurl, sharedes, albumid, proname, proprice, prourl) {
    ...
    $.ajax({
        url: $YSWL.BasePath + "profile/AjaxProductPost",
        type: 'post', dataType: 'text', timeout: 10000,
