...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class UserCenterController : SNSUserControllerBase
    {
        ...
        private YSWL.MALL.BLL.Members.PointsDetail detailBll = new BLL.Members.PointsDetail();
        private YSWL.MALL.BLL.Members.SiteMessage bllSM = new BLL.Members.SiteMessage();
        private YSWL.MALL.BLL.Members.UsersExp userEXBll = new BLL.Members.UsersExp();
        private YSWL.MALL.BLL.Members.UserBind userBind = new BLL.Members.UserBind();
        ...
        public void UpdateUserInfo(FormCollection collection)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    model.RegionId =Common.Globals.SafeInt(collection["RegionId"],0);
        ...
        public void SubmitApprove(FormCollection collection)
        {
            ...
            if (Session["USERAPPROVE"] != null)
            {
                ...
                string ImageFile = "/"+MvcApplication.UploadFolder+"/SNS/Images/ApproveImage/";
