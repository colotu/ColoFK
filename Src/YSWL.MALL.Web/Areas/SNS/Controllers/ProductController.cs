...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class ProductController : SNSControllerBase
    {
        ...
        YSWL.MALL.BLL.SNS.SearchWordTop SearchBll = new YSWL.MALL.BLL.SNS.SearchWordTop();
        ...
        {
            YSWL.MALL.ViewModel.SNS.ProductCategory Model = CateBll.GetCateListByParentId(topcid);
            ...
            if (topcid == 0 && cid == 0)
            {
                ...
                YSWL.MALL.Model.SNS.Categories CateModel = CateBll.GetModel(cname);
            ...
            YSWL.MALL.BLL.SNS.Comments comBll = new YSWL.MALL.BLL.SNS.Comments();
            Model.CommentList = comBll.GetCommentByIds(CommentsIdString, (int)YSWL.MALL.Model.SNS.EnumHelper.PostContentType.Product);
            #endregion
        ...
        public ActionResult Detail(int pid)
        {
            ...
            YSWL.MALL.ViewModel.SNS.TargetDetail DetailModel = new MALL.ViewModel.SNS.TargetDetail();
            YSWL.MALL.Model.SNS.ProductQuery Query = new Model.SNS.ProductQuery();
            YSWL.MALL.BLL.SNS.Tags tagsBll = new YSWL.MALL.BLL.SNS.Tags();
            int TypeInt = (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Product;
            int CommentType = (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Product;
            DetailModel = ProductBll.GetTargetAssiationInfo(pid);
            #region 可能喜欢的
            //TODO:  下面注释的代码是后期需要的，由于现在数据库中的数据比较少，所以可能喜欢的商品取的是相应商品顶级分类下的商品
            ...
            string CommentsIdString = string.Join(",", ProductIdList).TrimEnd(',');
            YSWL.MALL.BLL.SNS.Comments comBll = new YSWL.MALL.BLL.SNS.Comments();
            DetailModel.CommentList = comBll.GetCommentByIds(CommentsIdString, (int)YSWL.MALL.Model.SNS.EnumHelper.PostContentType.Product);
        ...
        //    int CommentType = type == "Product" ? (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Product : (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo;
        ...
        public ActionResult GetCount(FormCollection Fm)
        {
            ...
            else
            {
                ...
                YSWL.MALL.BLL.SNS.Comments commentBll = new YSWL.MALL.BLL.SNS.Comments();
                YSWL.MALL.BLL.SNS.UserFavourite ufBll = new YSWL.MALL.BLL.SNS.UserFavourite();

                int favcount = ufBll.GetFavCountByTargetId(ProductId, (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Product);
                int commmentcount = commentBll.GetCommentCount((int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Product, ProductId);
        ...
        {
            bool IsOpen = YSWL.MALL.BLL.SysManage.ConfigSystem.GetBoolValueByCache("SNS_Product_OpenRedirect");
