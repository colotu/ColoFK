...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class BlogController : SNSControllerBase
    {
        //
        // GET: /SNS/Blog/
        private  YSWL.MALL.BLL.SNS.UserBlog blogBll=new UserBlog();
        public ActionResult Index(int? page)
        {
            ...
            if (totalcount == 0)
                return View();
            PagedList<YSWL.MALL.Model.SNS.UserBlog> BlogList = new PagedList<YSWL.MALL.Model.SNS.UserBlog>(
        ...
        public ActionResult BlogDetail(int id)
        {
            ...
            YSWL.MALL.Model.SNS.UserBlog userBlog = blogBll.GetModelByCache(id);
        ...
        {
           List<YSWL.MALL.Model.SNS.UserBlog> blogList =blogBll.GetMoreList(UserId, BlogId, top);
           return PartialView(viewName, blogList);
        }
        public PartialViewResult HotBlog(string viewName = "_HotBlog", int top = -1)
        {
            List<YSWL.MALL.Model.SNS.UserBlog> blogList = blogBll.GetHotBlogList( top);
           return PartialView(viewName, blogList);
        }
        ...
        public PartialViewResult NewComment(string viewName = "_NewComment", int top = 15)
        {
            ...
            List<YSWL.MALL.Model.SNS.Comments> blogCommentList = commentBll.GetBlogComment(" type=4 and Status=1", " CreatedDate desc",top);
            //过滤HTML 标签
        ...
        {
            List<YSWL.MALL.Model.SNS.UserBlog> userBlogList = blogBll.GetActiveUser(top);
        ...
        {
            YSWL.MALL.Model.SNS.UserBlog blogModel = blogBll.GetModel(BlogId);
