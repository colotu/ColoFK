...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class PhotoController : SNSControllerBase
    {
        ...
        private  YSWL.MALL.BLL.SNS.Categories cateBll=new Categories();
        ...
        public ActionResult Index(int type, int categoryId, string address, string orderby, int? pageIndex,string vName="Index")
        {
            ...
            // photoList.ZuiInList = bllPhotos.GetZuiInListByCache((int)YSWL.MALL.Model.SNS.EnumHelper.PhotoType.ShareGoods, 3);
        ...
        {
            List<YSWL.MALL.Model.SNS.Photos> photoList = bllPhotos.GetTopPhotoPostByType(top, categoryId);
        ...
        {
            List<YSWL.MALL.Model.SNS.Photos> list = bllPhotos.GetTopPhotoPostByType(9, (int)YSWL.MALL.Model.SNS.EnumHelper.PhotoType.ShareGoods);
        ...
        public ActionResult Detail(int pid)
        {
            ...
            YSWL.MALL.BLL.SNS.PhotoTags tagsBll = new YSWL.MALL.BLL.SNS.PhotoTags();
            ...
            DetailModel.FavUserList = ufBll.GetFavUserByTargetId(pid, (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Photo, 8);
        ...
        public PartialViewResult PhotoCatePart(int categoryId, int top, YSWL.MALL.Model.SNS.EnumHelper.RecommendType mode = YSWL.MALL.Model.SNS.EnumHelper.RecommendType.Home,string viewName = "_PhotoCatePart")
        {
            YSWL.MALL.BLL.SNS.Photos PhotoBll = new YSWL.MALL.BLL.SNS.Photos();
            List<YSWL.MALL.Model.SNS.Photos> PhotoList = PhotoBll.GetRecPhoto(categoryId,top,mode);
        ...
        public ActionResult GetCount(FormCollection Fm)
        {
            ...
            else
            {
                ...
                YSWL.MALL.BLL.SNS.Comments commentBll = new YSWL.MALL.BLL.SNS.Comments();
                YSWL.MALL.BLL.SNS.UserFavourite ufBll = new YSWL.MALL.BLL.SNS.UserFavourite();
                int favcount = ufBll.GetFavCountByTargetId(PhotoId, (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Photo);
                int commmentcount = commentBll.GetCommentCount((int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo, PhotoId);
                //更新浏览数
