...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class PartialController : SNSControllerBase
    {
        ...
        public PartialViewResult UserInfo(int uid = -1, string nickname = "")
        {
            ...
            UserModel.Address = RegionBll.GetAddress(UserModel.RegionId);
            //是否是达人
        ...
        public PartialViewResult SelfRight()
        {
            ...
            model.UserInfo.Address = RegionBll.GetAddress(model.UserInfo.RegionId);
        ...
        public ActionResult AjaxGetPostByIndex(FormCollection Fm)
        {
            ...
            list = PostsBll.GetPostByType(UserId, ViewModel.ViewModelBase.GetStartPageIndex(PageSize, pageIndex), ViewModel.ViewModelBase.GetEndPageIndex(PageSize, pageIndex), PostType, YSWL.Components.MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.SNS), IncludeProduct);
