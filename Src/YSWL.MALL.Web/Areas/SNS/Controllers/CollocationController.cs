...
{
    public class CollocationController : SNSControllerBase
    {
        ...
        public ActionResult Index(string orderby, int? pageIndex)
        {
            ...
            //获取总条数
            int categoryId = YSWL.MALL.BLL.SysManage.ConfigSystem.GetIntValueByCache("SNS_Collocation_Category");
            if (categoryId ==-1)
            {
                categoryId = 167;
            }
            ...
            if (Request.IsAjaxRequest())
                return PartialView("CollocationList", photoList);
        ...
        public ActionResult CollocationWaterfall(string orderby, int startIndex)
        {
            MALL.ViewModel.SNS.PhotoList photoList = new MALL.ViewModel.SNS.PhotoList();
        ...
        public ActionResult ScrollCollocation()
        {
            int categoryId = YSWL.MALL.BLL.SysManage.ConfigSystem.GetIntValueByCache("SNS_Collocation_Category");
            if (categoryId ==-1)
            {
