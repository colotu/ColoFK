...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class AudioController : SNSControllerBase
    {
        ...
        public ActionResult Index(int? pageIndex)
        {
            ...
            //分页获取数据
            PagedList<YSWL.MALL.Model.SNS.Posts> AudioList = postBll.GetAudioListByPage(
        ...
        public ActionResult AudiosWaterfall(int startIndex)
        {
            ...
            //分页获取数据
            List<YSWL.MALL.Model.SNS.Posts> AudioList = postBll.GetAudioListByPage(
        ...
        {
            YSWL.MALL.Model.SNS.Posts audioModel = postBll.GetModel(id);
            if (audioModel == null)
            {
