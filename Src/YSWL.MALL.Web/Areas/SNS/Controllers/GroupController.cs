...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class GroupController : SNSControllerBase
    {
        ...
        private YSWL.MALL.BLL.SNS.GroupTags bllGroupTags = new YSWL.MALL.BLL.SNS.GroupTags();
        ...
        {
            YSWL.MALL.ViewModel.SNS.GroupIndex groupIndex = new YSWL.MALL.ViewModel.SNS.GroupIndex();
        ...
        public ActionResult Create(RegisterGroup model)
        {
            ...
            {
                //TODO: 移动临时文件抽取共通方法 BEN 2012-10-27
        ...
        public ActionResult Update(UpdateGroup model)
        {
            ...
            if (!string.IsNullOrWhiteSpace(model.GroupLogo) && model.GroupLogo != groups.GroupLogo)
            {
                ...
                {
                    //删除历史图片
                    YSWL.MALL.Web.Components.FileHelper.DeleteFile(EnumHelper.AreaType.SNS, groups.GroupLogoThumb);
                    YSWL.MALL.Web.Components.FileHelper.DeleteFile(EnumHelper.AreaType.SNS, groups.GroupLogo);
                    if (BLL.SysManage.ConfigSystem.GetValueByCache("SNS_ImageStoreWay") == "1")
                    {
                        groups.GroupLogoThumb = model.GroupLogo;
                        groups.GroupLogo = model.GroupLogo;
        ...
        {
          List<YSWL.MALL.Model.SNS.Groups> groupList= bllGroups.GetTopList(Top, "", "CreatedDate desc");
        ...
        {
            List<YSWL.MALL.Model.SNS.GroupTopics> newGroupTopic = bllTopic.GetList4Model(Top, "Status=1", "TopicID desc");
        ...
        {
            List<YSWL.MALL.Model.SNS.GroupTopics> GroupTopic = bllTopic.GetHotListByGroup(-1, Top);
        ...
        {
            List<YSWL.MALL.Model.SNS.GroupTopics> GroupTopic = bllTopic.GetList4Model(Top, "Status=1 and IsAdminRecommend=1", "TopicID desc");
            return PartialView(ViewName, GroupTopic);
        }
        #endregion
