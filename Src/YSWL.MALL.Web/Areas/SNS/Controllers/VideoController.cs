...
namespace YSWL.MALL.Web.Areas.SNS.Controllers
{
    public class VideoController : SNSControllerBase
    {
        ...
        public ActionResult Index(int? pageIndex)
        {
            ...
            //分页获取数据
            PagedList<YSWL.MALL.Model.SNS.Posts> VideoList = postBll.GetVideoListByPage(
        ...
        public ActionResult VideosWaterfall(int startIndex)
        {
            ...
            //分页获取数据
            List<YSWL.MALL.Model.SNS.Posts> VideoList = postBll.GetVideoListByPage(
        ...
        {
            YSWL.MALL.BLL.SNS.Posts postBll = new Posts();
            YSWL.MALL.Model.SNS.Posts videoModel = postBll.GetModel(id);
            if (videoModel == null)
            {
            ...
            ViewBag.Commentcount = commentBll.GetCommentCount((int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Normal, id);
            #region SEO 优化设置
        ...
        {
            YSWL.MALL.BLL.Members.UsersExp usersExpBll = new BLL.Members.UsersExp();
        ...
        {
            YSWL.MALL.BLL.SNS.Posts postBll=new Posts();
            List<YSWL.MALL.Model.SNS.Posts> listPost = postBll.GetVideoList(id, top);
