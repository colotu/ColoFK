        ...
        callbacks: {
            ...
            onComplete: function (id, fileName, responseJSON) {
                ...
                if (responseJSON.success) {
                    ulbtnparent.append(('<div class="upload_img_wrap"><div class="upload_img"><img src="{0}"></div><div class="toolbar"><a href="javascript:;"  onclick="nameDel(this);"  item="{0}" itemname="{1}" ><img src="/Areas/MB/Themes/MB01/Content/images/close.png" alt="删除" /></a></div></div>').format(
