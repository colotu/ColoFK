$(function () {
    ...
    $("#switch").click(function () {
        if ($(this).is(".icon-list-l")) {//显示一排两列
            $(this).removeClass("icon-list-l").addClass("icon-list-s");
            $("#product_content").removeClass("pro_container1_list").addClass("pro_container2_list");
            $("body").addClass("m_home");
        } else if ($(this).is(".icon-list-s")) {//显示一排一列
            $(this).removeClass("icon-list-s").addClass("icon-list-l");
            $("#product_content").removeClass("pro_container2_list").addClass("pro_container1_list");
            $("body").removeClass("m_home");
        }
    })
...
var getProductUrl = function () {
    ...
    return url.format($('#hidCid').val(), brandId, attrValue, $('.modList.sort_a').attr("mod"), priceStr, "ajaxViewName=_ProdList");
}
