...
function showLoad(msg) {
    ...
    var templete = '<div class="modal-div" style=""><img style="width: 64px;position: relative;" src="/Areas/MB/Themes/MB02/Content/images/loading.gif"><div style="position: static;color: #fff;text-align: center;margin: 0 auto;width: 80%;font-size: 16px;">' + msg + '</div></div>';
