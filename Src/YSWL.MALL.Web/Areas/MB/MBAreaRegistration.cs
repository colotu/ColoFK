...
namespace YSWL.MALL.Web.Areas.MB
{
    public class MBAreaRegistration : AreaRegistrationBase
    {
       public MBAreaRegistration() : base(AreaRoute.MB ){ }
        //public MBAreaRegistration()
        //{
        //    base.AreaRegistration(AreaRoute.MB, "mb");
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                ...
                url: CurrentRoutePath + "s/sl/{areaid}/{mod}/{keyword}",
                defaults:
                    new
                    {
                        controller = "Search",
                 ...
                 {
                     areaid = @"[\d]{0,11}",
                     mod = @"prod|favo|sales|years" //大小写字母/数字/下划线                
                 },
    namespaces: new string[] { string.Format("YSWL.MALL.Web.Areas.{0}.Controllers", AreaName) }
                );
            #endregion
            ...
            #region 店铺列表路由
            context.MapRoute(
                name: AreaName + "_StoreList_1",
                url: CurrentRoutePath + "store/sl/{areaid}/{mod}",
                defaults:
                    new
                    {
                        controller = "Store",
