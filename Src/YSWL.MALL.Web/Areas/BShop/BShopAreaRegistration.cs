...
namespace YSWL.MALL.Web.Areas.BShop
{
    public class BShopAreaRegistration : AreaRegistrationBase
    {
        public BShopAreaRegistration()
            : base(AreaRoute.BShop)
        {
        }
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                ...
                url: CurrentRoutePath + "Search/StoreList/{areaid}/{mod}/{keyword}",
                defaults:
                    new
                    {
                        controller = "Search",
            ...
            context.MapRoute(
                ...
                url: CurrentRoutePath + "Store/StoreList/{areaid}/{mod}",
                defaults:
                    new
                    {
                        controller = "Store",
