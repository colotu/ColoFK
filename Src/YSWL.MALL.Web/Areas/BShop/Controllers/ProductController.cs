...
{
    public class ProductController : BShopControllerBase
    {
        #region 全局变量
            ...
            if (categoryModel != null)
            {
                ...
                if (currentModel != null)
                {
                    ...
                    if (list != null && list.Count > 0)
                    {
                        ...
                        {
                            CategoryStr.AppendFormat("<a href='" + YSWL.Components.MvcApplication.GetCurrentRoutePath(AreaRoute.BShop) + "Product/" + categoryInfo.CategoryId + "'>{0}</a> > ", categoryInfo.Name);
                        }
                    }
