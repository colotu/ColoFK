...
namespace YSWL.MALL.Web.Areas.BShop.Controllers
{
    ...
    /// </summary>
    [BShopError]
    public class BShopControllerBaseUser : YSWL.MALL.Web.Controllers.ControllerBaseUser
    {
        ...
        public BShopControllerBaseUser(Func<ActionExecutingContext, ActionResult> func = null)
        {
            if (func == null)
            {
                //Shop 区域默认登录
