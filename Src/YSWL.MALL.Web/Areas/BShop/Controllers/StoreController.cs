...
{
    public class StoreController : BShopControllerBase
    {
        //
        // GET: /Shop/Supplier/
        ...
        /// <returns></returns>
        public ActionResult StoreList(int areaid=0,string mod="", int pageIndex = 1, int pageSize = 20, string vName = "StoreList", string ajaxVName = "_StoreList")
        {
            ...
            int toalCount = suppinfoBll.GetRecordCount("", areaid);
