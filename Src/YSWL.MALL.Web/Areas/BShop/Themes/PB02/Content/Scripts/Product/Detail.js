$(function () {
    ...
    $("#id-buyer-comment").click(function () {//顾客评论
        $("#LoadData").html("<div style='margin:0 auto;text-align: center;'><img src='/Areas/BShop/Themes/PB02/Content/images/loads.gif' ></div>");
...
function qh() {
    ...
    function tshow(i) {
        ...
        $("#samllImg").attr({ jqimg: $('#lbtp li img').eq(i).attr('jqimg'), src:  $('#lbtp li img').eq(i).attr('src').replace('T81X81_', 'T350X350_') });
    }
}
