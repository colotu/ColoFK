...
if (!window.jq || "function" !== typeof jq) {
    var jq = function (g) {
        ...
        function u(a, c) {
            if (a) {
                if (a.nodeType) return c[c.length++] = a;
                for (var b = 0,
        ...
        function E(a, c) {
            ...
            a.os.ie = c.match(/MSIE 10.0/i) ? !0 : !1;
        ...
        function v(a) {
            return a._jqmid || (a._jqmid = N++)
        }
        function O(a, c, b, d) {
            c = F(c);
            if (c.ns) var e = RegExp("(?:^| )" + c.ns.replace(" ", " .* ?") + "(?: |$$)");
            return (k[v(a)] || []).filter(function (a) {
        ...
        function w(a, c, b, d, l) {
            ...
            function (b, c) {
                ...
                n = f || c,
                h = function (b) {
                    var c = n.apply(a, [b].concat(b.data)); !1 === c && b.preventDefault();
                    return c
                },
                f = e.extend(F(b), {
                    fn: c,
        ...
        function H(a, c) {
            ...
            if ((b = v(a)) && k[b]) {
                for (var d in k[b]) a.removeEventListener(k[b][d].e, k[b][d].proxy, !1);
                delete k[b]
            }
        }
        function I(a, c) {
            if (a) {
                var b = a.childNodes;
                if (b && 0 < b.length) for (var d in b) I(b[d], c);
                H(a, c)
            }
        }
        var f, h = g.document,
        ...
        p = function (a, c) {
            this.length = 0;
            if (a) {
                if (a instanceof p && c == f) return a;
                if (e.isFunction(a)) return e(h).ready(a);
                if (e.isArray(a) && a.length != f) {
                    for (var b = 0; b < a.length; b++) this[this.length++] = a[b];
                    return this
                }
                if (e.isObject(a) && e.isObject(c)) {
                    if (a.length == f) a.parentNode == c && (this[this.length++] = a);
                    else for (b = 0; b < a.length; b++) a[b].parentNode == c && (this[this.length++] = a[b]);
                    return this
                }
                if (e.isObject(a) && c == f) return this[this.length++] = a,
                this;
                if (c !== f) {
                    if (c instanceof p) return c.find(a)
                } else c = h
            } else return this;
        ...
        e.map = function (a, c) {
            var b, d = [],
            l;
            if (e.isArray(a)) for (l = 0; l < a.length; l++) b = c(a[l], l),
            b !== f && d.push(b);
            else if (e.isObject(a)) for (l in a) a.hasOwnProperty(l) && (b = c(a[l], l), b !== f && d.push(b));
            return e([d])
        };
        e.each = function (a, c) {
            var b;
            if (e.isArray(a)) for (b = 0; b < a.length && !1 !== c(b, a[b]); b++);
            else if (e.isObject(a)) for (b in a) if (a.hasOwnProperty(b) && !1 === c(b, a[b])) break;
            return a
        };
        e.extend = function (a) {
            a == f && (a = this);
        ...
        e.fn = p.prototype = {
            ...
            selector: function (a, c) {
                a = a.trim();
                if ("#" === a[0] && -1 == a.indexOf(".") && -1 === a.indexOf(" ") && -1 === a.indexOf(">")) c == h ? u(c.getElementById(a.replace("#", "")), this) : u(D(a, c), this);
            ...
            map: function (a) {
                var c, b = [],
                d;
                for (d = 0; d < this.length; d++) c = a(d, this[d]),
                c !== f && b.push(c);
                return e([b])
            },
            each: function (a) {
            ...
            ready: function (a) {
                "complete" === h.readyState || "loaded" === h.readyState || !e.os.ie && "interactive" === h.readyState ? a() : h.addEventListener("DOMContentLoaded", a, !1);
                return this
            },
            find: function (a) {
            ...
            html: function (a, c) {
                ...
                for (var b = 0; b < this.length; b++) !1 !== c && e.cleanUpContent(this[b], !1, !0),
                this[b].innerHTML = a;
                return this
            },
            text: function (a) {
            ...
            css: function (a, c, b) {
                b = b != f ? b : this[0];
                if (0 === this.length) return this;
                if (c == f && "string" === typeof a) return g.getComputedStyle(b),
                b.style[a] ? b.style[a] : g.getComputedStyle(b)[a];
                for (b = 0; b < this.length; b++) if (e.isObject(a)) for (var d in a) this[b].style[d] = a[d];
                else this[b].style[a] = c;
                return this
            },
            vendorCss: function (a, c, b) {
                return this.css(e.feat.cssPrefix + a, c, b)
            },
            empty: function () {
            ...
            toggle: function (a) {
                for (var c = !0 === a ? !0 : !1, b = 0; b < this.length; b++) "none" !== g.getComputedStyle(this[b]).display || a !== f && !1 === c ? (this[b].setAttribute("jqmOldStyle", this[b].style.display), this[b].style.display = "none") : (this[b].style.display = this[b].getAttribute("jqmOldStyle") != f ? this[b].getAttribute("jqmOldStyle") : "block", this[b].removeAttribute("jqmOldStyle"));
                return this
            },
            val: function (a) {
                if (0 === this.length) return a === f ? f : this;
                if (a == f) return this[0].value;
                for (var c = 0; c < this.length; c++) this[c].value = a;
                return this
            },
            attr: function (a, c) {
                if (0 === this.length) return c === f ? f : this;
                if (c === f && !e.isObject(a)) return this[0].jqmCacheId && m[this[0].jqmCacheId][a] ? this[0].jqmCacheId && m[this[0].jqmCacheId][a] : this[0].getAttribute(a);
                for (var b = 0; b < this.length; b++) if (e.isObject(a)) for (var d in a) e(this[b]).attr(d, a[d]);
                else e.isArray(c) || e.isObject(c) || e.isFunction(c) ? (this[b].jqmCacheId || (this[b].jqmCacheId = e.uuid()), m[this[b].jqmCacheId] || (m[this[b].jqmCacheId] = {}), m[this[b].jqmCacheId][a] = c) : null == c && c !== f ? (this[b].removeAttribute(a), this[b].jqmCacheId && m[this[b].jqmCacheId][a] && delete m[this[b].jqmCacheId][a]) : this[b].setAttribute(a, c);
                return this
            },
            removeAttr: function (a) {
                for (var c = this,
                b = 0; b < this.length; b++) a.split(/\s+/g).forEach(function (d) {
                    c[b].removeAttribute(d);
                    c[b].jqmCacheId && m[c[b].jqmCacheId][a] && delete m[c[b].jqmCacheId][a]
                });
                return this
            },
            prop: function (a, c) {
                ...
                if (c === f && !e.isObject(a)) {
                    var b;
                    return this[0].jqmCacheId && r[this[0].jqmCacheId][a] ? this[0].jqmCacheId && r[this[0].jqmCacheId][a] : !(b = this[0][a]) && a in this[0] ? this[0][a] : b
                }
                for (b = 0; b < this.length; b++) if (e.isObject(a)) for (var d in a) e(this[b]).prop(d, a[d]);
                else e.isArray(c) || e.isObject(c) || e.isFunction(c) ? (this[b].jqmCacheId || (this[b].jqmCacheId = e.uuid()), r[this[b].jqmCacheId] || (r[this[b].jqmCacheId] = {}), r[this[b].jqmCacheId][a] = c) : null == c && c !== f ? e(this[b]).removeProp(a) : this[b][a] = c;
                return this
            },
            removeProp: function (a) {
                ...
                b = 0; b < this.length; b++) a.split(/\s+/g).forEach(function (d) {
                    c[b][d] && delete c[b][d];
                    c[b].jqmCacheId && r[c[b].jqmCacheId][a] && delete r[c[b].jqmCacheId][a]
                });
                return this
            },
            remove: function (a) {
                a = e(this).filter(a);
                if (a == f) return this;
                for (var c = 0; c < a.length; c++) e.cleanUpContent(a[c], !0, !0),
            ...
            removeClass: function (a) {
                for (var c = 0; c < this.length; c++) {
                    ...
                    this[c].className = 0 < b.length ? b.trim() : ""
                }
                return this
            },
            replaceClass: function (a, c) {
                for (var b = 0; b < this.length; b++) if (a == f) this[b].className = c;
                else {
            ...
            append: function (a, c) {
                ...
                if (e.isArray(a) || e.isObject(a)) a = e(a);
                var b;
                for (b = 0; b < this.length; b++) if (a.length && "string" != typeof a) a = e(a),
                B(a, this[b], c);
                else {
                    var d = U.test(a) ? e(a) : f;
                    if (d == f || 0 == d.length) d = h.createTextNode(a);
                    d.nodeName != f && "script" == d.nodeName.toLowerCase() && (!d.type || "text/javascript" === d.type.toLowerCase()) ? g.eval(d.innerHTML) : d instanceof p ? B(d, this[b], c) : c != f ? this[b].insertBefore(d, this[b].firstChild) : this[b].appendChild(d)
                }
                return this
            },
            ...
            parent: function (a, c) {
                if (0 == this.length) return this;
                for (var b = [], d = 0; d < this.length; d++) for (var f = this[d]; f.parentNode && f.parentNode != h && !(b.push(f.parentNode), f.parentNode && (f = f.parentNode), !c); );
                return this.setupOld(e(t(b)).filter(a))
            },
            parents: function (a) {
            ...
            closest: function (a, c) {
                ...
                for (; b && -1 == d.indexOf(b); ) b = b !== c && b !== h && b.parentNode;
                return e(b)
            },
            filter: function (a) {
            ...
            data: function (a, c) {
                ...
                return this.oldElement != f ? this.oldElement : e()
            },
            clone: function (a) {
                a = !1 === a ? !1 : !0;
                if (0 == this.length) return this;
            ...
            serialize: function () {
                ...
                for (var a = [], c = 0; c < this.length; c++) this.slice.call(this[c].elements).forEach(function (b) {
                    ...
                    if ("fieldset" != b.nodeName.toLowerCase() && (!b.disabled && "submit" != c && "reset" != c && "button" != c && ("radio" != c && "checkbox" != c || b.checked)) && b.getAttribute("name")) if ("select-multiple" == b.type) for (c = 0; c < b.options.length; c++) b.options[c].selected && a.push(b.getAttribute("name") + "=" + encodeURIComponent(b.options[c].value));
        ...
        e.ajax = function (a) {
            ...
            try {
                ...
                c.onreadystatechange = function () {
                    ...
                    if (4 === c.readyState) {
                        ...
                        if (200 <= c.status && 300 > c.status || 0 === c.status && "file:" == h) {
                            ...
                            0 === c.status && 0 === d.length && (g = !0);
                            g ? b.error.call(n, c, "parsererror", g) : b.success.call(n, d, "success", c)
                        } else g = !0,
                        b.error.call(n, c, "error");
                        b.complete.call(n, c, g ? "error" : "success")
                    }
                };
                ...
                if (!1 === b.beforeSend.call(n, c, b)) return c.abort(),
                !1;
                0 < b.timeout && (f = setTimeout(function () {
                    c.onreadystatechange = s;
                    c.abort();
                    b.error.call(n, c, "timeout")
                },
                b.timeout));
                c.send(b.data)
            } catch (m) {
                console.log(m),
                b.error.call(n, c, "error", m)
            }
            return c
        };
        e.get = function (a, c) {
        ...
        e.fn.off = function (a, c, b) {
            return c === f || e.isFunction(c) ? this.unbind(a, c) : this.undelegate(c, a, b)
        };
        ...
        e.trigger = function (a, c, b) {
            ...
            e.isArray(c) || (c = [c]);
            e.isArray(b) || (b = [b]);
            for (var f = 0; f < c.length; f++) if (a.__events[c[f]]) for (var g = a.__events[c[f]], h = 0; h < g.length; h++) e.isFunction(g[h]) && !1 === g[h].apply(a, b) && (d = !1);
            return d
        };
        e.unbind = function (a, c, b) {
            if (a.__events) {
                e.isArray(c) || (c = [c]);
                for (var d = 0; d < c.length; d++) if (a.__events[c[d]]) for (var g = a.__events[c[d]], h = 0; h < g.length; h++) if (b == f && delete g[h], g[h] == b) {
                    g.splice(h, 1);
                    break
                }
            }
        ...
        e.asap = function (a, c, b) {
            ...
            K.push(c ? c : {});
            L.push(b ? b : []);
            g.postMessage("jqm-asap", "*")
        };
        g.addEventListener("message",
        function (a) {
            a.source == g && "jqm-asap" == a.data && (a.stopPropagation(), 0 < A.length && A.shift().apply(K.shift(), L.shift()))
        },
        !0);
        var M = {};
        e.parseJS = function (a) {
            if (a) {
                ...
                for (c = 0; c < a.length; c++) if (0 < a[c].src.length && !M[a[c].src]) {
                    var b = h.createElement("script");
                    b.type = a[c].type;
                    b.src = a[c].src;
                    h.getElementsByTagName("head")[0].appendChild(b);
                    M[a[c].src] = 1
                } else g.eval(a[c].innerHTML)
            }
        };
    ...
    window.numOnly || (window.numOnly = function (g) {
        ...
        if (isNaN(parseFloat(g))) if (g.replace) g = g.replace(/[^0-9.-]/, "");
        else return 0;
        return parseFloat(g)
    })
};