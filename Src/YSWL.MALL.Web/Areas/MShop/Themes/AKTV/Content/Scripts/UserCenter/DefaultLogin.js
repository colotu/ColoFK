...
function CheckLoginEmailName(obj) {
    ...
    if (val == ""  ) {
       ...
       ShowFailTip("请填写有效的Email地址");
        ...
        $("#txtLogin").removeClass("errorInfo");
        //$("#userValidate").html('');
        return;
    }
}
...
function CheckPassword(obj) {
    if (obj.val() != "") {
        passwordStatus = true;
        $("#password").removeClass("errorInfo");
        $("#passValidate").html('');
    }
    else {
        passwordStatus = false;
        $("#password").addClass("errorInfo");
        $("#passValidate").html("请填写密码");
    }
}
