    ...
    $(".i-kaixin").click(function () {
        ...
        switch (strLoginType) {
            case "default":
                ...
                break;
            /*case "layer": //浮层登录        ========已在 /js/login.js中实现
        ...
        // 		window.open(" /Kaixin/KaixinTransferRequest.aspx?logintype=" + strLoginType + "&returnurl=" + strReturnUrl, 'kaixin', 'width=350,height=80,left=10,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no').blur();
        window.open(" /Kaixin/KaixinTransferRequest.aspx?logintype=" + strLoginType + "&returnurl=" + strReturnUrl);
    });
});