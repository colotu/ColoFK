var ShareToSina = {
    ...
    Favourite: function(strProductName, strImageUrl, strProductUrl, ClassId1, ShowBtnCallBackFunction, SuccessCallBackFunction) {
        ...
        /// </summary>
        this.Type = 2;
        this.Message = "我刚在云商看到这个“" + strProductName + "”，觉得挺赞的! 正在考虑要不要买呢，先给大家看看，给我点意见吧！";
        this.ImageUrl = strImageUrl;
        this.ProductUrl = this.TrackUrl + strProductUrl;
    ...
    Order: function(strProductName, strImageUrl, strProductUrl, ClassId1, ShowBtnCallBackFunction, SuccessCallBackFunction) {
        ...
        /// </summary>
        this.Type = 3;
        this.Message = "我在云商买了个（" + strProductName + "），挺不错的噢！大家也来看看吧！";
        this.ImageUrl = strImageUrl;
        this.ProductUrl = this.TrackUrl + strProductUrl;
    ...
    AsyncStatus: function() {
        ...
        $.ajax({
            type: "GET",
            url: " /microblog/CheckShareRight.aspx",
            data: "{}",
            dataType: "jsonp",
            async: false,
    ...
    Send: function(SuccessCallBackFunction, ShareType) {
        ...
        $.ajax({
            type: "GET",
            url: " /microblog/SendMessageToQueue.aspx",
    ...
    Show: function() {
        ...
        /// 展示信息
        /// </summary>
        var url = " /microblog/ShowSendMessage.aspx?Message=" + encodeURIComponent(ShareToSina.Message) + "&MediaUrl=" + encodeURIComponent(ShareToSina.ImageUrl) + "&ProductUrl=" + encodeURIComponent(ShareToSina.ProductUrl) + "&Type=" + ShareToSina.Type;
