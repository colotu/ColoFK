...
Favorites = {
    ...
    ShareToSina: function (styleId, type) {
        ...
        function (data) {
            if (data != null) {
                ...
                var prdurl = ' /p-' + data._StyleId + '.htm#rel=xlwb1';
                ...
                if (type == '0') {
                    ...
                    ShareToSina.Message = "我刚在云商看到这个“" + prdname + "”，觉得挺赞的! 正在考虑要不要买呢，先给大家看看，给我点意见吧！" + ShareToSina.TrackUrl + prdurl;
    ...
    BuildFavoriteHtml: function (styleId) {
        ...
        html += '<span class="fb f14">商品收藏成功！</span><a target="_blank" href=" /favorites/favoritelist.aspx" class="a2">查看收藏夹</a>';
    ...
    BuildFavoritedHtml: function (styleId) {
        ...
        html += '<div class="J_dialog_bd"><div class="pt10 pb10 clearfix" id="copyBack">';
        html += '<div class="tips-r pb10 bbd">';
        html += '<span class="fb f14">您的收藏夹中已经有该商品了！</span><a target="_blank" href=" /favorites/favoritelist.aspx" class="a2"> 查看收藏夹</a>';
        html += '<span class="pl10 pr10">|</span><span class="share-weibo pl20"><a href="javascript:void(0);" class="a2">分享到微博</a></span></div>';
        $.ajax({
            url: this.Url,
            dataType: "jsonp",
            ...
            success: function (data) {
                if (data != null && data.length > 0) {
                    ...
                    function (i, style) {
                        var deptno = 'scfc2';
                        var prdurl = ' /p-' + style._StyleId + '.htm#rel=' + deptno;
