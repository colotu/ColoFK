...
$(function () {
    ...
    switch (orderstates) {
        case "等待付款":
            ...
            if (orderid) {
                $('#pay-button').prepend('<a  href="/pay/certification' + orderid + '/' + $YSWL.CurrentArea + '"  > <img  src="/Areas/Shop/Themes/M1/Content/images/btn_pay.gif" width="46" height="25" style="display: inline;"> </a>');
            }
            break;
        case "正在处理":
        case "等待处理":
