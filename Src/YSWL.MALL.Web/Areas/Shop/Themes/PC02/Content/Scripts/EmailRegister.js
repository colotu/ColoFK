            ...
            $.ajax({
                ...
                success: function (resultData) {
                    if (resultData == "true") {
                        ...
                        $("#divPhoneTip").removeClass("msg msg-ok msg-naked").removeClass("msg msg-info").addClass("msg msg-err").html("该手机号码已被注册。使用该地址<a href=$YSWL.BasePath + 'Account/Login'>登录</a>，忘记密码请点击<a href=$YSWL.BasePath + 'Account/FindPwd' >找回密码</a>");
                        phoneStatus = false;
                    }
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
