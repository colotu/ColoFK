            ...
            if (categoryModel != null)
            {
                ...
                if (currentModel != null)
                {
                    ...
                    if (list != null && list.Count > 0)
                    {
                        ...
                        {
                            CategoryStr.AppendFormat("<a href='"+ YSWL.Components.MvcApplication.GetCurrentRoutePath(AreaRoute.Shop) + "Product/" + categoryInfo.CategoryId + "'>{0}</a> > ", categoryInfo.Name);
                        }
                    }
