...
namespace YSWL.MALL.Web
{
    ...
    public class PageBaseOption : IPageBaseOption
    {
        ...
        public string DefaultLogin
        {
            get
            {
                return MvcApplication.IsAutoConn?  "/Account/login":BLL.SysManage.ConfigSystem.GetValueByCache("DefaultLogin");
            }
        }

        public string DefaultLoginAdmin
        {
            get { return MvcApplication.IsAutoConn ? "/admin/login.aspx" : BLL.SysManage.ConfigSystem.GetValueByCache("DefaultLoginAdmin"); }
        }

        public string DefaultLoginEnterprise
        {
            get { return MvcApplication.IsAutoConn ? "" : BLL.SysManage.ConfigSystem.GetValueByCache("DefaultLoginEnterprise"); }
        }
        #endregion
    }
    #endregion
