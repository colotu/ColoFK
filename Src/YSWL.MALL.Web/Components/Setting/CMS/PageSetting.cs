...
namespace YSWL.MALL.Web.Components.Setting.CMS
{
    public class PageSetting : IPageSetting
    {
        ...
        /// <param name="applicationType">模块名称</param>
        /// <returns>设置内容</returns>
        public static PageSetting GetContentClassSetting(YSWL.MALL.Model.CMS.ContentClass classModel, string pageName = "CMSSelf", ApplicationKeyType applicationType = ApplicationKeyType.CMS)
        {
        ...
        /// <param name="applicationType">模块名称</param>
        /// <returns>设置内容</returns>
        public static PageSetting GetArticleSetting(YSWL.MALL.Model.CMS.Content contModel, string pageName = "CMS", ApplicationKeyType applicationType = ApplicationKeyType.CMS)
        {
        ...
        public static string GetCMSUrl(int NewId, string pageName = "CMS", ApplicationKeyType applicationType = ApplicationKeyType.CMS)
        {
            ...
            if (contentModel != null)
            {
                ...
                string Root = YSWL.MALL.BLL.SysManage.ConfigSystem.GetValueByCache("ArticleStaticRoot"); //获取商品静态的根目录
