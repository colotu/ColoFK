    ...
    public class PostMsgHelper
    {
                                                                    ...
                                                                    YSWL.WeChat.Model.Core.Command command, int Step = 1)
        {
            ...
            switch (Step)
            {
                ...
                case 2:
                    ...
                    reportModel.FileDataPath = "/"+MvcApplication.UploadFolder+"/WeChat/" + DateTime.Now.ToString("yyyyMMdd") + "/{0}";
                                                                    ...
                                                                    YSWL.WeChat.Model.Core.Command command, int Step = 1)
        {
            ...
            if (msg.MsgType == "image")
            {
                ...
                postModel.ImageUrl = String.Format("/"+MvcApplication.UploadFolder+"/SNS/Images/PhotosThumbs/{0}/{1}",
        ...
        public static string GetQRImage(string token, int sceneId)
        {
            ...
            if (!String.IsNullOrWhiteSpace(ticket))
            {
                ...
                //    {
                //        string savePath = "/"+MvcApplication.UploadFolder+"/WeChat/QRImage/";
        ...
        private static void ReGenImage(string origialStr)
        {
            ...
            string dir = "/"+MvcApplication.UploadFolder+"/SNS/Images/PhotosThumbs/" + DateTime.Now.ToString("yyyyMMdd");
                                                              ...
                                                              YSWL.WeChat.Model.Core.Command command)
        {
            ...
            if (MvcApplication.IsAutoConn)
            {
                enterpriseId = YSWL.Common.CallContextHelper.GetEnterpriseId();
            }
        ...
        public static void CreateQrCode(HttpContext context,YSWL.WeChat.Model.Core.User userModel, YSWL.WeChat.Model.Core.RequestMsg msg, long enterpriseId)
        {
            ...
            try
            {
                ...
                string savaPath = "/"+MvcApplication.UploadFolder+"/QRcode/QR_" + userModel.UserId + ".jpg";
