<%@ Page Title="<%$ Resources:AddPaymentMode, IDS_PageTitle %>" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="AddPaymentMode.aspx.cs" Inherits="YSWL.MALL.Web.Admin.AddPaymentMode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="newslistabout">
                    ...
                    <tr>
                        <td align="left">
                            <span style="font-size: 12pt; font-weight: bold; color: #3666AA">
                                ...
                                <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:AddPaymentMode, IDS_PageTitle %>" /></span>
                        </td>
                        <td align="middle">
                            &nbsp;
                        </td>
        ...
        <div>
            ...
            <div class="PageTitle">
                <asp:literal id="lblPageTitle" runat="server" text="<%$ Resources:AddPaymentMode, IDS_PageTitle %>"></asp:literal>
            </div>
            <div style="width: 80%;">
                <asp:literal id="lblPageDesc" runat="server" text="<%$ Resources:AddPaymentMode, IDS_PageDesc %>"></asp:literal>
            </div>
        </div>--%>
            ...
            <!-- 支付方式名称-->
            <table style="width: 100%;padding: 20px;" cellpadding="5" cellspacing="1" class="border" >
                <tr>
                    <td class="tdbg">
                        <table cellspacing="0" cellpadding="3" width="100%" border="0">
                            ...
                            <tr id="tblrImage" runat="server">
                                ...
                                <td class="rightTD">
                                    ...
                                    <YSWL:ValidateTarget ID="validatetxtEmailAddress" ContainerId="ValidatorContainer"
                                        ...
                                        Nullable="false"><%--<%$Resources:AddPaymentMode,ErrorEmailLength%>--%>
                                        <Validators>
                            ...
                            <tr id="tblrSecretKey" runat="server">
                                ...
                                <td class="rightTD">
                                    <div class="msgNormal msgNormal-wa">
                                ...
                                <td class="rightTD">
                                    ...
                                    <YSWL:ValidateTarget ID="ValidateTargetCharge" runat="server" ContainerId="ValidatorContainer"
                                        ...
                                        <Validators>
                                            ...
                                            <YSWL:NumberRangeClientValidator ErrorMessage="<%$ Resources:AddPaymentMode, ErrorPayFee %>" MinValue="0" MaxValue="99999999" />
                                        </Validators>
                                    </YSWL:ValidateTarget>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="rightTD" colspan="2">
                                    ...
                                    <asp:Button ID="btnCreate" runat="server" Text="<%$ Resources:Resources, IDS_Button_Add %>"
                                        CssClass="adminsubmit" OnClientClick="return PageIsValid()" />
                                </td>
                            </tr>
                        </table>
                        </td>
 ...
 , autoClearinitialContent: false, imagePath: "/<%= YSWL.Components.MvcApplication.UploadFolder %>/RTF/", imageManagerPath: "/"
            });
