<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Modify.aspx.cs" Inherits="YSWL.MALL.Web.Settings.MainMenus.Modify"
    Title="<%$Resources:CMS,WMptModify %>" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:CMS,WMptModify %>"/>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:CMS,WMlblModify %>"/>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <tr>
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                          <tr>
                            ...
                            <td height="25">
                                 <cc1:ConfigAreaList ID="ddlType" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="ddlType_Change"   />
                                          模板名称：
                              <%--  <asp:TextBox ID="txtThemeName" runat="server" Width="120px" Visible="True"></asp:TextBox>--%>
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal4" runat="server" Text="<%$Resources:CMS,WMenuName %>"/>：
                            </td>
                            <td>
                        ...
                        <tr style=" display:none">
                            <td class="td_class">
                               <asp:Literal ID="Literal5" runat="server" Text="<%$Resources:CMS,WMTitleName %>"/> ：
                            </td>
                            <td>
                         ...
                         <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal6" runat="server" Text="<%$Resources:Site,lblPageUrl%>"/>：
                            </td>
                            <td height="25">
                                   <asp:DropDownList ID="ddNavType" runat="server" OnSelectedIndexChanged="ddNavType_Change" AutoPostBack="true">
                                      <asp:ListItem Value="0">自定义</asp:ListItem>
                                    <asp:ListItem Value="1">CMS栏目分类</asp:ListItem>
                                   <%-- <asp:ListItem Value="2">社区商品分类</asp:ListItem>
                                    <asp:ListItem Value="3">社区图片分类</asp:ListItem>--%>
                                    <asp:ListItem Value="4">商城商品分类</asp:ListItem>
                                </asp:DropDownList>
                                           <asp:DropDownList ID="ddValue" runat="server" Visible="false">
                                </asp:DropDownList>
                                     <asp:TextBox ID="txtNavURL" runat="server" Width="280px" Visible="false" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal7" runat="server" Text="<%$Resources:Site,lblShowID %>"/>：
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="td_class">
                                <asp:Literal ID="Literal8" runat="server" Text="<%$Resources:CMS,WMlblTarget %>"/>：
                            </td>
                        ...
                        <tr>
                            <td class="td_class">
                               <asp:Literal ID="Literal9" runat="server" Text="<%$Resources:CMS,WMIsAvailable %>"/>：
                            </td>
                            <td height="25">
