    ...
    public partial class Add : PageBaseAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //获取主区域的
               string mainArea = ConfigSystem.GetValue("MainArea");
        ...
        protected void ddNavType_Change(object sender, EventArgs e)
        {
            ...
            switch (NavType)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    YSWL.MALL.BLL.SNS.Categories productCate = new BLL.SNS.Categories();
                    ...
                    break;
                case 3:
                    YSWL.MALL.BLL.SNS.Categories photoCate = new BLL.SNS.Categories();
