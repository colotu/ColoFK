...
{
    public partial class List2 : PageBaseAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                #region   加载业务员
                DataSet ds = userBll.GetSalesList();
                this.ddlSalesList.DataSource = ds;
                this.ddlSalesList.DataTextField = "TrueName";
                this.ddlSalesList.DataValueField = "UserID";
                this.ddlSalesList.DataBind();
                this.ddlSalesList.Items.Insert(0, new ListItem("请选择业务员", "0"));
                #endregion 
        ...
        protected void btnActivity_Click(object sender, EventArgs e)
        {
            ...
            if (userBll.UpdateActiveStatus(idlist, 1))
            {
        ...
        #region 业务员名称
        public string GetSalesName(object salesId)
        {
            int userId = Common.Globals.SafeInt(salesId, 0);
            YSWL.Accounts.Bus.User user = new User(userId);
            if (user != null)
            {
                return String.IsNullOrWhiteSpace(user.TrueName)?user.UserName: user.TrueName;
            }
            return "--";
        ...
        protected void btnUnActivity_Click(object sender, EventArgs e)
        {
            string idlist = GetSelIDlist();
            if (idlist.Trim().Length == 0) return;
            if (userBll.UpdateActiveStatus(idlist, 0))
            {
                YSWL.Common.MessageBox.ShowSuccessTip(this, Resources.Site.TooltipUpdateOK);
                gridView.OnBind();
            }
        ...
        public void BindData()
        {
            ...
            ds = userBll.GetSearchList("UU", strWhere.ToString());
        ...
        protected string GetGravatar(object target)
        {
            ...
            if (!StringPlus.IsNullOrEmpty(target))
            {
                ...
                {
                    savePath = "/"+MvcApplication.UploadFolder+"/User/Gravatar/";
                }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            dataTable.Columns.Add(new DataColumn("业务员",typeof(string)));
            ...
            foreach (DataRow row in dataSet.Tables[0].Rows)
            {
                ...
                tmpRow["业务员"] = GetSalesName(row.Field<int>("EmployeeID"));
        ...
        protected void btnMove_Click(object sender, EventArgs e)
        {
            ...
            if (idlist.Trim().Length == 0)
                return;
            int salesId = Common.Globals.SafeInt(this.ddlSalesList.SelectedValue, 0);
            if (salesId == 0)
            {
                MessageBox.ShowFailTip(this, "请选择业务员！");
                return;
            }
            if (userBll.SetSalesInfo(salesId, idlist))
            {
                MessageBox.ShowSuccessTip(this, "转移业务员成功！");

            }
            else
            {
                MessageBox.ShowFailTip(this, "转移业务员失败！");
            }
            gridView.OnBind();
        }
        #endregion
