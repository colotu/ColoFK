<%@ Page Title="模版管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
  CodeBehind="MShopList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Ms.Themes.MShopList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('[id$=labelB2CUrl]').parents('a :first').attr('href', $('[id$=labelB2CUrl]').text());
        });
    </script>
    <style type="text/css">
        .search
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="newslistabout">
         <div class="nTab4">
            <div class="TabTitle">
                <ul id="myTab1">
                    <li class="active" ><a href="javascript:;">B2C模板</a></li>
                    <li class="normal"><a href="MBList.aspx">B2B模板</a></li>
                </ul>
            </div>
                      <asp:HiddenField runat="server" ID="hidCurrentColor" Value="" />
        <asp:HiddenField runat="server" ID="hidHasColorThemes" Value="MC01,MC02" />
        <table style="text-align: center; width: 100%;" cellpadding="0" cellspacing="0" class="border">
            <tr>
                <td class="tx-l" style="padding-bottom:10px;">
                    访问地址：<a target="_blank"><asp:Label runat="server"  ID="labelB2CUrl"></asp:Label></a>
                </td></tr>
            <tr>
