        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    {
                        this.labelB2CUrl.Text = "http://" + Common.CallContextHelper.GetEnterpriseId() + "." + Common.Globals.DomainFullName + MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.MShop);
                    }else{
