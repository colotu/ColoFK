<%@ Page Title="模版管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="BShopList.aspx.cs" Inherits=" YSWL.MALL.Web.Admin.Ms.Themes.BShopList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('[id$=labelB2BUrl]').parents('a :first').attr('href', $('[id$=labelB2BUrl]').text());
        });
    </script>
    <style type="text/css">
        .search
