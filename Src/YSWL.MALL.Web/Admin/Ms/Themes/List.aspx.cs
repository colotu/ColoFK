    ...
    public partial class List : PageBaseAdmin
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    this.labelB2CUrl.Text = "http://" + Common.CallContextHelper.GetEnterpriseId() + "." + Common.Globals.DomainFullName + MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.Shop);
                }
                else
                {
                    this.labelB2CUrl.Text = "http://" + Common.Globals.DomainFullName + MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.Shop);
                }
                BindData();
