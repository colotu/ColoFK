...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceCheckright" runat="server">
    ...
    <script type="text/javascript">
        $('.qrImg:eq(0)').attr('src', '/<%= YSWL.Components.MvcApplication.UploadFolder %>/QR/website.png?r=' + Math.random());
        $('.qrImg:eq(1)').attr('src', '/<%= YSWL.Components.MvcApplication.UploadFolder %>/QR/android.png?r=' + Math.random());
