...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("[id$='chbStatus']").addClass('mui-switch').addClass('mui-switch-animbg').parent('span').show();
            WaterContent();
            $("[id$='chbStatus']").click(function () {
                $.ajax({
                    url: ("Setting.aspx?timestamp={0}").format(new Date().getTime()),
                    type: 'POST', dataType: 'json', timeout: 10000,
                    data: { Action: "UpdateStatus", Callback: "true", Status: $("[id$='chbStatus']").is(':checked') },
    ...
    <div class="newslistabout">
        ...
        <table border="0" cellspacing="1" style="width: 100%; height: 100%;" cellpadding="3"
            ...
            <tr>
                ...
                <td>
                   <span style="display:none;"><asp:CheckBox ID="chbStatus" runat="server" /></span> 
                    <div class="warn-msg warn-tips-interval">修改后，请重新生成商品缩略图</div>
                </td>
            </tr>
        </table>
        <br />
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang"
            id="txtAddWater" style="display:none;">
            <tr>
                 <td class="td_class">
                    产品图片水印设置：
                </td>
            ...
            <tr id="imgShow" class="photoAbout">
                ...
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                  ...
                  <td class="td_class">
                    水印位置： </td><td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    <asp:DropDownList ID="ddlPosition" runat="server" Width="150px">
                        <asp:ListItem Value="WM_CENTER">居中 </asp:ListItem><asp:ListItem Value="WM_TOP_LEFT">左上角</asp:ListItem><asp:ListItem Value="WM_BOTTOM_LEFT">左下角</asp:ListItem><asp:ListItem Value="WM_TOP_RIGHT">右上角</asp:ListItem><asp:ListItem Value="WM_BOTTOM_RIGHT">右下角</asp:ListItem><asp:ListItem></asp:ListItem></asp:DropDownList></td></tr><tr style=" display:none">
                  <td class="td_class">
                    水印对象： </td><td height="35" bgcolor="#FFFFFF" class="newstitlebody">
            ...
            <tr>
                  <td class="td_class">
                    水印透明度： </td><td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    <div style="float: left">
                        <asp:TextBox ID="txtTransparent" runat="server" Width="40px"></asp:TextBox></div><div id="slider-range-max" style="width: 200px; float: left; margin-left: 15px; margin-top: 17px">
                    </div>
                </td>
            </tr>
            <tr>
