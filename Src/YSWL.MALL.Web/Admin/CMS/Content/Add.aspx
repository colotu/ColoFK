<%@ Page Title="<%$Resources:CMS,ContentptAdd%>" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="YSWL.MALL.Web.CMS.Content.Add" %>
    ...
    <div class="newslistabout">
        ...
        <div class="TabContent">
                    ...
                    <tr>
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td class="td_class">
                                        <asp:Literal ID="Literal19" runat="server" Text="SeoURL地址" />：
                                    </td>
                                    <td height="25">
                                ...
                                <tr>
                                    <td class="td_class">
                                        <asp:Literal ID="Literal9" runat="server" Text="<%$Resources:Site,lblKeyword%>" />：
                                    </td>
                                    <td height="25">
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <div class="msgNormal">
                                            <asp:Literal ID="Literal10" runat="server" Text="请输入关键字以逗号分割，长度限制在25个字符以内！"></asp:Literal>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class">
                                        <asp:Literal ID="Literal16" runat="server" Text="是否静态化" />：
                                    </td>
                                    <td height="25">
                                        <asp:CheckBox ID="chkStatic" Text="是" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class">
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr runat="server" id="TrLinkUrl">
                                    <td class="td_class">
                                        <asp:Literal ID="Literal11" runat="server" Text="<%$Resources:CMS,ContentlblLinkUrl%>" />：
                                    </td>
                                    <td width="*" align="left" style="height: 25px;">
                                        <asp:TextBox ID="txtLinkUrl" runat="server" Width="500px" Text="http://" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class">
                                ...
                                <tr>
                                    <td class="td_class">
                                        <asp:Literal ID="Literal12" runat="server" Text="<%$Resources:Site,lblOrder%>" />：
                                    </td>
                                    <td height="25">
                                ...
                                <tr>
                                    <td class="td_class">
                                        <asp:Literal ID="Literal13" runat="server" Text="<%$Resources:CMS,ContentlblContentProperty%>" />：
                                    </td>
                                    <td height="25">
                                ...
                                <tr>
                                    <td class="td_class">
                                        <asp:Literal ID="Literal15" runat="server" Text="<%$Resources:CMS,ContentlblAppendix%>" />：
                                    </td>
                                    <td height="25" style="padding-left: 5px">
                                ...
                                <tr runat="server" id="TrRemary">
                                    <td class="td_class">
                                        <asp:Literal ID="Literal17" runat="server" Text="<%$Resources:Site,remark %>" />：
                                    </td>
                                    <td height="25">
                                        <asp:TextBox ID="txtRemary" runat="server" Width="376px" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <div id="myTab1_Content2" tabindex="2" class="none4">
                <table style="width: 100%; border-bottom: none; border-top: none; float: left;" cellpadding="2"
                    cellspacing="1" class="border padd-no">
                    <tr>
                        <td class="td_class">
                            页面标题 ：
                        </td>
