    ...
    $(document).ready(function () {
        ...
        $("#uploadify").uploadify({
            ...
            onUploadStart: function (file) {
                $("#uploadify").uploadify('settings', 'formData', {'folder': '/<%= YSWL.Components.MvcApplication.UploadFolder %>/CMS/Photo/', 'userId':<%= strUserId %>, 'album': $("[id$='DropAlbum']").find(":selected").val() });
            },
