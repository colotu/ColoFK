...
namespace YSWL.MALL.Web.Admin.SNS.Photos
{
    public partial class ListEx : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.Photos bll = new YSWL.MALL.BLL.SNS.Photos();
        private YSWL.MALL.BLL.Members.SiteMessage siteBll = new SiteMessage();
        ...
        public void BindData()
        {
            ...
            if (txtKeyword.Text.Trim() != "")
            {
                ...
                strWhere.AppendFormat("  (PhotoName like '%{0}%' or CreatedNickName like '%{0}%')", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }
        ...
        protected string GetCategoryName(object target)
        {
            ...
            if (!StringPlus.IsNullOrEmpty(target))
            {
                ...
                YSWL.MALL.Model.SNS.Categories model = cateBll.GetModel(SNSCateId);
                if (model != null)
                {
                    str = model.Name;
                }
        ...
        protected void btnMove_Click(object sender, EventArgs e)
        {
            ...
            if (SNSPhotoCateId == 0)
            {
                YSWL.Common.MessageBox.ShowSuccessTip(this, "请选择类别");
            }
            if (!bll.UpdateCateList(idlist, SNSPhotoCateId))
            {
                YSWL.Common.MessageBox.ShowSuccessTip(this, "批量归类失败");
            }
            else
            {
                YSWL.Common.MessageBox.ShowSuccessTip(this, "批量归类成功");
            }
            BindData();
        }
        ...
        protected void btnRecomend_Click(object sender, EventArgs e)
        {
            ...
            if (!bll.UpdateRecomendList(idlist, 1))
            {
                ...
                YSWL.Common.MessageBox.ShowSuccessTip(this, "批量推荐到首页失败");
        ...
        protected void btnRecomend2_Click(object sender, EventArgs e)
        {
            ...
            {
                YSWL.Common.MessageBox.ShowFailTip(this, "批量推荐到频道首页失败");
                LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "批量推荐图片(PhotoIDs=" + idlist + ")到首页失败", this);
            }
            LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "批量推荐图片(PhotoIDs=" + idlist + ")到首页成功", this);
            BindData();
        ...
        protected void btnNoRecomend_Click(object sender, EventArgs e)
        {
            ...
            if (!bll.UpdateRecomendList(idlist, 0))
            {
                ...
                YSWL.Common.MessageBox.ShowFailTip(this, "批量取消推荐失败");
            }
        ...
        //    if (!bll.UpdateCateList(idlist, SNSPhotoCateId))
        //    {
        //        YSWL.Common.MessageBox.ShowSuccessTip(this, "批量转移分类失败");
        //    }
        //    gridView.OnBind();
        //}
