<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Modify.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Photos.Modify"
    Title="修改页" %>

<%@ Register Src="~/Controls/UCDroplistPermission.ascx" TagName="UCDroplistPermission"
    TagPrefix="uc2" %>
    <%@ Register src="~/Controls/SNSPhotoCateDropList.ascx" tagname="PhotoCategoryDropList" tagprefix="YSWL" %>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <tr style=" display:none">
                            ...
                            <td height="35" width="*" align="left">
                                 <YSWL:PhotoCategoryDropList ID="PhotoCategory" runat="server" IsNull="true" />
                            </td>
                        </tr>
                        <tr>
                            <td height="35" width="30%" align="right">
