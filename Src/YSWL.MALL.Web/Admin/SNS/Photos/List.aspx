<%@ Page Title="照片表" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Photos.List" %>
                    ...
                    <ItemTemplate>
                        <a href="<%=YSWL.Components.MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.SNS)%>Photo/Detail/<%#Eval("PhotoID")%>" target="_blank">
                            <asp:Image ID="Image1" runat="server" Width="100px" Height="100px" ImageAlign="Middle"
                                ImageUrl='<%#YSWL.MALL.Web.Components.FileHelper.GeThumbImage(Eval("ThumbImageUrl").ToString(), "T116x170_")%>' />
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
