<%@ Page Title="<%$Resources:CMSPhoto,ptList %>" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="ListEx.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Photos.ListEx" %>
...
//            $("[id$='to']").prop("readonly", true).datepicker({ dateFormat: "yy-mm-dd", yearRange: ("1949:"+new Date().getFullYear()) });
    ...
    <script type="text/javascript">
        $(function () {
            $("#ctl00_ContentPlaceHolder1_txtKeyword").attr("placeholder", "查询图片名或发布者昵称");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="newslistabout">
     ...
     <!--Add end -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            <tr>
                <td  height="35"   class="cate_div">
                    <asp:Literal ID="txtCateParent" runat="server" Text="图片分类：" />
                    <YSWL:SNSPhotoCateDropList ID="PhotoCate" runat="server" IsNull="true" />
                ...
                <td  height="35" class="newstitlebody"  >
                  <asp:Literal ID="Literal4" runat="server" Text="时间：" />
                    <input type="text" id="from" name="from" style="width: 120px" /><asp:HiddenField ID="txtFrom"
                        runat="server" /> <asp:Literal ID="Literal6" runat="server" Text="--" />
                        <input type="text" id="to" name="to" style="width: 120px" /><asp:HiddenField ID="txtTo"
                        runat="server" />
                         <asp:Literal ID="Literal5" runat="server" Text="<%$Resources:Site,lblKeyword%>" />：
                     <asp:TextBox ID="txtKeyword" runat="server"></asp:TextBox>
                    <asp:Button ID="btnSearch" runat="server" Text="查询" OnClick="btnSearch_Click" class="adminsubmit_short">
                    </asp:Button>
                </td>
                                ...
                                <table cellpadding="2" cellspacing="8">
                                    <tr>
                                        <td style="border: 1px solid #ecf4d3; text-align: center">
                                             <a href="<%=YSWL.Components.MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.SNS)%>Photo/Detail/<%#Eval("PhotoID")%>" target="_blank">
                                               <img src='<%# YSWL.MALL.Web.Components.FileHelper.GeThumbImage(Eval("ThumbImageUrl").ToString(), "T116x170_") %>' style="width: 180px; height:240px" />
                                            </a>
                                            <br />
        ...
        <table border="0" cellpadding="0" cellspacing="1" style="width: 100%; height: 100%;">
            <tr>
                <td style="float: left;" height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    <YSWL:SNSPhotoCateDropList ID="PhotoCategory" runat="server" IsNull="true" />
                </td>
