...
namespace YSWL.MALL.Web.SNS.PhotoTags
{
    public partial class List : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.PhotoTags bll = new YSWL.MALL.BLL.SNS.PhotoTags();
        ...
        protected new int Act_AddData = 126;    //SNS_图片标签_新增图片标签
        ...
        {
            YSWL.MALL.BLL.SNS.PhotoTags bll = new YSWL.MALL.BLL.SNS.PhotoTags();
            YSWL.MALL.Model.SNS.PhotoTags model = bll.GetModel(TagID);
            if (null != model)
            {
        ...
        public void BindData()
        {
            ...
            gridView.DataSetSource = bll.GetList("TagName like '%" + Common.InjectionFilter.SqlFilter(txtKeyword.Text.TrimEnd()) + "%'");
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            YSWL.MALL.BLL.SNS.PhotoTags bll = new YSWL.MALL.BLL.SNS.PhotoTags();
            YSWL.MALL.Model.SNS.PhotoTags model = null;
            if (TagID > 0)
            {
