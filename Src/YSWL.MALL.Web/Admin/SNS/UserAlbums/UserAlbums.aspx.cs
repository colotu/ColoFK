...
namespace YSWL.MALL.Web.SNS.UserAlbums
{
    public partial class List : PageBaseAdmin
    {
        //int Act_ShowInvalid = -1; //查看失效数据行为
        private YSWL.MALL.BLL.SNS.UserAlbums bll = new YSWL.MALL.BLL.SNS.UserAlbums();
        ...
        {
            YSWL.MALL.BLL.SNS.AlbumType TypeBll = new BLL.SNS.AlbumType();
        ...
        public void BindData()
        {
            ...
            {
                strWhere.AppendFormat(" AlbumName like '%{0}%'", Common.InjectionFilter.SqlFilter(this.txtKeyword.Text));
            }
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            YSWL.MALL.BLL.SNS.UserAlbums bll = new BLL.SNS.UserAlbums();
        ...
        public string GetCategoryName(object target)
        {
            ...
            if (!StringPlus.IsNullOrEmpty(target))
            {
                ...
                {
                    YSWL.MALL.BLL.SNS.AlbumType typeBll = new BLL.SNS.AlbumType();
                    List<YSWL.MALL.Model.SNS.AlbumType> list = typeBll.GetTypeList(albumId);
