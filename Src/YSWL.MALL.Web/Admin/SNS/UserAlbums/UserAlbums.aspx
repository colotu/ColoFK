<%@ Page Title="用户专辑管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="UserAlbums.aspx.cs" Inherits="YSWL.MALL.Web.SNS.UserAlbums.List" %>
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="专辑名称" ItemStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        <a href='<%=YSWL.Components.MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.SNS)%>Album/Details?AlbumID=<%#Eval("AlbumID")%>'
                            target="_blank">
                            <%# Eval("AlbumName") %>
                        </a>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="创建人" ItemStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        <a href='<%=YSWL.Components.MvcApplication.GetCurrentRoutePath(YSWL.Web.AreaRoute.SNS)%>User/Posts/<%#Eval("CreatedUserID")%>'
                            target="_blank">
