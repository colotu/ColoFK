...
namespace YSWL.MALL.Web.Admin.SNS.Star
{
    public partial class List : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.Star bll = new YSWL.MALL.BLL.SNS.Star();
        ...
        protected void btnUpdateState_Click(object sender, EventArgs e)
        {
            ...
            if (bll.UpdateStateList(idlist, 1))
            {
                ...
                YSWL.Common.MessageBox.ShowSuccessTip(this, "批量设置成功！");
            }
            else
            {
        ...
        public void BindData()
        {
            ...
            {
                strWhere.AppendFormat("NickName like '%{0}%'", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }
        ...
        protected string GetStarType(object target)
        {
            ...
            {
                YSWL.MALL.BLL.SNS.StarType cateBll = new BLL.SNS.StarType();
                int SNSCateId = Common.Globals.SafeInt(target.ToString(), 0);
                YSWL.MALL.Model.SNS.StarType model = cateBll.GetModel(SNSCateId);
                if (model != null)
                {
                    str = model.TypeName;
                }
