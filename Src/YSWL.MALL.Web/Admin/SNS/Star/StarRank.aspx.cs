...
namespace YSWL.MALL.Web.Admin.SNS.StarRank
{
    public partial class List : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.StarRank bll = new YSWL.MALL.BLL.SNS.StarRank();
        YSWL.MALL.BLL.SNS.StarType starType = new BLL.SNS.StarType();
        ...
        protected void btnUpdateState_Click(object sender, EventArgs e)
        {
            ...
            if (!bll.UpdateStateList(idlist))
            {
                ...
                YSWL.Common.MessageBox.ShowFailTip(this, "批量设置失败");
            }
            else
            {
        ...
        public void BindData()
        {
            ...
            {
                strWhere.AppendFormat(" and NickName like '%{0}%'", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }
