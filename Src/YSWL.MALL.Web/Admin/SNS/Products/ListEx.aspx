<%@ Page Title="商品分享" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="ListEx.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Products.ListEx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#ctl00_ContentPlaceHolder1_txtKeyword").attr("placeholder", "查询商品名或发布者昵称");
    ...
    <div class="newslistabout">
        ...
        <%--        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="borderkuang">
            ...
            <tr>
                ...
                <td colspan="3">
                    <YSWL:TaoBaoCategoryDropList ID="TaoBaoCate" runat="server" IsNull="true" />
                </td>
            </tr>
            <tr>
                <td style="text-align: right" class="style4">
            ...
            <tr class="newstitlebody">
                <td  class="cate_div">
                  <asp:Literal ID="txtCateParent" runat="server" Text="商品分类：" />
                    <YSWL:SNSCategoryDropList ID="SNSCate" runat="server" IsNull="true" />
                                    ...
                                    <tr>
                                        <td style="border: 1px solid #ecf4d3; text-align: center">
                                            <a class="group2" href='<%#Eval("NormalImageUrl") %>' title='<%#Eval("ProductName") %>'>
                                                <img src='<%#YSWL.MALL.Web.Components.FileHelper.GeThumbImage(Eval("ThumbImageUrl").ToString(), "T116x170_")%>' style="width: 180px;" />
                                            </a>
                                            <br />
                                            ...
                                            <a target="_blank" style="color: #0063dc; text-decoration: none;" href="<%=BasePath %>Product/Detail/<%#Eval("ProductID") %>">
                                                <%#YSWL.Common.StringPlus.SubString(Eval("ProductName"),"...",20,true) %></a><br />
        ...
        <table border="0" cellpadding="0" cellspacing="1" style="width: 100%; height: 100%;">
            <tr>
                <td style="float: left" height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    <YSWL:SNSCategoryDropList ID="SNSCate2" runat="server" IsNull="true" />
                </td>
