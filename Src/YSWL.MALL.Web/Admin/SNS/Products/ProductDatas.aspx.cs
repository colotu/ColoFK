...
namespace YSWL.MALL.Web.Admin.SNS.Products
{
    public partial class ProductDatas : PageBaseAdmin
    {
        ...
        YSWL.MALL.BLL.SNS.Products bll = new BLL.SNS.Products();
        YSWL.MALL.BLL.SNS.UserAlbums albumBll = new UserAlbums();
        protected string UploadPath = "/"+MvcApplication.UploadFolder+"/Temp/" + DateTime.Now.ToString("yyyyMMdd") + "/";
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            YSWL.MALL.BLL.Members.Users userBll = new BLL.Members.Users();
            YSWL.MALL.Model.Members.Users user = userBll.GetModel(userId);
            if (user == null)
            {
        ...
        {
            string sheetName = YSWL.MALL.BLL.SysManage.ConfigSystem.GetValueByCache("SNS_TaoBaoExcel_SheetName");
