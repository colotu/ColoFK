<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddColor.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Products.AddColor" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal2" runat="server" Text="新增商品颜色" />
                    </td>
                </tr>
            </table>
