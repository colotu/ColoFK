<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="TagsModify.aspx.cs" Inherits="YSWL.MALL.Web.SNS.Tags.Modify" Title="编辑标签" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal2" runat="server" Text="编辑标签" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal3" runat="server" Text="您可以编辑标签信息" />
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        <tr>
                            ...
                            <td height="25">
                                <asp:RadioButtonList ID="radlIsRecommand" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="0">推荐</asp:ListItem>
