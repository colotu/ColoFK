...
namespace YSWL.MALL.Web.Admin.SNS.ProductSources
{
    public partial class List : PageBaseAdmin
    {
        //int Act_ShowInvalid = -1; //查看失效数据行为
        protected override int Act_PageLoad { get { return 601; } } //SNS_商品来源管理_新增页
        protected new int Act_AddData = 602;    //SNS_商品来源管理_新增数据
        protected new int Act_UpdateData = 603;    //SNS_商品来源管理_编辑数据
        protected new int Act_DelData = 604;    //SNS_商品来源管理_删除数据

		YSWL.MALL.BLL.SNS.ProductSources bll = new YSWL.MALL.BLL.SNS.ProductSources();
        ...
        public void BindData()
        {
            ...
            {      
                ...
                strWhere.AppendFormat("WebSiteName like '%{0}%'", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }            
