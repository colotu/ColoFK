<%@ Page Title="淘宝数据采集" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="ProductDatas.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Products.ProductDatas" %>

<%@ Register Src="~/Controls/TaoBaoCategoryDropList.ascx" TagName="TaoBaoCategoryDropList"
    TagPrefix="YSWL" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<%@ Register TagPrefix="YSWL" TagName="SNSCategoryDropList" Src="~/Controls/SNSCategoryDropList.ascx" %>
    ...
    <div class="newslistabout">
        ...
        <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr>
                ...
                <td  colspan="2">
                    <YSWL:SNSCategoryDropList ID="SNSCategoryDropList" runat="server" IsNull="true" />
                </td>
                                    ...
                                    <tr>
                                        <td style="border: 1px solid #ecf4d3; text-align: center">
                                            ...
                                            <a href="<%#Eval("ClickUrl") %>" target="_blank" title='<%#Eval("Title") %>'>
                                                <asp:Label ID="lblImageName" runat="server" Text='<%#YSWL.Common.StringPlus.SubString(Eval("Title"),"...",20,true) %>'></asp:Label></a><br />
                                        </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
