<%@ Page Title="标签类型管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="TagTypeList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.TagType.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
        ...
        <div class="newslist">
            <div class="newsicon">
                <ul>
                    <li class="add-btn"  runat="server" id="LiAdd"  ><a href="TagTypeadd.aspx">
                        新增</a></li>
                    <li class="add-btn" style="display: none" id="liDel" runat="server" >
