<%@ Page Title="淘宝数据采集" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="GetTaoDatas.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Products.GetTaoDatas" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="txtProduct" runat="server" Text="淘宝店铺商品数据采集" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal8" runat="server" Text="您可以根据选择的条件批量采集店铺商品数据到本站。" />
                    </td>
                </tr>
            </table>
        </div>
                                ...
                                <table cellpadding="2" cellspacing="8">
                                    <tr>
                                        <td style="border: 1px solid #ecf4d3; text-align: center">
                                            ...
                                            <asp:Label ID="lblImageName" runat="server" Text='<%#YSWL.Common.StringPlus.SubString(Eval("Name"),"...",20,true) %>'></asp:Label><br />
                                        </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
