<%@ Page Title="商品来源表" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="SourcesList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.ProductSources.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslist mar-bt">
        <div class="newsicon">
            <ul>
                <li class="add-btn" id="liAdd" runat="server"><a href="add.aspx">新增</a></li>
