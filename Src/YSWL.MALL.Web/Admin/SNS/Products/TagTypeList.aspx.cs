...
namespace YSWL.MALL.Web.Admin.SNS.TagType
{
    public partial class List : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.TagType bll = new YSWL.MALL.BLL.SNS.TagType();
        ...
        protected new int Act_AddData = 135;    //运营管理_商品标签类型_新增标签
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            YSWL.MALL.BLL.SNS.Tags tagBll=new BLL.SNS.Tags();
