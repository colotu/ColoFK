...
namespace YSWL.MALL.Web.Admin.SNS.Products
{
    public partial class ListEx : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.Products bll = new YSWL.MALL.BLL.SNS.Products();
        ...
        public void BindData()
        {
            ...
            if (txtKeyword.Text.Trim() != "")
            {
                ...
                strWhere.AppendFormat(" (ProductName like '%{0}%' or CreatedNickName like '%{0}%')", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }
        ...
        protected void ddAction_Changed(object sender, EventArgs e)
        {
            ...
            switch (this.ddAction.SelectedValue)
            {
                case "1":
                    ...
                    {
                        YSWL.Common.MessageBox.ShowFailTip(this, "批量推荐到首页失败");
                        LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "批量推荐商品(ProductIds=" + idlist + ")到首页失败", this);
                    }
                    YSWL.Common.MessageBox.ShowSuccessTip(this, "批量取消推荐成功");
                    break;
                case "2":
                ...
                case "3":
                    ...
                    {
                        YSWL.Common.MessageBox.ShowFailTip(this, "批量下架失败");
                    }
                    YSWL.Common.MessageBox.ShowSuccessTip(this, "批量下架成功");
                    break;
                default:
                    break;
            }
        ...
        protected void btnMove_Click(object sender, EventArgs e)
        {
            ...
            {
                YSWL.Common.MessageBox.ShowFailTip(this, "批量转移分类失败");
