...
namespace YSWL.MALL.Web.SNS.GroupTags
{
    public partial class List : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.GroupTags bll = new YSWL.MALL.BLL.SNS.GroupTags();
        ...
        {
            YSWL.MALL.BLL.SNS.GroupTags bll = new YSWL.MALL.BLL.SNS.GroupTags();
            YSWL.MALL.Model.SNS.GroupTags model = bll.GetModel(TagID);
            if (null != model)
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            YSWL.MALL.BLL.SNS.GroupTags bll = new YSWL.MALL.BLL.SNS.GroupTags();
            YSWL.MALL.Model.SNS.GroupTags model = null;
            if (TagID > 0)
            {
            ...
            else
            {
                ...
                if ((ID=bll.Add(model) )> 0)
                {
                    ...
                    LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "新增群组标签(TagId="+ID+")成功!", this);
                    gridView.OnBind();
                }
                else
                {
