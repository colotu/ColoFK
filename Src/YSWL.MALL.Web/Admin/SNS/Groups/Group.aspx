<%@ Page Title="小组表" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Group.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Groups.List" %>
            ...
            <Columns>
                 <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="64px">
                    <ItemTemplate>
                        ...
                        <img src="<%#YSWL.MALL.Web.Components.FileHelper.GeThumbImage(Eval("GroupLogoThumb").ToString(), "T80x80_") %>" style="height:64px;width:64px;border-width:0px;">
                            </a>
                    </ItemTemplate>
                </asp:TemplateField>
