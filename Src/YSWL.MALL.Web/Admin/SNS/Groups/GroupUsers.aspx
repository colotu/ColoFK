<%@ Page Title="小组人员表" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="GroupUsers.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.GroupUsers.List" %>
                                    ...
                                    <tr>
                                        <td style="border: 1px solid #ecf4d3; text-align: center">
                                            <a class="group2" title='<%#Eval("NickName") %>'>
                                                <img src="/<%= YSWL.Components.MvcApplication.UploadFolder %>/User/Gravatar/<%#Eval("UserID") %>.jpg" style="width: 90px;
                                                    height: 100px" />
                                            </a>
                                            <br />
