...
namespace YSWL.MALL.Web.Admin.SNS.GroupTopicReply
{
    public partial class List : PageBaseAdmin
    {
		...
		YSWL.MALL.BLL.SNS.GroupTopicReply replyBll = new YSWL.MALL.BLL.SNS.GroupTopicReply();
        ...
        public void BindData()
        {
            ...
            if (txtKeyword.Text.Trim() != "")
            {
                ...
                strWhere.AppendFormat("ReplyNickName like '%{0}%' or Description like '%{0}%'", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }            
        ...
        protected void btnCheck_Click(object sender, EventArgs e)
        {
            string idlist = GetSelIDlist();
            if (idlist.Trim().Length == 0) return;
            if (replyBll.UpdateStatusList(idlist, YSWL.MALL.Model.SNS.EnumHelper.TopicStatus.Checked))
            {
        ...
        protected void btnForbidSpeak_Click(object sender, EventArgs e)
        {
            ...
            if (groupuserBll.UpdateStatusByTopicReplyIds(idlist, (int)YSWL.MALL.Model.SNS.EnumHelper.GroupUserStatus.ForbidSpeak))
            {
                MessageBox.ShowSuccessTip(this, "操作成功！");
        ...
        protected void btnCheckedUnPass_Click(object sender, EventArgs e)
        {
            string idlist = GetSelIDlist();
            if (idlist.Trim().Length == 0) return;
            if (replyBll.UpdateStatusList(idlist, YSWL.MALL.Model.SNS.EnumHelper.TopicStatus.CheckedUnPass))
            {
                MessageBox.ShowSuccessTip(this, "操作成功！");
