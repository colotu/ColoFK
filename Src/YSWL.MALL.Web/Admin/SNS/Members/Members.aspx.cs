...
namespace YSWL.MALL.Web.Admin.SNS.MembershipManage
{
    public partial class List : PageBaseAdmin
    {
        //int Act_ShowInvalid = -1; //查看失效数据行为
        protected override int Act_PageLoad { get { return 581; } } //SNS_会员管理_列表页

        protected int Act_BatActive = 582;//SNS_会员管理_激活数据
        protected int Act_BatUnActive = 583;//SNS_会员管理_冻结数据
        ...
        public void BindData()
        {
            ...
            if (!string.IsNullOrEmpty(txtEndTime.Text.Trim()))
            {
                ...
                strWhere.Append("  convert(date,User_dateCreate)<='" + Common.InjectionFilter.SqlFilter(txtEndTime.Text.Trim()) + "' ");
            }
        ...
        protected string GetGravatar(object target)
        {
            ...
            {
                string savePath = YSWL.MALL.BLL.SysManage.ConfigSystem.GetValueByCache("SNSGravatarPath");
