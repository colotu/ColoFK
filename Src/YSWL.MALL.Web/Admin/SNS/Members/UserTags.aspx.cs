...
namespace YSWL.MALL.Web.Admin.SNS.Members
{
    public partial class UserTags : PageBaseAdmin
    {
        ...
        protected new int Act_AddData = 579;    //SNS_用户标签管理新增数据
        protected new int Act_DelData = 580;    //SNS_用户标签管理_删除数据
        YSWL.MALL.BLL.SNS.Tags  bTags=new BLL.SNS.Tags();
        YSWL.MALL.BLL.SNS.TagType bTagType=new BLL.SNS.TagType();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                YSWL.MALL.Model.SNS.Tags mTags=new Model.SNS.Tags();
