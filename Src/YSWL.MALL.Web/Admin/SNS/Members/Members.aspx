<%@ Page Title="SNS_GradeConfig" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="Members.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.MembershipManage.List" %>
              ...
              <asp:TemplateField ItemStyle-Width="80">
               ...
               邮&nbsp;&nbsp;&nbsp;&nbsp;箱：<span style=" color:Gray">  <%#Eval("Email")%></span>
                ...
                <asp:TemplateField HeaderText="实名认证" ItemStyle-HorizontalAlign="Center"    ItemStyle-Width="80">
                    <ItemTemplate>
                        <span ><%#YSWL.Common.Globals.SafeBool(Eval("IsUserDPI").ToString(), false) ? "<img src=\"/Areas/SNS/Themes/Default/Content/images/geren.png\" alt=\"实名用户\" title=\"实名用户\">" : ""%></span>
                    </ItemTemplate>
                </asp:TemplateField>
