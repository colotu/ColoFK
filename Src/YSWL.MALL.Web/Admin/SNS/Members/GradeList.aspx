<%@ Page Title="SNS_GradeConfig" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="GradeList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.GradeConfig.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
        ...
        <div class="newslist mar-bt">
            <div class="newsicon">
                <ul>
                    <li class="add-btn" id="liAdd" runat="server"><a href="GradeAdd.aspx">  新增</a></li>
                </ul>
            </div>
        </div>
