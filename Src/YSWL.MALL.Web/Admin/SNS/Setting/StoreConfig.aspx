<%@ Page Title="图片存储设置" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="StoreConfig.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Setting.StoreConfig" %>
                    ...
                    <div class="newsadd_title">
                        ...
                        <div class="member_info_show">
                            <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                <tr>
                                    <td class="td_class" Width="120">
                                        上传图片存储：
                                    </td>
                                    <td>
                                        <asp:RadioButton ID="rdtLocal" GroupName="StoreWay" runat="server" Text="本地存储" />
                                        <asp:RadioButton ID="rdtWeb" runat="server" Text="又拍云存储" GroupName="StoreWay" />
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                                <tr class="webprop">
                                    ...
                                    <td width="420">
                                        <asp:TextBox ID="txtSpaceName" runat="server" Width="240" Height="21"></asp:TextBox>
                                    </td>
                                    <td rowspan="3" style="float: left">
                                        <a style="color: rgb(68, 68, 68); font-family: Simsun; font-size: 12px; font-style: normal;
                                            ...
                                            widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px;
                                            background-color: rgb(255, 255, 255); display: inline !important; float: none;">
                                            又拍云存储是通用的大规模存储服务。为网站提供静态文件存储+CDN加速的服务，静态文件主要是指图片，APP，音频，视频，小文件等等服务。<a href="https://www.upyun.com/?s=maticsoft"
                                                style="color: blue" target="_blank">点击申请</a>
                                    </td>
                                </tr>
                                <tr class="webprop">
                                    <td class="td_class" >
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtOperaterName" runat="server" Width="240" Height="21"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="webprop">
                                    <td class="td_class">
                                    ...
                                    <td style="color: Gray">
                                        <asp:TextBox ID="txtOperaterPassword" runat="server" Width="240" Height="21" TextMode="Password"></asp:TextBox>
                                    </td>
                                    <td>
                                        密码框不填表示不修改密码。
                                    </td>
                                ...
                                <tr class="webprop">
                                    ...
                                    <td style="color: Gray">
                                        <asp:TextBox ID="txtPhotoDomain" runat="server" Width="240" Height="21" Text="http://"></asp:TextBox>
                                    </td>
                                    <td>
                                        <span style="color: gray">例如：http://xxxx.b0.upaiyun.com</span>
                                    </td>
                                </tr>
                            </table>
                            <br />
                                    ...
                                    <tr>
                                        ...
                                        <td height="25">
                                            <asp:Button ID="btnSave" runat="server" Text="<%$ Resources:Site, btnSaveText %>"
                                                class="adminsubmit_short" OnClick="btnSave_Click" OnClientClick="return SubForm();"></asp:Button>
                                            <asp:Button ID="btnReset" runat="server" CausesValidation="false" Text="<%$ Resources:Site, btnCancelText%>"
                                                class="adminsubmit_short" OnClick="btnReset_Click" Visible="False"></asp:Button>
                                        </td>
                                    </tr>
                                </table>
                            </td>
