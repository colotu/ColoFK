<%@ Page Title="社区分类管理" Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Basic.Master"
    CodeBehind="List.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Categories.List" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody" style="float: left;border-bottom: 0px;">
                        <asp:Literal ID="Literal4" runat="server" Text="您可以对分类信息进行新增，编辑，删除操作" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <div class="newsicon">
                    <ul>
                        <li class="add-btn" id="liAdd"
                            runat="server"><a href="add.aspx?type=<%=Type %>" title="新增新的网站分类">新增</a>
                        </li>
