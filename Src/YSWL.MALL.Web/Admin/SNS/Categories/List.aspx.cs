...
namespace YSWL.MALL.Web.Admin.SNS.Categories
{
    public partial class List : PageBaseAdmin
    {
        ...
        protected new int Act_AddData = 122;    //运营管理_商品分享分类_新增分类
