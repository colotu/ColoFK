...
namespace YSWL.MALL.Web.Admin.SNS.Categories
{
    ...
    { //区分是否为商品分类还是图片分类
        ...
        private YSWL.MALL.BLL.SNS.Categories bll = new YSWL.MALL.BLL.SNS.Categories();
        ...
        {
            YSWL.MALL.BLL.SNS.Categories bll = new YSWL.MALL.BLL.SNS.Categories();
            YSWL.MALL.Model.SNS.Categories model = bll.GetModel(CategoryId);
        ...
        public void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (bll.Update(model))
            {
                ...
                if (Type ==1)
                {
                    YSWL.Common.MessageBox.ShowSuccessTip(this, "保存成功！", "list.aspx?type=1");
                }
                else
                {
