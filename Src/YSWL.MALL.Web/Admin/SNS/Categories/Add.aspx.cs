...
namespace YSWL.MALL.Web.Admin.SNS.Categories
{
    ...
    {    //区分是否为商品分类还是图片分类
        ...
        protected override int Act_PageLoad //SNS_图片分类管理_新增页
        {
            get
            {
                switch (type)
                {
                    case 0: 
                        return 564;//SNS_商品分享分类管理_新增页
                    case 1:
                        return 561;//SNS_图片分享分类管理_新增页
                    default:
                        return 564;
                }
            }
        ...
        private YSWL.MALL.BLL.SNS.Categories bll = new BLL.SNS.Categories();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            YSWL.MALL.Model.SNS.Categories model = new Model.SNS.Categories();
            ...
            if (bll.AddCategories(model))
            {
                ...
                {
                    YSWL.Common.MessageBox.ShowSuccessTip(this, "新增成功,正在跳转...！", "list.aspx?type=1");
                }
                else
                {
                    YSWL.Common.MessageBox.ShowSuccessTip(this, "新增成功,正在跳转...！", "list.aspx");
                }
                LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "新增商品类别成功!", this);
            }
            else
            {
                this.btnSave.Enabled = true;
                ...
                LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "新增商品类别失败!", this);
            }
        }
