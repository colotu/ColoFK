...
namespace YSWL.MALL.Web.Admin.SNS.ReportType
{
    public partial class List : PageBaseAdmin
    {
        ...
        protected new int Act_AddData = 151;    //运营管理_举报类型_新增举报类型
        protected new int Act_DeleteList = 154;    //运营管理_举报类型_批量删除举报类型

        private YSWL.MALL.BLL.SNS.ReportType bll = new YSWL.MALL.BLL.SNS.ReportType();
        ...
        protected void gridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            YSWL.MALL.BLL.SNS.Report reportBll=new BLL.SNS.Report();
