...
namespace YSWL.MALL.Web.Admin.SNS.ReportType
{
    public partial class Add : PageBaseAdmin
    {

        protected override int Act_PageLoad { get { return 608; } } //SNS_举报类型管理_新增页
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (bll.Add(model) > 0)
            {
                MessageBox.ShowSuccessTipScript(this, "新增举报类型成功", "window.parent.location.reload();");
                LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "新增举报类型成功", this);
            }
        }
