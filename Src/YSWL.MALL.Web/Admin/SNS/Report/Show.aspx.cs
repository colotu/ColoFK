...
namespace YSWL.MALL.Web.Admin.SNS.Report
{
    public partial class Show : PageBaseAdmin
    {
        ...
        private YSWL.MALL.BLL.SNS.Report bll = new YSWL.MALL.BLL.SNS.Report();
        YSWL.MALL.BLL.SNS.ReportType typeBll = new BLL.SNS.ReportType();
        ...
        private void ShowInfo(int Id)
        {
            ...
            if (model != null)
            {
                ...
                {
                    YSWL.MALL.Model.SNS.Posts postModel = postBll.GetModel(model.TargetID);
                ...
                {
                    YSWL.MALL.Model.SNS.Photos photoModel = photoBll.GetModel(model.TargetID);
                    this.lblName.Text = "此信息已不存在";
                    if (photoModel != null)
                    {
                ...
                {
                    YSWL.MALL.Model.SNS.Products productModel = productBll.GetModel(model.TargetID);
                    this.lblName.Text = "此信息已不存在";
        ...
        protected void btnReportTrue_Click(object sender, EventArgs e)
        {
            ...
            //YSWL.Common.MessageBox.ShowSuccessTip(this, "处理成功！");
            YSWL.Common.MessageBox.ResponseScript(this, "parent.location.href='Report.aspx'");
        }
