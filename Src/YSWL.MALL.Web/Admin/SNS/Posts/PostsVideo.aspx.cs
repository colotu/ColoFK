...
namespace YSWL.MALL.Web.Admin.SNS.PostsVideo
{
    public partial class List : PageBaseAdmin
    {
        ...
        public void BindData()
        {
            ...
            {
                strWhere.Append(" and convert(date,CreatedDate)>='" + Common.InjectionFilter.SqlFilter(txtBeginTime.Text.Trim()) + "' ");
            }
            if (!string.IsNullOrEmpty(txtEndTime.Text.Trim()))
            {
            
                strWhere.Append(" and convert(date,CreatedDate)<='" + Common.InjectionFilter.SqlFilter(txtEndTime.Text.Trim()) + "' ");
            }
