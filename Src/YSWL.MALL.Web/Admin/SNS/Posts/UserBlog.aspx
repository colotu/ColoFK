<%@ Page Title="用户文章管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="UserBlog.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.Posts.UserBlog" %>
            ...
            <Columns>
                    ...
                    <ItemTemplate>
                        <p style="white-space: normal; max-width:700px">                            
                           <a href='<%=YSWL.Components.MvcApplication.GetCurrentRoutePath(AreaRoute.SNS)%>Blog/BlogDetail?id=<%#Eval("BlogID")%>' target="_blank"> <%#Eval("Title")%></a>
                        </p>
                    </ItemTemplate>
                </asp:TemplateField>
