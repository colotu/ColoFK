<%@ Page Title="动态和评论管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="PostsVideo.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.PostsVideo.List" %>
                ...
                <asp:TemplateField HeaderText="视频信息" ItemStyle-HorizontalAlign="Center" SortExpression="CommentCount"
                    ...
                    <ItemTemplate>
                          <div style="text-align: left; margin-left: 10px;">
                            <asp:Literal ID="ltlTitle" runat="server" Text="标题"></asp:Literal>：<%#YSWL.Common.StringPlus.SubString(Eval("Description"),30,"...")%>
