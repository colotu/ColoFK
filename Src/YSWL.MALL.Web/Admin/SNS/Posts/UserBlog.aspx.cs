...
namespace YSWL.MALL.Web.Admin.SNS.Posts
{
    ...
    {
        private YSWL.MALL.BLL.SNS.UserBlog bll = new YSWL.MALL.BLL.SNS.UserBlog();
        ...
        public void BindData()
        {
            ...
            if (!string.IsNullOrEmpty(txtPoster.Text.Trim()))
            {
                ...
                strWhere.AppendFormat("UserName like '%{0}%' ", Common.InjectionFilter.SqlFilter(txtPoster.Text.Trim()));
            ...
            if (!string.IsNullOrEmpty(txtBeginTime.Text.Trim()))
            {
                ...
                strWhere.Append("  CreatedDate>='" + Common.InjectionFilter.SqlFilter(txtBeginTime.Text.Trim())+"'");
            }
            if (!string.IsNullOrEmpty(txtEndTime.Text.Trim()))
            {
                ...
                strWhere.Append(" CreatedDate<='" + Common.InjectionFilter.SqlFilter(txtEndTime.Text.Trim()) + "'");
            }
            ...
            if (txtKeyword.Text.Length > 0)
            {
                ...
                strWhere.Append(" Title like '%" + Common.InjectionFilter.SqlFilter(txtKeyword.Text) + "%' ");
            }
