<%@ Page Title="淘宝商品分类" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="TaoBaoCateList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.TaoBaoCate.TaoBaoCateList" %>

<%@ Register Assembly="YSWL.MALL.Web" Namespace="YSWL.MALL.Web.Controls" TagPrefix="Gre" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            <tr>
                ...
                <td style="float: left" height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    ...
                    <asp:Button ID="btnTaoBaoShow" runat="server" Text="查询" OnClick="btnTaoBaoShow_Click"
