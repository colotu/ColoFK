...
namespace YSWL.MALL.Web.Admin.SNS.TaoBaoCate
{
    public partial class TaoBaoCateList : PageBaseAdmin
    {
        private YSWL.MALL.BLL.SNS.CategorySource bll = new BLL.SNS.CategorySource();
        ...
        protected void btnUpdateTaoBaoCate_Click(object sender, EventArgs e)
        {
            ...
            YSWL.MALL.Web.LogHelp.AddUserLog(CurrentUser.UserName, "更新淘宝分类",
