...
namespace YSWL.MALL.Web.SNS.SearchWordLog
{
    public partial class List : PageBaseAdmin
    {
        //int Act_ShowInvalid = -1; //查看失效数据行为

        private YSWL.MALL.BLL.SNS.SearchWordLog bllSearchWordLog = new YSWL.MALL.BLL.SNS.SearchWordLog();
        private YSWL.MALL.BLL.SNS.HotWords bllHotWords = new YSWL.MALL.BLL.SNS.HotWords();

        protected override int Act_PageLoad { get { return 144; } } //运营管理_是否显示查询日志管理页面
        protected new int Act_DeleteList = 145;    //运营管理_查询日志管理_批量删除查询日志
        protected new int Act_DelData = 145;    //运营管理_查询日志管理_批量删除查询日志
        ...
        protected void lbtnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                LogHelp.AddUserLog(CurrentUser.UserName, CurrentUser.UserType, "批量删除查询日志(id=" + idlist + ")成功", this);
        ...
        public void BindData()
        {
            ...
            if (!string.IsNullOrEmpty(txtKeyword.Text.Trim()))
            {
                ...
                strWhere.AppendFormat("SearchWord like '%{0}%' ", Common.InjectionFilter.SqlFilter(txtKeyword.Text.Trim()));
            }
        ...
        protected void btnPush_Click(object sender, EventArgs e)
        {
            ...
            if (bllSearchWordLog.GetHotHotWordssList(Top))
            {
                ...
                //        {
                //            YSWL.MALL.Model.SNS.HotWords model = new Model.SNS.HotWords();
        ...
        {
            //状态 0:不可用 1：可用 2:被推荐到逛宝贝的热搜词中,3 被推荐到查询框下面的热搜词中
            string str = string.Empty;
            if (!StringPlus.IsNullOrEmpty(target))
            {
                switch (Globals.SafeInt(target.ToString(), -1))
