<%@ Page Title="查询日志管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="SearchLog.aspx.cs" Inherits="YSWL.MALL.Web.SNS.SearchWordLog.List" %>
    ...
    <div class="newslistabout">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal1" runat="server" Text="查询日志管理" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal3" runat="server" Text="您可以删除查询日志" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SearchWord" HeaderText="查询词"
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            <tr>
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                    ...
                    <asp:CheckBox ID="chkDelete" runat="server" Text="覆盖原热门查询排行" Checked="true"  />
