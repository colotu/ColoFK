...
namespace YSWL.MALL.Web.Admin.SNS.AddTags
{
    public partial class AddTags : PageBaseAdmin
    {
         ...
         YSWL.MALL.BLL.SNS.PhotoTags photoTags = new BLL.SNS.PhotoTags();
         YSWL.MALL.BLL.SNS.Tags productTags = new BLL.SNS.Tags();
        ...
        private void BindTags()
        {
            if (Type == "Product")
            {
                ...
                List<YSWL.MALL.Model.SNS.Tags> List = new List<Model.SNS.Tags>();
                ...
                foreach (YSWL.MALL.Model.SNS.Tags item in List)
                {
                    if (productModel != null && !string.IsNullOrEmpty(productModel.Tags))
                    {
            ...
            if (Type == "Photo")
            {
                ...
                List<YSWL.MALL.Model.SNS.PhotoTags> List = new List<Model.SNS.PhotoTags>();
                ...
                foreach (YSWL.MALL.Model.SNS.PhotoTags item in List)
                {
                    if (photoModel != null && !string.IsNullOrEmpty(photoModel.Tags))
                    {
        ...
        public int GetTypeIdByProductId(int ProductId)
        {
            ...
            if (model != null)
            {
                ...
                List<YSWL.MALL.Model.SNS.TagType> list=new List<Model.SNS.TagType>();
                int Cid = 0;
