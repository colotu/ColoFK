<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTags.aspx.cs" Inherits="YSWL.MALL.Web.Admin.SNS.AddTags.AddTags" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                       <asp:Literal ID="Literal2" runat="server" Text="新增标签" />
                    </td>
                </tr>
            </table>
                          ...
                          <table cellspacing="0" width="100%" cellpadding="0" border="0"  style=" margin-top:20px;margin-bottom: 20px;">
                              <tr>
                                  ...
                                  <td id="AddTags"  style="width:1200px">
                                     ...
                                     <asp:Button ID="btnAddTags" runat="server" Text="新增标签" class="adminsubmit_short" OnClick="btnSave_Click"
                                         />
                                  </td>
                              </tr>
