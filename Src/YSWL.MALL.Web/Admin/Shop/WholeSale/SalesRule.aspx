<%@ Page Title="批发规则管理" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="SalesRule.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.WholeSale.SalesRule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $(".iframe").colorbox({ iframe: true, width: "840", height: "640", overlayClose: false });
            $(".SetProduct").colorbox({ iframe: true, width: "1080", height: "770", overlayClose: false });
            ...
            <div class="newsicon">
                <ul>
                    <li id="liAdd" class="add-btn" runat="server">
                        <a class="iframe" href="AddRule.aspx">新增</a> <%--<b>|</b> --%></li>
                    <li id="liDel" class="add-btn" runat="server" style="display: none"><a href="#">删除</a><%--<b>|</b>--%></li>
                </ul>
            </div>
        </div>
