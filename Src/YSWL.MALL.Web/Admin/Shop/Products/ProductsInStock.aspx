...
padding-top: 5px;
top: -50px;
left: -42px;"><img style="margin: 0 auto;display: block;" src="/<%= YSWL.Components.MvcApplication.UploadFolder %>/Shop/QR/Product/<%# Eval("ProductId")%>.png" width="100px" height="100px"/>
