<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="ProductAdd.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Products.ProductAdd"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/admin/js/jquery/ProductAdd.helper.js?v=1.0" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
        <div class="newslist_title">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">您可以<asp:Literal ID="Literal3" runat="server" Text="设置商品的基本信息，详细介绍，规格，相关商品" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="TabContent formitem">
            <div id="myTab1_Content0" tabindex="0" style="outline: none;">
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0" class="formTR">
                                <tr>
                                    ...
                                    <td height="25">
                                        <span style="color: royalblue; font-size: 11pt; font-weight: bold;" id="litCategoryName"></span>[<a style="font-size: 9pt;" class='iframe'>设置分类</a>]
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_class">
                                ...
                                <tr style="display: none;">
                                    <td class="td_class">限购数 ：
                                    </td>
                                    <td height="25">
                                        <asp:TextBox ID="txtRestrictionCount" runat="server" CssClass="OnlyNum" Width="200px" MaxLength="6" Text="0">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:RadioButtonList ID="rblSalesType" runat="server"
                                            ...
                                            <%--  <asp:ListItem  Value="2">预订</asp:ListItem>     --%>
                                            <asp:ListItem Value="3">赠品</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr runat="server" id="deliveryTip" visible="false">
                                    <td class="td_class">预定配送提示：
                                    </td>
                                    <td height="25">
                                        <asp:TextBox ID="txtDeliveryTip" runat="server" Width="200px">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <li>
                                                <div class="ImgUpload ">
                                                    ...
                                                    <span id="a1" class="cancel" style="display: none; z-index: 999999"><a class="DelImage"
                                                        href="javascript:void(0);">删除</a></span> <span class="file_uploadUploader" style="width: 127px; height: 128px; overflow: hidden;">
                ...
                <input type="hidden" value="" id="Hidden_SelectValueCompare" />
                <!--当关闭分类时用于比较分类是否发生改变-->
                ...
                <div style='display: none; width: 700px;'>
                    <div class="dataarea mainwidth td_top_ccc" style="background: white;" id='divPackage'>
                        ...
                        <div class="toptitle">
                            <h1 class="title_height">选择具体包装</h1>
                        </div>
                        <%--<div class="search_results">
            ...
            <div id="myTab1_Content1" tabindex="1" class="none4" style="outline: none;">
                <table style="width: 100%; border-bottom: none; padding-top: 10px; border-top: none; float: left;" cellpadding="2"
            ...
            <div id="myTab1_Content3" tabindex="3" class="none4" style="outline: none;">
                <table style="width: 100%; border-bottom: none; border-top: none; float: left; padding-top: 10px;" cellpadding="2"
                    cellspacing="1" class="border">
                    <tr>
                            ...
                            <table style="width: 100%; border-bottom: none; border-top: none; float: left;" cellpadding="2"
                                ...
                                <tr>
                                    <td colspan="4" style="width: 100%; text-align: center;">
                                        <iframe width="95%" height="649px" frameborder="0" src="" id="RelatedProductIfram"></iframe>
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <script type="text/javascript">
        var editor = new baidu.editor.ui.Editor({
            ...
            autoClearinitialContent: true, imagePath: "/<%= YSWL.Components.MvcApplication.UploadFolder %>/RTF/", imageManagerPath: "/"
        });
