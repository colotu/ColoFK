      ...
      <div class="newslistabout">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            ...
            <tr>
                ...
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                 <a href="/<%= YSWL.Components.MvcApplication.UploadFolder %>/Template/ImportProduct.xls" class="a-link">下载导入商品模板文件  </a>&#12288;&#12288;&#12288;
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
            ...
            <tr>
                ...
                <td height="35" bgcolor="#FFFFFF" class="newstitlebody">
                      1.请把本地电脑上的商品清晰图整理好并通过 FTP 上传到： 网站根目录/<%= YSWL.Components.MvcApplication.UploadFolder %>/Shop/Images/Product/  <span style="color:#DA8210;">+</span>  ImageUrl
                </td>
            </tr>
            <tr>
                <td width="60px" height="30" >
