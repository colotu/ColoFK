...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table style="width: 100%;" cellpadding="2" cellspacing="1" class="borderkuang padd-no">
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnAdd" runat="server" Text="新增" class="adminsubmit_short" OnClick="btnAdd_Click">  </asp:Button>
                </td>
            </tr>
        </table>
        <!--Title end -->
    ...
    <script type="text/javascript">
        if ($('.GridViewTyle .GridViewDataRow').length == 0)
            $('.GridViewTyle>tbody').append('<tr><td colspan="4">暂无数据</td></tr>');
