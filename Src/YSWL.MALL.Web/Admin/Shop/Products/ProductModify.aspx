<%@ Page Title="编辑商品" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="ProductModify.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Products.ProductModify" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <%--  <link href="/admin/js/jBox/Skins/jbox.css" rel="stylesheet" type="text/css" />
   ...
   <script src="/admin/js/jquery/ProductModify.helper.js?v=1.0" type="text/javascript"></script> 
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var isOpenRelated = $("#ctl00_ContentPlaceHolder1_hfIsOpenRelated").val().toLowerCase();
            if (isOpenSku== "true") {
            ...
            if ($("[id$=hfIsOpenSEO]").val().toLowerCase() == "true") {
                $("#tabSEO").show();
            }
    ...
    <div class="newslistabout">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                ...
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        您可以<asp:literal id="Literal3" runat="server" text="设置商品的基本信息，详细介绍，规格，相关商品" />
                    </td>
                </tr>
            </table>
        </div>
      ...
      <%--  <asp:HiddenField ID="hfIsOpenFit" runat="server" Value="True"/>--%>
        ...
        <div class="TabContent formitem">
            <div id="myTab1_Content0" tabindex="0" style="outline: none;">
                <table style="width: 100%; border-bottom: none; border-top: none; float: left;" cellpadding="2" cellspacing="1">
                    <tr>
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0" class="formTR">
                                <tr >
                                    ...
                                    <td height="25">
                                        <span style="color: royalblue; font-size: 11pt;" id="litCategoryName"><asp:Literal runat="server" ID="LitPName"></asp:Literal></span>
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:textbox id="txtProductName" runat="server" width="318px">
                                        </asp:textbox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td height="25">
                                        <div>
                                           ...
                                           <span > <span class="pinpai">品牌 ：</span>
                                ...
                                <tr style="display: none;">
                                    ...
                                    <td height="25">
                                        <label class="msgNormal" style="width: 318px">
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtProductSKU" runat="server" Width="318px" MaxLength="20">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtSalePrice" runat="server" CssClass="OnlyFloat" Width="318px"
                                            MaxLength="20">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr  class="haveSku">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtStock" runat="server" CssClass="OnlyNum" Width="318px" MaxLength="6" Text="0">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr  style="display:none;">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtRestrictionCount" runat="server" CssClass="OnlyNum" Width="318px" MaxLength="6" Text="0">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtDisplaySequence" runat="server" Width="318px">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtUnit" runat="server" Width="318px" MaxLength="20">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtMarketPrice" runat="server" Width="318px" MaxLength="20" Text="0">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                 <tr  class="haveSku">
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtCostPrice" runat="server" CssClass="OnlyFloat" Width="318px"
                                            MaxLength="20">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr  class="haveSku">
                                    ...
                                    <td height="25">
                                        <asp:textbox id="txtAlertStock" runat="server" CssClass="OnlyNum" width="318px" maxlength="5">
                                        </asp:textbox>
                                    </td>
                                </tr>
                                <tr class="haveSku">
                                    ...
                                    <td height="25">
                                        <asp:textbox id="txtWeight" runat="server" CssClass="OnlyNum" width="318px" maxlength="20">
                                        </asp:textbox>
                                        克
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td height="25">
                                        <asp:TextBox ID="txtPoints" runat="server" CssClass="OnlyNum" Width="318px" MaxLength="5" Text="0">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr  class="haveSku">
                                 ...
                                 <tr  >
                                   ...
                                   销售类型：
                                    ...
                                    <td height="25">
                                        <asp:RadioButtonList ID="rblSalesType" runat="server" 
                                            RepeatDirection="Horizontal" 
                                            onselectedindexchanged="rblSalesType_SelectedIndexChanged">
                                ...
                                <tr  runat="server" id="deliveryTip"  visible="false">
                                    <td class="td_class">
                                    预定配送提示：
                                    </td>
                                    <td height="25">
                                          <asp:TextBox ID="txtDeliveryTip" runat="server"  Width="318px"  >
                                        </asp:TextBox>
                                    </td>
                                </tr>  
                                <tr>
            ...
            <div id="myTab1_Content1" tabindex="1" class="none4" style="outline: none;">
                <table style="width: 100%; border-bottom: none; padding-top: 10px; border-top: none; float: left;" cellpadding="2" cellspacing="1">
                    <tr>
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td class="td_class" style="vertical-align: top;width: 97px;">
                                        商品介绍 ：
                                    </td>
                                    <td height="25">
            ...
            <div id="myTab1_Content2" tabindex="2" class="none4" style="outline: none;">
                <table style="width: 100%; border-bottom: none; border-top: none; float: left;" cellpadding="2" cellspacing="1">
                    <tr id="trbtnOpenSKUs">
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                  <td  class="td_class" >
                                    ...
                                    <td height="25">
                                        <input id="btnOpenSKUs" type="button" class="add-btn" value="开启规格" />
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <div id="myTab1_Content3" tabindex="3" class="none4" style="outline: none;">
                <table style="width: 100%; border-bottom: none; border-top: none; float: left;padding-top: 10px;" cellpadding="2" cellspacing="1"
                    >
                    <tr>
                        <td class="td_class">
                            URL规则 ：
                        ...
                        <td height="25">
                            <asp:TextBox ID="txtUrlRule" runat="server" Width="318px">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25">
                            <asp:textbox id="txtMeta_Title" runat="server" width="318px">
                            </asp:textbox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25">
                            <asp:textbox id="txtMeta_Description" runat="server" width="318px">
                            </asp:textbox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25">
                            <asp:textbox id="txtMeta_Keywords" runat="server" width="318px">
                            </asp:textbox>
                        </td>
                    </tr><tr>
                        <td class="td_class">
                        ...
                        <td height="25">
                            <asp:TextBox ID="txtSeoImageAlt" runat="server" Width="318px">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25">
                            <asp:TextBox ID="txtSeoImageTitle" runat="server" Width="318px">
                            </asp:TextBox>
                        </td>
                    </tr>
                </table>
            ...
            <div id="myTab1_Content4" tabindex="4" class="none4" style="outline: none;">
                <table style="width: 100%; border-bottom: none; border-top: none; float: left;" cellpadding="2" cellspacing="1">
                        ...
                        <td class="tdbg">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        <input id="btnAddRelatedProducts" type="button" class="adminsubmit-short add-btn" value="新增" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <td class="tdbg">
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td height="25">
                                    <asp:button id="btnSave" runat="server" onclick="btnSave_OnClick" text="<%$ Resources:Site, btnSaveText %>" class="adminsubmit-short add-btn" onclientclick="return SubForm();"></asp:button>
                                </td>
                            </tr>
                        </table>
                    </td>
