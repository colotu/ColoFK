...
namespace YSWL.MALL.Web.Admin.Shop.Supplier.SupplierInfo
{
    public partial class Modify : PageBaseAdmin
    {
        ...
        BLL.Shop.Supplier.SuppAreaRelation suppareaRelationBll = new BLL.Shop.Supplier.SuppAreaRelation();
        ...
        private void ShowInfo()
        {
            ...
            if (model != null)
            {
                ...
                YSWL.MALL.Model.Shop.Supplier.SuppAreaRelation suppAreaRelationModel= suppareaRelationBll.GetModelBySupplerId(model.SupplierId);
                if (suppAreaRelationModel != null) {
                    this.dllSuppAreasDropList.SelectedValue = suppAreaRelationModel.AreaId.ToString();
                }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (null != model)
            {
                int suppAreaId = Common.Globals.SafeInt(this.dllSuppAreasDropList.SelectedValue, 0);
                model.Name = Name;
                ...
                if (bll.Update(model, SupplierId, list, suppAreaId))
                {
