<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Supplier.SupplierInfo.Modify" Title="编辑商家" %>

<%@ Register Src="~/Controls/UCDroplistPermission.ascx" TagName="UCDroplistPermission" TagPrefix="uc2" %>
<%@ Register Src="~/Controls/SuppAreasDropList.ascx" TagPrefix="YSWL" TagName="SuppAreasDropList" %>
    ...
    <div class="newslistabout">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal2" runat="server" Text="编辑商家" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        <asp:Literal ID="Literal3" runat="server" Text="您可以编辑商家信息" />
                    </td>
                </tr>
            </table>
        </div>
        <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr>
                ...
                <td height="25">
                    <asp:TextBox ID="txtEstablishedDate" runat="server" Width="150px" MaxLength="10"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td_class">
            ...
            <tr>
             ...
             <tr>
                ...
                <td height="25">
                    <YSWL:SuppAreasDropList runat="server" ID="dllSuppAreasDropList"  IsNull="true" />
                </td>
            </tr>
            <tr  style="display:none;">
                <td class="td_class">
            ...
            <tr>
                ...
                <td height="25">
                    <asp:TextBox ID="txtRemark" runat="server" Width="536px" TextMode="MultiLine" Rows="3" Height="80px"></asp:TextBox>
                </td>
            </tr>
                                    <tr style="display:none;">
