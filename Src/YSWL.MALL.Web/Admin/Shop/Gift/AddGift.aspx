<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="AddGift.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Gift.AddGift"
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal2" runat="server" Text="新增礼品" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        您可以<asp:Literal ID="Literal3" runat="server" Text="设置礼品的基本信息，礼品描述，查询优化" />
                    </td>
                </tr>
            </table>
        </div>
                                            ...
                                            <li>
                                                <div class="ImgUpload ">
                                                    <asp:HiddenField ID="hfImage" runat="server"  />
                                                      <asp:HiddenField ID="thfImage" runat="server"  />
