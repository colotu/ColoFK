<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Brands.Add" Title="增加页" %>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        ...
                                        <YSWL:ValidateTarget ID="ValidateTargetName" runat="server" Description="品牌名称不能为空，长度限制在100个字符以内！" OkMessage="输入正确"
                                ...
                                <tr>
                                    ...
                                    <td height="25">
                                        ...
                                        <YSWL:ValidateTarget ID="ValidateTargetOffUrl" runat="server" ControlToValidate="txtCompanyUrl"  OkMessage="输入正确"
