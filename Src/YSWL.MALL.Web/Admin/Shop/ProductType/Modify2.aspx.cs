...
namespace YSWL.MALL.Web.Admin.Shop.ProductType
{
    public partial class Modify2 : PageBaseAdmin
    {
        ...
        protected new int Act_AddData = 495;    // Shop_扩展属性_新增数据
        ...
        private YSWL.MALL.BLL.Shop.Products.AttributeValue bllValue = new YSWL.MALL.BLL.Shop.Products.AttributeValue();
        ...
        protected void gridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                List<YSWL.MALL.Model.Shop.Products.AttributeValue> list = bllValue.GetModelList(AttributeId);
