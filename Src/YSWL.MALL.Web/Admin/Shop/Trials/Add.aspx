<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Trials.Add" Title="增加页" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderkuang">
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitle">
                        <asp:Literal ID="Literal2" runat="server" Text="增加试用" />
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFFF" class="newstitlebody">
                        您可以<asp:Literal ID="Literal3" runat="server" Text="增加试用" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        ...
                        <tr style="display: none;">
                            ...
                            <td height="25" width="*" align="left">
                                <asp:TextBox ID="txtDisplaySequence" runat="server" Width="200px" Text="0"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td height="25" class="td_class">
