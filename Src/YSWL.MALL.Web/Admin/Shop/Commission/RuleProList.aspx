<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/BasicNoFoot.Master" AutoEventWireup="true"
    CodeBehind="RuleProList.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Shop.Commission.RuleProList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="newslistabout">
        <div class="dg-title">设置佣金规则应用商品</div>
                            ...
                            <table style="width: 100%; border: none; float: left;" cellpadding="2" cellspacing="1"
                                ...
                                <tr>
                                    <td colspan="4" style="width: 100%; text-align: center;">
                                        <iframe width="100%" height="649px" frameborder="0" src="/Admin/Shop/Commission/ProductItems.aspx?ruleId=<%=RuleId%>">
                                        </iframe>
                                    </td>
                                </tr>
                            </table>
