<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main2.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Main2" %>
...
<span><strong style="font-size:14px;">Admin 早上好，欢迎使用云商框架后台管理系统</strong> <a href="javascript:;"> 账号设置</a></span></div>
</div>
<div class="main_main"><div class="sj"><img src="images/icon5.gif" width="22" height="20" /></div> <span class="main_time">您上次登录的时间：2011-10-11 12:10  (不是您登录的？<a href="javascript:;">请点这里</a>)</span></div>
...
<div class="main_tj"><a href="javascript:;">新增新的快捷功能</a></div>
