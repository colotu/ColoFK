...
namespace YSWL.MALL.Web.Admin.Members.Reservation
{
    public partial class UpdateService : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //待上传的图片名称
            string savePath = string.Format("/"+MvcApplication.UploadFolder+"/Reservation/Images/Product/{0}/", DateTime.Now.ToString("yyyyMMdd"));
            string saveThumbsPath = "/"+MvcApplication.UploadFolder+"/Reservation/Images/ProductThumbs/" + DateTime.Now.ToString("yyyyMMdd") + "/";
