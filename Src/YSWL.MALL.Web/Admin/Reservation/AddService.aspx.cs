...
namespace YSWL.MALL.Web.Admin.Members.Reservation
{
    public partial class AddService : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //待上传的图片名称
            string savePath = string.Format("/"+MvcApplication.UploadFolder+"/Appt/Images/Reservation/{0}/", DateTime.Now.ToString("yyyyMMdd"));
            string saveThumbsPath = "/"+MvcApplication.UploadFolder+"/Appt/Images/ReservationThumbs/" + DateTime.Now.ToString("yyyyMMdd") + "/";
