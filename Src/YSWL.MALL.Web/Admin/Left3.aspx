<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Left3.aspx.cs" Inherits="YSWL.MALL.Web.Admin.Left3" %>
...
<head id="Head1" runat="server">
    ...
    <link href="/admin/css/style-left.css?v=1.0" rel="stylesheet"> 
</head>
...
<div class=" page-sidebar navbar-collapse collapse content_wrap" >
  <div class="" ><h3 class="page-sidebar-head" >订货商城</h3></div>
 <div class="nav-left">
