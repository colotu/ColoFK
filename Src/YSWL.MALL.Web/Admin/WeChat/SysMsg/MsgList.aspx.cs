...
namespace YSWL.MALL.Web.Admin.WeChat.SysMsg
{
    public partial class MsgList : PageBaseAdmin
    {
        ...
        private string AddMsg()
        {
            ...
            string savePath = "/"+MvcApplication.UploadFolder+"/WeChat/" + DateTime.Now.ToString("yyyyMMdd") + "/";
            ...
            if (!String.IsNullOrWhiteSpace(tempImg) && tempImg.Contains("/"+MvcApplication.UploadFolder+"/Temp"))
            {
