        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else  //订货菜单
                {
                    ...
                    this.ddMenuAction.Items.Insert(2, new ListItem("我的账户", "-15"));
                    this.ddMenuAction.Items.Insert(3, new ListItem("我的订单", "-16"));
                    this.ddMenuAction.Items.Insert(4, new ListItem("零售商城", "-17"));
