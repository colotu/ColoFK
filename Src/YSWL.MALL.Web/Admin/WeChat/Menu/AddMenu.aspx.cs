      ...
      private YSWL.MALL.BLL.CMS.Content contentBll = new BLL.CMS.Content();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.ddMenuAction.Items.Insert(1, new ListItem("批发商城", "-14"));
                    this.ddMenuAction.Items.Insert(2, new ListItem("零售商城", "-17"));
                    this.ddMenuAction.Items.Insert(3, new ListItem("我的账户", "-15"));
                    this.ddMenuAction.Items.Insert(4, new ListItem("我的订单", "-16"));
