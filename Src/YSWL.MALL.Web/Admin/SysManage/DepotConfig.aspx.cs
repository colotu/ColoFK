    ...
    public partial class DepotConfig : PageBaseAdmin
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BLL.SysManage.ConfigSystem.Modify("Shop_SAAS_Enterprise", txtToken.Text, "云商订单管理系统SAAS版Token");
                ...
                {
                    UpdateWCFConfig(omsUrl, pmsUrl);
                }
                //清空缓存
                #region 清空所有缓存
                YSWL.Common.DataCache.ClearAll(MvcApplication.IsAutoConn);
                #endregion
