            ...
            <tr>
                <td class="tdbg">
                    <table cellspacing="0" cellpadding="3" width="100%" border="0">
                        ...
                        <tr  style="<%= YSWL.Components.MvcApplication.IsAutoConn?"display:none":"" %>">
                            <td class="td_class">
                        ...
                        <tr style="<%= YSWL.Components.MvcApplication.IsAutoConn?"display:none":"" %>" >
                            <td class="td_class">
                                <asp:Literal ID="Literal13" runat="server" Text="网站授权码" />：
                            </td>
                            <td height="25">
                                <asp:TextBox ID="txtAuthorize" runat="server" Width="400"></asp:TextBox>
                                <span style="color: gray;">联系<a href="http://www.ys56.com/contact.aspx" target="_blank"
                                    style="color: blue">云商官方获取授权</a></span>
                            </td>
                        </tr>
