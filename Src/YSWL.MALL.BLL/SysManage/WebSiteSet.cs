...
namespace YSWL.MALL.BLL.SysManage
{
    ...
    public class WebSiteSet
    {
        ...
        {
            get { return ConfigSystem.GetValueByCache(WebSiteSet.WEB_AUTHORIZECODE, applicationKeyType); }
            set
            {
                ConfigSystem.Modify(WEB_AUTHORIZECODE, value, WEB_AUTHORIZECODE, applicationKeyType);
