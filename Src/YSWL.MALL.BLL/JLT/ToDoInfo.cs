...
namespace YSWL.MALL.BLL.JLT
{
    ...
    public partial class ToDoInfo
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.JLT.ToDoInfo GetModelByCache(int ID)
        {
            ...
            return (YSWL.MALL.Model.JLT.ToDoInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.JLT.ToDoInfo> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.JLT.ToDoInfo> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.JLT.ToDoInfo> modelList = new List<YSWL.MALL.Model.JLT.ToDoInfo>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.JLT.ToDoInfo model;
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.JLT.ToDoInfo> GetModelListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
        ...
        /// </summary>
        public List<YSWL.MALL.Model.JLT.ToDoInfo> GetListByPageEx4API(string strWhere, string orderby, int startIndex, int endIndex)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.JLT.ToDoInfo GetModelEx(int ID)
        {
