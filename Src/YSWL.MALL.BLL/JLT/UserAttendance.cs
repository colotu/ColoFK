...
namespace YSWL.MALL.BLL.JLT
{
    ...
    public partial class UserAttendance
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.JLT.UserAttendance GetModelByCache(int ID)
        {
            ...
            return (YSWL.MALL.Model.JLT.UserAttendance)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.JLT.UserAttendance> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.JLT.UserAttendance> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.JLT.UserAttendance> modelList = new List<YSWL.MALL.Model.JLT.UserAttendance>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.JLT.UserAttendance model;
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.JLT.UserAttendance> GetModelListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
        ...
        public DataSet Statistics(YSWL.Accounts.Bus.User currentUser, DateTime startDate, DateTime endDate, int reviewedStatus)
        {
        ...
        /// <param name="endDate">结束时间</param>
        /// <param name="reviewedStatus">批复状态</param>
        public DataSet GetCollectAttendance(YSWL.Accounts.Bus.User currentUser, string userName, DateTime startDate, DateTime endDate, int reviewedStatus)
        {
            StringBuilder strWhere = new StringBuilder(" 1=1 ");
            if (currentUser.UserType == "UU")
            {
