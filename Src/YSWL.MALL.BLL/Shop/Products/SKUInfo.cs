...
namespace YSWL.MALL.BLL.Shop.Products
{
    ...
    public partial class SKUInfo
    {
       ...
       /// <returns></returns>
        ...
        /// <returns></returns>
        public int GetInSaleSkuNumByCache(DateTime? date)
        {
            string CacheKey = " GetInSaleSkuNum";
            if (date.HasValue)
            {
                CacheKey = " GetInSaleSkuNum-" + date.Value.ToString("yyyy-MM-dd");
            }
