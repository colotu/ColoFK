...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Groups
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Groups GetModelByCache(int GroupID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Groups)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Groups> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Groups> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Groups> modelList = new List<YSWL.MALL.Model.SNS.Groups>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Groups model;
        ...
        public List<YSWL.MALL.Model.SNS.Groups> GetUserJoinGroup(int UserId, int Top)
        {
        ...
        /// 搜索相关的小组
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Groups> GetGroupListByKeyWord(string q)
        {
            return GetModelList("GroupName like '%" + Common.InjectionFilter.SqlFilter(q) + "%'");
        }
        /// <summary>
        /// 搜索小组分页
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Groups> GetGroupListByKeyWord(int startIndex, int endIndex, string Sequence, string q, int rec = -1)
        {
            string strWhere = "";
            if (rec != -1)
            {
            ...
            if (!String.IsNullOrWhiteSpace(q))
            {
                ...
                strWhere += " (GroupName like '%" + Common.InjectionFilter.SqlFilter(q) + "%' or GroupDescription Like '%" + Common.InjectionFilter.SqlFilter(q) + "%' or Tags like '%" + Common.InjectionFilter.SqlFilter(q)+
                            "%')";
            }
        ...
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Groups> GetGroupListByRecommendType(int Top, YSWL.MALL.Model.SNS.EnumHelper.GroupRecommend Type)
        {
        ...
        /// <param name="Top"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Groups> GetHotGroupList(int Top)
        {
