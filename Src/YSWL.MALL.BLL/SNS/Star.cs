...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Star
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(YSWL.MALL.Model.SNS.Star model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSWL.MALL.Model.SNS.Star model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Star GetModel(int ID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Star GetModelByCache(int ID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Star)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Star> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Star> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Star> modelList = new List<YSWL.MALL.Model.SNS.Star>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Star model;
        ...
        public List<ViewModel.SNS.ViewStar> GetListForPage(int TypeId, string orderby, int startIndex, int endIndex, int CurrentUserId)
        {
            ...
            YSWL.MALL.BLL.Members.UsersExp userExpBll = new Members.UsersExp();
            ...
            foreach (Model.SNS.Star model in models)
            {
                ...
                if (CurrentUserId != 0)
                {
                    ...
                    List<YSWL.MALL.Model.SNS.UserShip> shipList = bllUserShip.GetModelList("ActiveUserID = " + CurrentUserId + "");
        ...
        {    DataSet ds=new DataSet();
            ...
            {
                List<YSWL.MALL.Model.SNS.Star> List;
                if (ds != null)
                {
                    List = DataTableToList(ds.Tables[0]);
                    if (List != null)
                    {
                        foreach (YSWL.MALL.Model.SNS.Star item in List)
                        {
