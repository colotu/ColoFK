...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class UserAlbumsType
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.UserAlbumsType GetModelByCache(int AlbumsID,int TypeID)
		{
			...
			return (YSWL.MALL.Model.SNS.UserAlbumsType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserAlbumsType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserAlbumsType> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.UserAlbumsType> modelList = new List<YSWL.MALL.Model.SNS.UserAlbumsType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.UserAlbumsType model;
        ...
        /// 增加一条数据
        /// </summary>
        public bool AddEx(YSWL.MALL.Model.SNS.UserAlbumsType model)
        {
