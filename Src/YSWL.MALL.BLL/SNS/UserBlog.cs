...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class UserBlog
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(YSWL.MALL.Model.SNS.UserBlog model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSWL.MALL.Model.SNS.UserBlog model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.UserBlog GetModel(int BlogID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.UserBlog GetModelByCache(int BlogID)
        {
            ...
            return (YSWL.MALL.Model.SNS.UserBlog)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserBlog> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserBlog> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.UserBlog> modelList = new List<YSWL.MALL.Model.SNS.UserBlog>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.UserBlog model;
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserBlog> GetMoreList(int userId, int blogId, int top)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserBlog> GetHotBlogList(int top)
        {
            string strWhere = " Status=1";
        ...
        #region 分页得到数据
        public List<YSWL.MALL.Model.SNS.UserBlog> GetUserBlogPage(string strWhere, string orderby, int StartIndex, int EndIndex)
        {
            List<YSWL.MALL.Model.SNS.UserBlog> list = new List<Model.SNS.UserBlog>();
        ...
        /// </summary>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserBlog> GetActiveUser(int top)
        {
            ...
            return (List<YSWL.MALL.Model.SNS.UserBlog>)objModel;
        ...
        public List<YSWL.MALL.Model.SNS.UserBlog> GetRecBlogList(int top)
        {
