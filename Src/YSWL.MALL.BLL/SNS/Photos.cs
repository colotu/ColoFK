...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Photos
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(YSWL.MALL.Model.SNS.Photos model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSWL.MALL.Model.SNS.Photos model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Photos GetModel(int PhotoID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Photos GetModelByCache(int PhotoID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Photos)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Photos> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Photos> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Photos> modelList = new List<YSWL.MALL.Model.SNS.Photos>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Photos model;
        ...
        public List<PostContent> GetPhotoListByPage(int categoryId, string orderby, int startIndex, int endIndex)
        {
            ...
            YSWL.MALL.BLL.SNS.Comments commentBll = new Comments();
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    model.Type = (int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Photo;
                ...
                if (commentList != null)
                {
                    ...
                    imgList.ForEach(img =>
                    {
                        List<Model.SNS.Comments> List = commentList.FindAll(xx => (xx.TargetId == img.TargetId && xx.Type == (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo));
                        if (List == null) return;
        ...
        public List<YSWL.MALL.Model.SNS.Photos> GetTopPhotoList(int Top,int Type,YSWL.MALL.Model.SNS.EnumHelper.RecommendType mode=YSWL.MALL.Model.SNS.EnumHelper.RecommendType.Home)
        {
        ...
        public List<YSWL.MALL.Model.SNS.Photos> GetTopPhotoPostByType(int top, int CategoryId)
        {
            return DataTableToList(GetListByPage(" Status=1 and  CategoryId=" + CategoryId + "", "CreatedDate desc", 0, top).Tables[0]);
        }
        public List<YSWL.MALL.Model.SNS.Photos> GetRecPhoto(int categoryId, int top,
                                                            YSWL.MALL.Model.SNS.EnumHelper.RecommendType mode =
                                                                YSWL.MALL.Model.SNS.EnumHelper.RecommendType.Home)
        {
        ...
        /// <param name="pid"></param>
        /// <returns></returns>
        public YSWL.MALL.ViewModel.SNS.TargetDetail GetPhotoAssistionInfo(int pid,int type=-1)
        {
            YSWL.MALL.ViewModel.SNS.TargetDetail DetailModel = new ViewModel.SNS.TargetDetail();
            YSWL.MALL.BLL.Members.UsersExp UserEx = new Members.UsersExp();
            YSWL.MALL.BLL.SNS.UserAlbums UserAlbumBll = new UserAlbums();
            YSWL.MALL.BLL.SNS.UserAlbumDetail DetailAlbumBll = new UserAlbumDetail();
            DetailModel.Photo = GetModel(pid);
            DetailModel.UserModel = UserEx.GetUsersExpModel(DetailModel.Userid);
            DetailModel.UserAlums = UserAlbumBll.GetUserAlbum((int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Photo, DetailModel.TargetId, DetailModel.Userid);
        ...
        public List<YSWL.MALL.Model.SNS.Photos> GetRecommandByPid(int pid)
        {
            YSWL.MALL.Model.SNS.Photos model = GetModel(pid);
            ...
            if (model != null)
            {
                ...
                if (commentList != null)
                {
                    ...
                    list.ForEach(img =>
                    {
                        List<Model.SNS.Comments> List = commentList.FindAll(xx => (xx.TargetId == img.PhotoID && xx.Type == (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo));
                        if (List == null) return;
        ...
        public List<YSWL.MALL.Model.SNS.ZuiInPhoto> GetZuiInList(int CategoryId, int Top)
        {
            List<YSWL.MALL.Model.SNS.ZuiInPhoto> list = new List<ZuiInPhoto>();
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    YSWL.MALL.Model.SNS.ZuiInPhoto model = new YSWL.MALL.Model.SNS.ZuiInPhoto();
        ...
        public List<YSWL.MALL.Model.SNS.ZuiInPhoto> GetZuiInListByCache(int CategoryId, int Top)
        {
            ...
            return (List<YSWL.MALL.Model.SNS.ZuiInPhoto>)objModel;
        }
        ...
        {
            return GetRecordCount(" Status =1 and Tags Like '%" + Common.InjectionFilter.SqlFilter(q) + "%' or  Description like '%" + Common.InjectionFilter.SqlFilter(q) + "%'");
        }
        ...
        {
            List<YSWL.MALL.Model.SNS.Photos> Photolist = new List<YSWL.MALL.Model.SNS.Photos>();
            //必须进行审核过滤
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" Status =1 ");
            if (!string.IsNullOrEmpty(q))
            {
                strSql.Append( " and (Tags Like '%" + Common.InjectionFilter.SqlFilter(q) + "%' or  Description like '%" + Common.InjectionFilter.SqlFilter(q) + "%')");
            }
            if (!string.IsNullOrEmpty(area))
            {
                strSql.Append(" and (PhotoAddress like '%" +Common.InjectionFilter.SqlFilter(area) + "%' )");
            }
            switch (orderby)
            {
                case "popular":
        ...
        public string GetThumByPhotoID(int id)
        {
            ...
            YSWL.MALL.Model.SNS.Photos model = GetModel(id);
            if (model != null)
            {
        ...
        {
            //过滤SQL注入
            address = YSWL.Common.InjectionFilter.SqlFilter(address);
