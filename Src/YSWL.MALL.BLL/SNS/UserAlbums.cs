...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class UserAlbums
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.UserAlbums GetModelByCache(int AlbumID)
        {
            ...
            return (YSWL.MALL.Model.SNS.UserAlbums)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserAlbums> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.UserAlbums> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.UserAlbums> modelList = new List<YSWL.MALL.Model.SNS.UserAlbums>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.UserAlbums model;
        ...
        public int GetCountByKeyWard(string KeyWord)
        {
            ...
            {
                sql = "AlbumName like '%" + Common.InjectionFilter.SqlFilter(KeyWord) + "%'";
            }
        ...
        /// <param name="UserID"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserAlbums> GetUserAblumsByUserID(int UserID)
        {
            return GetModelList("CreatedUserID=" + UserID + "");
        }

        /// 或的top n 某个用户的专辑
        public List<YSWL.MALL.Model.SNS.UserAlbums> GetUserAlbumsByUserId(int top, int UserID)
        {
        ...
        public bool DeleteEx(int AlbumID, int UserId)
        {
            ...
            List<YSWL.MALL.Model.SNS.UserAlbumsType> list = utBll.GetModelList("AlbumsID=" + AlbumID + " and AlbumsUserID=" + UserId + "");
            if (list.Count > 0)
            {
        ...
        {
            return dal.GetList(0, string.Format(" AlbumName like '%{0}%'", Common.InjectionFilter.SqlFilter(Keywords)), "");
        }
