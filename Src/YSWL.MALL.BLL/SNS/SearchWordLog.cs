...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class SearchWordLog
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.SearchWordLog GetModelByCache(int ID)
		{
			...
			return (YSWL.MALL.Model.SNS.SearchWordLog)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.SearchWordLog> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.SearchWordLog> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.SearchWordLog> modelList = new List<YSWL.MALL.Model.SNS.SearchWordLog>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.SearchWordLog model;
        ...
        {
            return dal.GetList(0, string.Format(" SearchWord like '%{0}%' ",Common.InjectionFilter.SqlFilter(Keywords)), "");
        }
          /// <summary>
        /// 获得前几行数据
        /// </summary>
        ...
        {
            return dal.GetHotHotWordssList(Top);
        }
