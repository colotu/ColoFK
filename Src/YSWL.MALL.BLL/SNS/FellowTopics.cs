...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class FellowTopics
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.FellowTopics GetModelByCache(int ID)
		{
			...
			return (YSWL.MALL.Model.SNS.FellowTopics)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.FellowTopics> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.FellowTopics> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.FellowTopics> modelList = new List<YSWL.MALL.Model.SNS.FellowTopics>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.FellowTopics model;
