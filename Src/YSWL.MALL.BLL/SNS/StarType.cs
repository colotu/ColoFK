...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class StarType
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.StarType GetModelByCache(int TypeID)
		{
			...
			return (YSWL.MALL.Model.SNS.StarType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.StarType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.StarType> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.StarType> modelList = new List<YSWL.MALL.Model.SNS.StarType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.StarType model;
