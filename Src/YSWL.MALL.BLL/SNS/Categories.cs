...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Categories
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(YSWL.MALL.Model.SNS.Categories model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSWL.MALL.Model.SNS.Categories model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Categories GetModel(int CategoryId)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Categories GetModelByCache(int CategoryId)
        {
            ...
            return (YSWL.MALL.Model.SNS.Categories)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Categories> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Categories> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Categories> modelList = new List<YSWL.MALL.Model.SNS.Categories>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Categories model;
        ...
        public List<YSWL.MALL.Model.SNS.Categories> GetChildrenListById(int Cid)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Categories> GetMenuByCategory(int Top=-1)
        {
            ...
            return (List<YSWL.MALL.Model.SNS.Categories>)objModel;
        ...
        /// <returns></returns>
        public YSWL.MALL.ViewModel.SNS.ProductCategory GetCateListByParentId(int ParentID)
        {
            YSWL.MALL.ViewModel.SNS.ProductCategory ParentList = new ViewModel.SNS.ProductCategory();
            if (ParentID == 0)
            {
                return ParentList;
            }
            YSWL.MALL.Model.SNS.Categories ParentModel = GetModel(ParentID);
            ParentList.CurrentCateName = ParentModel == null ? "暂无" : ParentModel.Name;
            ParentList.CurrentCid = ParentID;
            List<YSWL.MALL.Model.SNS.Categories> list = GetModelList("ParentID=" + ParentID + "");
            foreach (YSWL.MALL.Model.SNS.Categories items in list)
            {
                YSWL.MALL.ViewModel.SNS.SonCategory SonList = new ViewModel.SNS.SonCategory();
        ...
        /// <param name="ParentID"></param>
        /// <returns></returns>
        public YSWL.MALL.ViewModel.SNS.ProductCategory GetCacheCateListByParentId(int ParentID)
        {
            ...
            return (YSWL.MALL.ViewModel.SNS.ProductCategory)objModel;
        }
        ...
        /// <param name="ParentID"></param>
        /// <returns></returns>
        public YSWL.MALL.ViewModel.SNS.ProductCategory GetCateListByParentIdEx(int ParentID)
        {
            YSWL.MALL.ViewModel.SNS.ProductCategory ParentList = new ViewModel.SNS.ProductCategory();
            if (ParentID == 0)
            {
        ...
        /// <param name="ParentID"></param>
        /// <returns></returns>
        public YSWL.MALL.ViewModel.SNS.ProductCategory GetCacheCateListByParentIdEx(int ParentID)
        {
        ...
        public List<YSWL.MALL.ViewModel.SNS.ProductCategory> GetChildByMenu()
        {
            List<YSWL.MALL.Model.SNS.Categories> TopList = GetMenuByCategory();
            List<YSWL.MALL.ViewModel.SNS.ProductCategory> ResultList = new List<ViewModel.SNS.ProductCategory>();
            foreach (YSWL.MALL.Model.SNS.Categories item in TopList)
            {
                YSWL.MALL.ViewModel.SNS.ProductCategory ParentList = new ViewModel.SNS.ProductCategory();
                ParentList.ParentModel = item;
                List<YSWL.MALL.Model.SNS.Categories> list = GetChildrenListById(item.CategoryId);
        ...
        {
            YSWL.MALL.Model.SNS.Categories Cmodel = GetModel(Cid);
            if (Cmodel == null) { 
                return "暂无分类";
            }
        ...
        {
            YSWL.MALL.Model.SNS.Categories Cmodel = new Model.SNS.Categories();
            Cmodel = GetModel(Cid);
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Categories GetModel(string Name)
        {
            List<YSWL.MALL.Model.SNS.Categories> list = GetModelList("Name='" + Common.InjectionFilter.SqlFilter(Name) + "'");
            if (list.Count > 0)
            {
                return list[0];
            }
        ...
        {
            YSWL.MALL.BLL.SNS.Categories SNSCateBll = new BLL.SNS.Categories();
        ...
        public List<YSWL.MALL.Model.SNS.Categories> GetCategorysByDepth(int depth, int type)
        {
            //ADD Cache
        ...
        public List<YSWL.MALL.Model.SNS.Categories> GetListByParentId(int parentCategoryId)
        {
            //ADD Cache
        ...
        /// <returns></returns>
        public bool AddCategory(YSWL.MALL.Model.SNS.Categories model)
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public bool UpdateCategory(YSWL.MALL.Model.SNS.Categories model)
        {
        ...
        public List<YSWL.MALL.Model.SNS.Categories> GetPhotoMenuCategoryList()
        {
            //ADD Cache
        ...
        public string GetUrlById(int Id)
        {
            ...
            YSWL.MALL.Model.SNS.Categories CateModel =  GetModel(Id);
            if (CateModel != null)
            {
                ...
                {
                    YSWL.MALL.Model.SNS.Categories model = GetModelByCache(Common.Globals.SafeInt(item, 0));
                    if (model != null)
                    {
                        if (i == 0)
                        {
                            pathUrl = YSWL.Common.PinyinHelper.GetPinyin(model.Name).ToLower();
                        }
                        else
                        {
                            pathUrl = pathUrl + "/" + YSWL.Common.PinyinHelper.GetPinyin(model.Name).ToLower() ;
                        }
                    }
                    i++;
                }
        ...
        public List<YSWL.MALL.Model.SNS.Categories> GetCategoryList(int parentId,int type)
        {
            return GetModelList(string.Format("  ParentID ={0} and type={1} ORDER BY Sequence ASC", parentId, type));
        }


        public List<YSWL.MALL.Model.SNS.Categories> GetChildList(int parentId, int top,int type)
        {
        ...
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Categories> GetAllCateByCache(int type)
        {
        ...
        public static List<YSWL.MALL.Model.SNS.Categories> GetAllList(int type)
        {
