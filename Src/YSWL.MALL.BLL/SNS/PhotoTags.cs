...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class PhotoTags
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.PhotoTags GetModelByCache(int TagID)
		{
			...
			return (YSWL.MALL.Model.SNS.PhotoTags)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.PhotoTags> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.PhotoTags> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.PhotoTags> modelList = new List<YSWL.MALL.Model.SNS.PhotoTags>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.PhotoTags model;
        ...
        public List<YSWL.MALL.Model.SNS.PhotoTags> GetHotTags(int top)
        {
