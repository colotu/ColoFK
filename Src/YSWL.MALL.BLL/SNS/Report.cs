...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Report
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Report GetModelByCache(int ID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Report)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Report> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Report> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Report> modelList = new List<YSWL.MALL.Model.SNS.Report>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Report model;
        ...
        {
            return GetListEx(0, strWhere, "CreatedDate Desc");
        }
        ...
        {
            return dal.UpdateReportStatus(status, reportId);
        }    
        /// <summary>
        /// 批量更新举报内容状态
        /// </summary>
        ...
        {
            return dal.UpdateReportStatus(status, reportIds);
        }
