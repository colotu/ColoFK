...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class VisiteLogs
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.VisiteLogs GetModelByCache(int VisitID)
		{
			...
			return (YSWL.MALL.Model.SNS.VisiteLogs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.VisiteLogs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.VisiteLogs> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.VisiteLogs> modelList = new List<YSWL.MALL.Model.SNS.VisiteLogs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.VisiteLogs model;
