...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Comments
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(YSWL.MALL.Model.SNS.Comments model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(YSWL.MALL.Model.SNS.Comments model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public YSWL.MALL.Model.SNS.Comments GetModel(int CommentID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Comments GetModelByCache(int CommentID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Comments)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Comments> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Comments> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Comments> modelList = new List<YSWL.MALL.Model.SNS.Comments>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Comments model;
        ...
        /// <returns></returns>
        public int AddEx(YSWL.MALL.Model.SNS.Comments ComModel)
        {
            ...
            {
                ComModel.Description = YSWL.MALL.BLL.Settings.FilterWords.ReplaceWords(ComModel.Description);
            }
            int CommentID = dal.AddEx(ComModel);
            switch (ComModel.Type)
            {
                case (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Product:
                    ...
                    pBll.Update(pModel);
                    break;
                case (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Photo:
                    YSWL.MALL.Model.SNS.Photos photoModel = new Model.SNS.Photos();
                    ...
                    break;
                case (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Album:
                    YSWL.MALL.BLL.SNS.UserAlbums albumsBll = new UserAlbums();
                    albumsBll.UpdateCommentCount(ComModel.TargetId);
                    break;
                case (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Normal:
                    YSWL.MALL.BLL.SNS.Posts postBll = new Posts();
                    postBll.UpdateCommentCount(ComModel.TargetId);
                    break;
                case (int)YSWL.MALL.Model.SNS.EnumHelper.CommentType.Blog:
                    YSWL.MALL.BLL.SNS.UserBlog blogBll = new UserBlog();
                    YSWL.MALL.BLL.SNS.Posts postBll3 = new Posts();
                    blogBll.UpdateCommentCount(ComModel.TargetId);
                    postBll3.UpdateCommentCount(ComModel.TargetId);
                    break;
                default:
                    YSWL.MALL.BLL.SNS.Posts postBll2 = new Posts();
            ...
            ReferBll.AddEx(ComModel.Description, YSWL.MALL.Model.SNS.EnumHelper.ReferType.Comment, CommentID);
            return CommentID;
        }

        public List<YSWL.MALL.Model.SNS.Comments> GetCommentByPost(YSWL.MALL.Model.SNS.Posts Post, string basePath)
        {
            ...
            int TargetId = (Type == (int)YSWL.MALL.Model.SNS.EnumHelper.PostContentType.Normal ? Post.PostID : Post.TargetId);
            List<YSWL.MALL.Model.SNS.Comments> list = GetModelList(" TargetId=" + TargetId + " and Type=" + Type + "");
            List<YSWL.MALL.Model.SNS.Comments> list2 = new List<Model.SNS.Comments>();
            foreach (YSWL.MALL.Model.SNS.Comments item in list)
            {
                item.Description = ViewModel.ViewModelBase.RegexNickName(item.Description,basePath);
                list2.Add(item);
            }
            return list2;
        }
        ...
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Comments> GetCommentByPage(int type, int TargetId, int StartIndex, int EndIndex)
        {
        ...
        public List<YSWL.MALL.Model.SNS.Comments> GetCommentByIds(string IdStr, int Type)
        {
        ...
        /// <param name="Type"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Comments> GetCacheCommentByIds(string IdStr, int Type)
        {
            ...
            return (List<YSWL.MALL.Model.SNS.Comments>)objModel;
        }
        ...
        /// 分页获取数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Comments> GetBlogComment(string strWhere,string orderBy,int top=-1)
        {
            DataSet ds = GetList(top, strWhere, orderBy);
            List<YSWL.MALL.Model.SNS.Comments> CommentList = DataTableToList(ds.Tables[0]);
            if (CommentList != null && CommentList.Count > 0)
            {
                YSWL.MALL.BLL.SNS.UserBlog userBlogBll=new UserBlog();
