...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class Videos
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.Videos GetModelByCache(int VideoID)
		{
			...
			return (YSWL.MALL.Model.SNS.Videos)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.Videos> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.Videos> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.Videos> modelList = new List<YSWL.MALL.Model.SNS.Videos>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.Videos model;
