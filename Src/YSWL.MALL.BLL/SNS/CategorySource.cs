...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class CategorySource
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.CategorySource GetModelByCache(int SourceId,int CategoryId)
		{
			...
			return (YSWL.MALL.Model.SNS.CategorySource)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.CategorySource> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.CategorySource> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.CategorySource> modelList = new List<YSWL.MALL.Model.SNS.CategorySource>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.CategorySource model;
        ...
        {
            YSWL.MALL.BLL.SNS.CategorySource SNSCateBll = new CategorySource();
        ...
        public List<YSWL.MALL.Model.SNS.CategorySource> GetCategorysByDepth(int depth)
        {
            //ADD Cache
        ...
        public void CategoryLoop(long CategoryId, string Path, int Depth)
        {
            ...
            YSWL.MALL.Model.SNS.CategorySource CateModel = new Model.SNS.CategorySource();
