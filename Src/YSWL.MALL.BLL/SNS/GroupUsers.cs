...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class GroupUsers
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.GroupUsers GetModelByCache(int GroupID, int UserID)
        {
            ...
            return (YSWL.MALL.Model.SNS.GroupUsers)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.GroupUsers> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.GroupUsers> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.GroupUsers> modelList = new List<YSWL.MALL.Model.SNS.GroupUsers>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.GroupUsers model;
        ...
        public List<YSWL.MALL.Model.SNS.GroupUsers> GetNewUserListByGroup(int GroupId, int Top)
        {
        ...
        public List<YSWL.MALL.Model.SNS.GroupUsers> GetAdminUserList(int GroupId)
        {
        ...
        /// </summary>
        /// <param name="GroupId">小组ID</param>
        public List<YSWL.MALL.Model.SNS.GroupUsers> GetUserList(int GroupId, int startIndex, int endIndex)
        {
