...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class UserShip
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(YSWL.MALL.Model.SNS.UserShip model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(YSWL.MALL.Model.SNS.UserShip model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public YSWL.MALL.Model.SNS.UserShip GetModel(int ActiveUserID,int PassiveUserID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.UserShip GetModelByCache(int ActiveUserID,int PassiveUserID)
		{
			...
			return (YSWL.MALL.Model.SNS.UserShip)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserShip> GetModelList(string strWhere)
		{
        ...
        {
            YSWL.MALL.Model.SNS.UserShip UserShipModel = new Model.SNS.UserShip();
            ...
            UserShipModel.Type = (int)YSWL.MALL.Model.SNS.EnumHelper.FansType.Normal;
        ...
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserShip> GetToListByFellowsPage(int userid, string orderby, int startIndex, int endIndex)
        {
        ...
        /// <param name="endIndex"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserShip> GetToListByFansPage(int userid, string orderby, int startIndex, int endIndex)
        {
        ...
        /// <param name="endIndex"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserShip> GetUsersAllFansByPage(int userid, int startIndex, int endIndex,int CurrentUserId)
        {
            List<YSWL.MALL.Model.SNS.UserShip> list= GetToListByFansPage(userid, "", startIndex, endIndex);
            ///当前用户是否关注此粉丝列表中的用户
            if (CurrentUserId != 0 && list != null && list.Count > 0)
            {
                List<YSWL.MALL.Model.SNS.UserShip> shipList = GetUserFellowList(CurrentUserId);
        ...
        /// <param name="endIndex"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserShip> GetUsersAllFellowsByPage(int userid, int startIndex, int endIndex, int CurrentUserId)
        {
            List<YSWL.MALL.Model.SNS.UserShip> list = GetToListByFellowsPage(userid, "", startIndex, endIndex);
            ///当前用户是否关注此关注列表中的用户
            if (CurrentUserId != 0&&list!=null&&list.Count>0)
            {
                List<YSWL.MALL.Model.SNS.UserShip> shipList = GetUserFellowList(CurrentUserId);
        ...
        /// <param name="UserId"></param>
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.UserShip> GetUserFellowList(int UserId)
        {
        ...
        public void GiveUserFellow(int UserId, int Top)
        {
            ...
            List<YSWL.MALL.Model.Members.Users> list = new List<YSWL.MALL.Model.Members.Users>();
        ...
        {
            string Fans = YSWL.MALL.BLL.SysManage.ConfigSystem.GetValueByCache("SNS_FansList");
            YSWL.MALL.BLL.Members.Users userBll = new Members.Users();
