...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class StarRank
	{
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.StarRank GetModelByCache(int ID)
        {
            ...
            return (YSWL.MALL.Model.SNS.StarRank)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.StarRank> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.StarRank> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.StarRank> modelList = new List<YSWL.MALL.Model.SNS.StarRank>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.StarRank model;
