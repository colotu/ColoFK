...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class UserFavAlbum
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.UserFavAlbum GetModelByCache(int ID)
		{
			...
			return (YSWL.MALL.Model.SNS.UserFavAlbum)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserFavAlbum> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserFavAlbum> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.UserFavAlbum> modelList = new List<YSWL.MALL.Model.SNS.UserFavAlbum>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.UserFavAlbum model;
        ...
        {
            return dal.GetList(0,string.Format(" Tags like '%{0}%'",Common.InjectionFilter.SqlFilter(Keywords)) ,"");
        }
