...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class ReportType
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.ReportType GetModelByCache(int ID)
		{
			...
			return (YSWL.MALL.Model.SNS.ReportType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.ReportType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.ReportType> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.ReportType> modelList = new List<YSWL.MALL.Model.SNS.ReportType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.ReportType model;
        ...
        public DataSet GetSearchList(int Status,string Keywords)
        {
            ...
            if (Keywords.Length > 0)
            {
                ...
                strWhere += string.Format(" TypeName like '%{0}%'", Common.InjectionFilter.SqlFilter(Keywords));
            }
