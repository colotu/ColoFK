...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class SearchWordTop
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.SearchWordTop GetModelByCache(int ID)
		{
			...
			return (YSWL.MALL.Model.SNS.SearchWordTop)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.SearchWordTop> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.SearchWordTop> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.SearchWordTop> modelList = new List<YSWL.MALL.Model.SNS.SearchWordTop>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.SearchWordTop model;
        ...
        public List<YSWL.MALL.Model.SNS.SearchWordTop> GetRecommadKeyWordList()
        {
            ...
            return (List<YSWL.MALL.Model.SNS.SearchWordTop>)objModel;
        }

        public List<YSWL.MALL.Model.SNS.SearchWordTop> GetCacheRecommadKeyWordList()
        {
