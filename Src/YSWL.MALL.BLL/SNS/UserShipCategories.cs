...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class UserShipCategories
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.UserShipCategories GetModelByCache(int CategoryID)
		{
			...
			return (YSWL.MALL.Model.SNS.UserShipCategories)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserShipCategories> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.UserShipCategories> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.UserShipCategories> modelList = new List<YSWL.MALL.Model.SNS.UserShipCategories>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.UserShipCategories model;
