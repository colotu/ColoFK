...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Products
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Products GetModelByCache(long ProductID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Products)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Products> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Products> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Products> modelList = new List<YSWL.MALL.Model.SNS.Products>();
        ...
        private string BindstrWhere(ProductQuery queryobj)
        {
            ...
            {
                queryobj.Keywords = YSWL.Common.InjectionFilter.SqlFilter(queryobj.Keywords);
                if (strWhere.Length > 0)
                {
                    strWhere.Append(" And ");
                }
                strWhere.AppendFormat("( ProductName like '%{0}%' or Tags like '%{0}%')", Common.InjectionFilter.SqlFilter(queryobj.Keywords));
            }
            ...
            {
                queryobj.Tags = YSWL.Common.InjectionFilter.SqlFilter(queryobj.Tags);
                if (strWhere.Length > 0)
                {
                    strWhere.Append(" And ");
                }
                strWhere.AppendFormat(" Tags like '%{0}%'", Common.InjectionFilter.SqlFilter(queryobj.Tags));
            }
            if (!string.IsNullOrEmpty(queryobj.Color) && queryobj.Color != "all")
            {
                queryobj.Color = YSWL.Common.InjectionFilter.SqlFilter(queryobj.Color);
                if (strWhere.Length > 0)
                {
                    strWhere.Append(" And ");
                }
            ...
            strWhere.AppendFormat(" Status<>{0}", (int)YSWL.MALL.Model.SNS.EnumHelper.ProductStatus.UnChecked);
        ...
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Products> GetProductByPage(YSWL.MALL.Model.SNS.ProductQuery Query,
        ...
        /// <returns></returns>
        public List<YSWL.MALL.Model.SNS.Products> GetCacheProductByPage(YSWL.MALL.Model.SNS.ProductQuery Query,
                                                                        int StartIndex, int EndIndex)
        {
            ...
            return (List<YSWL.MALL.Model.SNS.Products>)objModel;
        }
        ...
        /// <param name="EndIndex"></param>
        /// <returns></returns>
        public int GetCacheProductCount(YSWL.MALL.Model.SNS.ProductQuery Query)
        {
        ...
        /// <param name="EndIndex"></param>
        /// <returns></returns>
        public int GetProductCount(YSWL.MALL.Model.SNS.ProductQuery Query)
        {
        ...
        /// <param name="pid"></param>
        /// <returns></returns>
        public YSWL.MALL.ViewModel.SNS.TargetDetail GetTargetAssiationInfo(int pid)
        {
            ...
            DetailModel.UserAlums = UserAlbumBll.GetUserAlbum((int)YSWL.MALL.Model.SNS.EnumHelper.ImageType.Product,
        ...
        public List<YSWL.MALL.Model.SNS.Products> GetProductListByCid(int Cid)
        {
        ...
        public YSWL.MALL.Model.SNS.Products GetProductModel(YSWL.MALL.Model.SNS.Products PModel)
        {
        ...
        public int ImportData(int userid, int albumId, int cid, List<TaoBao.Domain.TbkItem> list, bool ReRepeat = true)
        {
            ...
            if (list.Count > 0)
            {
                ...
                foreach (var item in list)
                {
                    ...
                    if (ReRepeat)
                    {
                        if (!Exsit(item.NumIid, (int)YSWL.MALL.Model.SNS.EnumHelper.WebSiteType.TaoBao))
                        {
                            ...
                            if (productId > 0)
                            {
                                YSWL.MALL.BLL.SNS.UserAlbumDetail detailBll = new UserAlbumDetail();
                                YSWL.MALL.Model.SNS.UserAlbumDetail detailModel = new Model.SNS.UserAlbumDetail();
        ...
        public int ImportExcelData(int userid, int albumId, int categoryId, DataTable dt, bool ReRepeat = true)
        {
            ...
            //            item.ProductSourceID = (int)YSWL.MALL.Model.SNS.EnumHelper.WebSiteType.TaoBao;
            //            item.SourceType = 1;
        ...
        /// 获得Excel数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Products> ExcelToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Products> modelList = new List<YSWL.MALL.Model.SNS.Products>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
        ...
        //    }
        //    ///最后的tags是 成色:全新|钱包款式:长款钱包|里料材质:合成革 这种形式
        //    string[] Props = YSWL.Common.StringPlus.GetStrArray(Prop);
        ...
        /// <returns></returns>
        //public List<YSWL.MALL.Model.SNS.Products> GetProductList(int cid,int top=10,bool hasChild=true )
        //{
