...
namespace YSWL.MALL.BLL.SNS
{
    ...
    public partial class Tags
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public YSWL.MALL.Model.SNS.Tags GetModelByCache(int TagID)
        {
            ...
            return (YSWL.MALL.Model.SNS.Tags)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Tags> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Tags> DataTableToList(DataTable dt)
        {
            List<YSWL.MALL.Model.SNS.Tags> modelList = new List<YSWL.MALL.Model.SNS.Tags>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                YSWL.MALL.Model.SNS.Tags model;
        ...
        /// 根据类型获取正常状态的标签数据集
        /// </summary>
        public List<YSWL.MALL.Model.SNS.Tags> GetList(int TypeId)
        {
            return DataTableToList(dal.GetList("Status=1 and TypeId=" + TypeId).Tables[0]);
        }
        public List<YSWL.MALL.Model.SNS.Tags> GetHotTags(int top)
        {
        ...
        public string GetTagUnionStrByCache()
        {
            ...
            if (objModel == null)
            {
                try
                {
                    List<YSWL.MALL.Model.SNS.Tags> list = GetModelList("");
        ...
        public DataSet GetSearchList(string Keywords)
        {
            ...
            {
                strWhere = string.Format(" TagName like '%{0}%' ", Common.InjectionFilter.SqlFilter(Keywords));
            }
