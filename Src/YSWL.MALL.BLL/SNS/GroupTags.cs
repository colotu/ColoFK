...
namespace YSWL.MALL.BLL.SNS
{
	...
	public partial class GroupTags
	{
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(YSWL.MALL.Model.SNS.GroupTags model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(YSWL.MALL.Model.SNS.GroupTags model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public YSWL.MALL.Model.SNS.GroupTags GetModel(int TagID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YSWL.MALL.Model.SNS.GroupTags GetModelByCache(int TagID)
		{
			...
			return (YSWL.MALL.Model.SNS.GroupTags)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.GroupTags> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YSWL.MALL.Model.SNS.GroupTags> DataTableToList(DataTable dt)
		{
			List<YSWL.MALL.Model.SNS.GroupTags> modelList = new List<YSWL.MALL.Model.SNS.GroupTags>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YSWL.MALL.Model.SNS.GroupTags model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new YSWL.MALL.Model.SNS.GroupTags();
        ...
        {
            return dal.GetList(0, string.Format("TagName like '%{0}%'", Common.InjectionFilter.SqlFilter(Keywords)), "");
        } 
         /// <summary>
        /// 是否存在该记录
        /// </summary>
